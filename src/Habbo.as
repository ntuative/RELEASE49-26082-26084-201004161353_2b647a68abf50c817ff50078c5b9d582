package
{
   ...
   public class Habbo extends MovieClip
   {
      ...
      public static const const_12:String = "client.init.volter.retry";
      ...
      public static const const_16:String = "client.init.volter.fail";
      ...
      public static const const_11:String = "error_ctx";
      
      private static var _crashed:Boolean = false;
      
      public static const const_27:String = "client.init.core.fail";
      
      public static const const_8:String = "error_cat";
      
      private static const const_26:Number = 0.71;
      
      public static const FILE_BAR_SPRITE:String = "fileBarSprite";
      
      public static const const_3:String = "textField";
      ...
      public static const const_22:String = "client.init.volter.loaded";
      
      private static const const_23:String = "testLocalConnection";
      
      public static const const_20:String = "error_data";
      ...
      public static function reportCrash(param1:String, param2:int, param3:Error) : void
      {
         ...
         if(!Habbo._crashed)
         {
            ...
            _loc7_ = "";
            _loc6_[const_11] = _loc7_;
            _loc6_[const_19] = Capabilities.version;
            _loc6_[const_15] = 0;
            _loc6_[const_18] = param1;
            _loc6_[const_8] = String(param2);
            if(param3 != null)
            {
               _loc6_[const_20] = String(param3.getStackTrace());
            }
      ...
      {
         var _loc3_:* = null;
         var _loc2_:TextField = param1.getChildByName(const_3) as TextField;
         if(_loc2_)
         {
      ...
      private function onVolterLoadingCompleted(param1:Event) : void
      {
         ...
         if(var_1)
         {
            updateFont(var_1.getChildByName(const_3) as TextField,"Volter",true);
