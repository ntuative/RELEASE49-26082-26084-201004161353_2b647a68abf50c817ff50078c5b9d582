package com.sulake.core.utils
{
   ...
   public class LibraryLoader extends EventDispatcher implements IDisposable
   {
      ...
      protected static const const_1412:int = 5;
      ...
      protected var var_529:XML;
      
      protected var var_1394:Boolean = false;
      
      protected var var_456:uint = 0;
      
      protected var var_14:Loader;
      
      protected var var_2289:String = "";
      
      protected var var_288:URLRequest;
      
      protected var _debug:Boolean = false;
      
      protected var _name:String;
      
      protected var var_366:Class;
      ...
      protected function method_9(param1:URLRequest, param2:int) : void
      {
      ...
      protected function prepareLibrary() : void
      {
         ...
         var_366 = this.getDefinition(_name) as Class;
         if(var_366 == null)
         {
            failure("Failed to find resource class \"" + _name + "\" in library " + var_288.url + "!");
            return;
         }
         try
         {
            xmlClass = var_366.manifest as Class;
            if(xmlClass == null)
            {
               return;
            }
         ...
         var_529 = new XML(bytes.readUTFBytes(bytes.length));
      }
      ...
      protected function loadEventHandler(param1:Event) : void
      {
         switch(param1.type)
         {
            case Event.INIT:
               ...
               var_456 |= LibraryLoader.STATE_EVENT_INIT;
               break;
            case Event.COMPLETE:
               debug("Load event COMPLETE for file \"" + var_14.contentLoaderInfo.url + "\"");
               var_456 |= LibraryLoader.STATE_EVENT_COMPLETE;
               break;
         ...
         if(var_456 == LibraryLoader.STATE_ANALYZE)
         {
            if(analyzeLibrary())
            {
               var_456 |= LibraryLoader.STATE_EVENT_FRAME;
            }
         }
         if(var_456 == LibraryLoader.STATE_READY)
         {
            var_1394 = true;
            prepareLibrary();
            removeEventListeners();
      ...
      protected function handleHttpStatus(param1:int) : Boolean
      {
         if(param1 >= 400)
         {
            if(var_951 > 0)
            {
               var_14.close();
               var_14.unload();
               method_9(var_288,const_1412 - var_951);
               var_14.load(var_288,var_15);
               --var_951;
               return true;
            }
