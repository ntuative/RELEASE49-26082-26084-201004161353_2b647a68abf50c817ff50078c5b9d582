package com.sulake.core.window
{
   ...
   public class WindowContext implements IWindowContext, IDisposable, IUpdateReceiver
   {
      ...
      private static var var_1007:Factory;
      ...
      public static const const_1600:int = 0;
      
      public static const const_1592:int = 3;
      
      public static const const_1378:int = 4;
      ...
      protected var var_325:DisplayObjectContainer;
      ...
      public function WindowContext(param1:String, param2:IWindowRenderer, param3:IWindowFactory, param4:ICoreLocalizationManager, param5:DisplayObjectContainer, param6:Rectangle, param7:IWindowContextStateListener)
      {
         ...
         var_325.addChild(var_86.getDisplayObject());
         var_325.doubleClickEnabled = true;
         var_325.addEventListener(Event.RESIZE,stageResizedHandler);
      ...
      {
         var _loc12_:Class = var_1007.getWindowClassByType(param3);
         if(_loc12_ == null)
         {
            handleError(WindowContext.const_1378,new Error("Failed to solve implementation for window \"" + param1 + "\"!"));
            return null;
         }
         if(param8 == null)
         {
      ...
      {
         _disposed = true;
         var_325.removeEventListener(Event.RESIZE,stageResizedHandler);
         var_325.removeChild(IGraphicContextHost(var_86).getGraphicContext(true) as DisplayObject);
         var_86.destroy();
         var_86 = null;
         var_1112.destroy();
         var_1112 = null;
      ...
      private function stageResizedHandler(param1:Event) : void
      {
         if(var_86 != null && true)
         {
            if(var_325 is Stage)
            {
               var_86.width = Stage(var_325).stageWidth;
               var_86.height = Stage(var_325).stageHeight;
            }
            else
            {
               var_86.width = var_325.width;
               var_86.height = var_325.height;
            }
         }
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         while(true)
         {
            ...
            if(_loc2_.stageX != var_579.x || _loc2_.stageY != var_579.y)
            {
               ...
               _loc5_ = new Array();
               var_86.groupChildrenUnderPoint(var_579,_loc5_);
            }
               ...
               if(_loc4_ != null && _loc4_.visible)
               {
                  ...
                  else if(_loc2_.type == MouseEvent.MOUSE_UP || _loc2_.type == MouseEvent.CLICK)
                  {
                     if(var_93 && true)
                     {
                        if(var_335 != null)
                        {
                           var_335.mouseEventReceived(_loc2_.type,var_93);
                        }
                     }
                  }
                  if(_loc2_.altKey)
      ...
      public function getMouseCursor() : IMouseCursor
      {
         if(var_1608 == null)
         {
            var_1608 = new MouseCursorControl(var_325);
         }
         return var_1608;
      }
      ...
      private function passMouseEvent(param1:WindowController, param2:MouseEvent) : WindowController
      {
         ...
         if(param1.testParamFlag(WindowParam.const_450))
         {
