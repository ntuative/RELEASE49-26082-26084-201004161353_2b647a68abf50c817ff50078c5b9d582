package com.sulake.core.window.graphics
{
   ...
   public class GraphicContext extends Sprite implements IGraphicContext
   {
      ...
      public static const const_847:uint = 256;
      
      protected static var var_642:uint = 0;
      
      protected static var var_379:uint = 0;
      
      public static const const_936:uint = 2;
      
      public static const const_1546:uint = 128;
      
      public static const const_1509:uint = 64;
      
      public static const const_669:uint = 4;
      
      public static const const_1187:uint = 0;
      
      public static const const_1352:uint = 16;
      
      public static const const_707:uint = 1;
      
      public static const const_1375:uint = 8;
       
      
      protected var _disposed:Boolean = false;
      
      protected var var_635:Boolean;
      
      protected var var_1611:Boolean;
      
      protected var var_158:DisplayObjectContainer;
      ...
      public function GraphicContext(param1:String, param2:uint, param3:Rectangle)
      {
         ...
         switch(param2)
         {
            ...
            case GraphicContext.const_1375:
               ...
               break;
            case GraphicContext.const_1352:
               setDisplayObject(new MorphShape());
               break;
            case GraphicContext.const_669:
               setDisplayObject(new Sprite());
               break;
            case GraphicContext.const_847:
               break;
            case GraphicContext.const_1187:
               break;
            default:
      ...
      protected function releaseDrawBuffer() : void
      {
         ...
         if(var_635)
         {
            ...
            if(_loc1_ is Bitmap)
            {
               ...
               if(_loc2_ != null)
               {
                  var_379 -= _loc2_.width * _loc2_.height * 4;
                  _loc2_.dispose();
               }
            }
         }
      ...
      protected function setupChildContainer() : DisplayObjectContainer
      {
         ...
         {
            var_158 = new Sprite();
            var_158.name = this.name + " - Child Container";
            var_158.mouseEnabled = false;
            addChild(var_158);
         }
         return var_158;
      }
         ...
         if(var_635)
         {
            ...
            if(displayObject is Bitmap)
            {
               ...
               if(bitmap != null)
               {
                  ...
                  {
                     var_379 -= bitmap.width * bitmap.height * 4;
                     bitmap.dispose();
                     bitmap = null;
                  }
               }
