package com.sulake.core.window.graphics.renderer
{
   ...
   public class SkinRenderer implements ISkinRenderer
   {
      ...
      protected var var_323:Dictionary;
      
      protected var var_324:Dictionary;
      
      protected var var_451:Dictionary;
      ...
      {
         var _loc3_:ISkinLayout = var_451[param2];
         if(_loc3_ == null)
         {
      ...
      {
         var _loc3_:ISkinTemplate = var_323[param2];
         if(_loc3_ == null)
         {
      ...
      public function dispose() : void
      {
         ...
         {
            ISkinLayout(var_451[_loc1_]).dispose();
            delete var_451[_loc1_];
         }
         var_451 = null;
         _layoutsByState = null;
         for(_loc1_ in var_323)
         {
            ISkinTemplate(var_323[_loc1_]).dispose();
            delete var_323[_loc1_];
         }
         var_323 = null;
         var_324 = null;
      }
