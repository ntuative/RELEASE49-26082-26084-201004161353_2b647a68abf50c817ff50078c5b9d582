package com.sulake.core.window.graphics.renderer
{
   ...
   public class BitmapSkinRenderer extends SkinRenderer implements ISkinRenderer
   {
      ...
      protected var var_638:Dictionary;
      
      public function BitmapSkinRenderer(param1:Array)
      {
         super(param1);
         var_638 = new Dictionary(false);
      ...
      private function getBitmapFromCache(param1:ISkinTemplate, param2:String) : BitmapData
      {
         ...
         var _loc4_:BitmapData = var_638[_loc3_];
         if(_loc4_ == null)
         {
         ...
         if(_loc7_ != null && _loc9_ > 0)
         {
            ...
            while(_loc18_ < _loc9_)
            {
               ...
               if(_loc12_ != null)
               {
                  ...
                  _loc13_.x += param3.x;
                  _loc13_.y += param3.y;
                  if(_loc11_.scaleH == SkinLayoutEntity.const_236)
                  {
                     _loc13_.x += _loc16_;
                  }
                  else if(_loc11_.scaleH == SkinLayoutEntity.const_406)
                  {
                     _loc14_ = true;
                  ...
                  else if(_loc11_.scaleH == SkinLayoutEntity.const_268)
                  {
                     _loc14_ = true;
                     _loc13_.right += _loc16_;
                     if(_loc13_.width < 1)
                  ...
                  if(_loc11_.scaleV == SkinLayoutEntity.const_236)
                  {
                     _loc13_.y += _loc17_;
                  }
                  else if(_loc11_.scaleV == SkinLayoutEntity.const_406)
                  {
                     _loc15_ = true;
                  ...
                  else if(_loc11_.scaleV == SkinLayoutEntity.const_268)
                  {
                     _loc15_ = true;
                     _loc13_.bottom += _loc17_;
                     if(_loc13_.height < 1)
                  ...
                  else if(_loc11_.scaleV == SkinLayoutEntity.const_268 || _loc11_.scaleH == SkinLayoutEntity.const_268)
                  {
                  ...
                  {
                     var_666.a = _loc13_.width / _loc19_.width;
                     var_666.d = _loc13_.height / _loc19_.height;
                     _loc32_ = new BitmapData(_loc13_.width,_loc13_.height,false);
                     _loc32_.draw(_loc19_,var_666);
                     _loc33_ = new BitmapData(_loc13_.width,_loc13_.height,true,0);
                     _loc33_.draw(_loc20_,var_666,null);
      ...
      override public function dispose() : void
      {
         ...
         super.dispose();
         var_666 = null;
         for(_loc1_ in var_638)
         {
            _loc2_ = var_638[_loc1_] as BitmapData;
            _loc2_.dispose();
            delete var_638[_loc1_];
         }
         var_638 = null;
      ...
      protected function drawStaticLayoutEntity(param1:BitmapData, param2:Rectangle, param3:ISkinLayout, param4:ISkinLayoutEntity, param5:ISkinTemplate, param6:ISkinTemplateEntity) : void
      {
         ...
         switch(param6.type)
         {
            case "bitmap":
               ...
               if(param4.scaleH == SkinLayoutEntity.const_236)
               {
                  _loc7_.x += param2.width - param3.width;
               }
               if(param4.scaleV == SkinLayoutEntity.const_236)
               {
