package com.sulake.core.window.graphics
{
   ...
   public class WindowRenderer implements IWindowRenderer
   {
      ...
      private var var_1484:Rectangle;
      
      private var var_305:Dictionary;
      ...
      public function WindowRenderer(param1:ISkinContainer)
      {
         ...
         var_588 = new Array();
         var_1485 = new Point();
         var_1484 = new Rectangle();
         var_304 = new Rectangle();
         var_305 = new Dictionary(true);
         var_678 = param1;
      ...
      {
         var _loc2_:WindowRendererItem = var_305[param1] as WindowRendererItem;
      ...
      public function render() : void
      {
         ...
         while(_loc4_ < _loc2_)
         {
            _loc1_ = var_588.pop() as WindowController;
            if(!_loc1_.disposed)
            {
               _loc3_ = getWindowRendererItem(_loc1_);
               var_304.x = _loc3_.dirty.x;
               var_304.y = _loc3_.dirty.y;
               var_304.width = _loc3_.dirty.width;
               var_304.height = _loc3_.dirty.height;
               renderWindowBranch(_loc1_,_loc3_,var_304);
            }
            _loc4_++;
         }
      }
      ...
      {
         param1.removeEventListener(WindowDisposeEvent.const_578,windowDisposedCallback);
         var _loc2_:WindowRendererItem = var_305[param1] as WindowRendererItem;
         if(_loc2_ != null)
         {
            _loc2_.dispose();
      ...
      public function dispose() : void
      {
         ...
         if(!_disposed)
         {
            _disposed = true;
            var_588 = null;
            for(_loc1_ in var_305)
            {
               delete var_305[_loc1_];
            }
            var_305 = null;
      ...
      private function renderWindowBranch(param1:WindowController, param2:WindowRendererItem, param3:Rectangle) : void
      {
         ...
         if(param1.visible)
         {
            if(getDrawLocationAndClipRegion(param1,param3,var_1485,var_1484))
            {
               if(param2.render(param1,var_1485,var_1484))
               {
      ...
      public function registerRenderable(param1:IWindow) : void
      {
         ...
         if(_loc2_ == null)
         {
            _loc2_ = new WindowRendererItem(this,_drawBufferAllocator,var_678);
            var_305[param1] = _loc2_;
            param1.addEventListener(WindowDisposeEvent.const_578,windowDisposedCallback);
         }
      }
      ...
      public function invalidate(param1:IWindowContext, param2:Rectangle) : void
      {
         ...
         while(_loc4_-- > 0)
         {
            ...
            addToRenderQueue(_loc5_,_loc5_.rectangle,WindowRedrawFlag.const_75);
         }
      }
      ...
      public function addToRenderQueue(param1:IWindow, param2:Rectangle, param3:uint) : void
      {
         ...
         if(getWindowRendererItem(param1).invalidate(param1,param2,param3))
         {
            ...
            var_304.x = param2.x - param1.x;
            var_304.y = param2.y - param1.y;
            var_304.width = param2.width;
            var_304.height = param2.height;
            if(param1.testParamFlag(WindowParam.const_34))
            {
               while(param1.testParamFlag(WindowParam.const_34))
               {
                  ...
                  var_304.offset(param1.x,param1.y);
                  param1 = _loc4_;
               }
            }
            getWindowRendererItem(param1).invalidate(param1,var_304,WindowRedrawFlag.const_263);
            if(var_588.indexOf(param1) == -1)
            {
               var_588.push(param1);
            }
         }
