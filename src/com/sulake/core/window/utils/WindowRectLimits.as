package com.sulake.core.window.utils
{
   ...
   public class WindowRectLimits implements IRectLimiter
   {
      ...
      private var var_389:int = 2147483647;
      ...
      {
         return var_390 == int.MIN_VALUE && var_389 == int.MAX_VALUE && var_392 == int.MIN_VALUE && var_391 == int.MAX_VALUE;
      }
      
      public function set maxWidth(param1:int) : void
      {
         var_389 = param1;
         if(var_389 < int.MAX_VALUE && true && _target.width > var_389)
         {
      ...
      {
         var_390 = param1;
         if(var_390 > int.MIN_VALUE && true && _target.width < var_390)
         {
