package com.sulake.core.window.utils
{
   ...
   public class WindowParser implements IWindowParser
   {
      ...
      public static const const_1504:String = "_INCLUDE";
      
      public static const const_982:String = "_EXCLUDE";
      
      public static const const_1506:String = "_TEMP";
      
      private static const const_1075:RegExp = /^(\s|\n|\r|\t|\v)*/m;
      
      private static const const_1074:RegExp = /(\s|\n|\r|\t|\v)*$/;
       
      
      protected var var_1110:Dictionary;
      
      private var _disposed:Boolean = false;
      
      protected var var_944:Dictionary;
      
      protected var var_1383:Map;
      
      protected var var_15:IWindowContext;
      
      protected var var_1384:Dictionary;
      ...
      public function WindowParser(param1:IWindowContext)
      {
         ...
         var_1110 = new Dictionary();
         TypeCodeTable.fillTables(var_1109,var_1110);
         var_944 = new Dictionary();
         var_1384 = new Dictionary();
         ParamCodeTable.fillTables(var_944,var_1384);
         var_1383 = new Map();
      }
      
      private static function trimWhiteSpace(param1:String) : String
      {
         param1 = param1.replace(const_1074,"");
         return param1.replace(const_1075,"");
      }
      ...
      public function dispose() : void
      {
         ...
         if(!_disposed)
         {
            ...
            for(_loc1_ in var_1110)
            {
               delete var_1110[_loc1_];
            }
            for(_loc1_ in var_944)
            {
               delete var_944[_loc1_];
            }
            for(_loc1_ in var_1384)
            {
               delete var_1384[_loc1_];
            }
            var_1383.dispose();
            var_1383 = null;
            var_15 = null;
      ...
      private function parseSingleWindowEntity(param1:XML, param2:WindowController, param3:Map) : IWindow
      {
         ...
         visible = parseAttribute(xml,"visible",variables,visible.toString()) == "RoomReadyMessageParser";
         ...
         background = parseAttribute(xml,"background",variables,window.background.toString()) == "RoomReadyMessageParser";
         blend = Number(parseAttribute(xml,"blend",variables,window.blend.toString()));
         clipping = parseAttribute(xml,"clipping",variables,window.clipping.toString()) == "RoomReadyMessageParser";
         ...
         if(_loc7_ is IIterable)
         {
            ...
            if(_loc9_ > 0)
            {
               ...
               while(_loc12_ < _loc9_)
               {
                  ...
                  if(_loc10_.tags.indexOf(WindowParser.const_982) == -1)
                  {
