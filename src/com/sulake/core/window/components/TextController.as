package com.sulake.core.window.components
{
   ...
   public class TextController extends WindowController implements ITextWindow, ITextFieldContainer, ILocalizable
   {
      ...
      {
         return new Rectangle(var_639 * maxScrollH,var_376 * maxScrollV,width,height);
      }
      ...
      override public function dispose() : void
      {
         if(var_772)
         {
            context.removeLocalizationListener(var_326,this);
         }
         if(var_67 != null)
         {
            var_67.dispose();
      ...
      {
         var_639 = param1;
         _field.scrollH = var_639 * Number(_field.maxScrollH);
         refreshTextImage();
      }
      ...
      public function set text(param1:String) : void
      {
         ...
         var_326 = param1;
         if(var_326.charAt(0) == "$" && var_326.charAt(1) == "{")
         {
            context.registerLocalizationListener(var_326.slice(2,var_326.indexOf("}")),this);
            var_772 = true;
         }
         else if(_field != null)
         {
      ...
      override public function update(param1:WindowController, param2:Event) : Boolean
      {
         if(!var_210)
         {
            if(param2.type == WindowNotifyEvent.const_180)
            {
               refreshTextImage();
            }
         }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct("font_size",defaultTextFormat.size,PropertyStruct.const_879,true));
         _loc1_.push(new PropertyStruct("text_color",_field.textColor,PropertyStruct.const_381,true));
         ...
         _loc1_.push(new PropertyStruct("border_color",_field.borderColor,PropertyStruct.const_381,true));
         ...
         _loc1_.push(new PropertyStruct("max_chars",_field.maxChars,PropertyStruct.const_64,true));
         ...
         _loc1_.push(new PropertyStruct("sharpness",_field.sharpness,PropertyStruct.const_600,true));
         _loc1_.push(new PropertyStruct("style_sheet",_field.styleSheet,PropertyStruct.STRING,false));
         _loc1_.push(new PropertyStruct("thickness",_field.thickness,PropertyStruct.const_600,true));
         _loc1_.push(new PropertyStruct("word_wrap",_field.wordWrap,PropertyStruct.const_59,true));
         _loc1_.push(new PropertyStruct("margin_left",var_67.left,PropertyStruct.const_64,true));
         _loc1_.push(new PropertyStruct("margin_top",var_67.top,PropertyStruct.const_64,true));
         _loc1_.push(new PropertyStruct("margin_right",var_67.right,PropertyStruct.const_64,true));
         _loc1_.push(new PropertyStruct("margin_bottom",var_67.bottom,PropertyStruct.const_64,true));
         ...
         _loc1_.push(new PropertyStruct("spacing",_field.defaultTextFormat.letterSpacing,PropertyStruct.const_600,_field.defaultTextFormat.letterSpacing != 0));
         return _loc1_;
      }
