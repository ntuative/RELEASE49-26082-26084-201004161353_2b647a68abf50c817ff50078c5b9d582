package com.sulake.core.window.components
{
   ...
   public class InteractiveController extends WindowController implements IInteractiveWindow
   {
      ...
      protected static const const_1410:uint = 500;
      ...
      public function InteractiveController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         param4 |= 0;
         var_455 = new Array();
         var_455[0] = MouseCursorType.const_286;
         var_455[1] = MouseCursorType.const_42;
         var_455[2] = MouseCursorType.const_286;
         var_455[3] = MouseCursorType.const_286;
         var_455[4] = MouseCursorType.const_42;
         var_455[5] = MouseCursorType.const_42;
         var_455[6] = MouseCursorType.const_286;
         if(var_328 == null)
         {
            var_328 = new Array();
            var_328[0] = WindowState.const_98;
            var_328[1] = WindowState.const_77;
            var_328[2] = WindowState.const_81;
            var_328[3] = WindowState.const_67;
            var_328[4] = WindowState.WINDOW_STATE_SELECTED;
            var_328[5] = WindowState.const_99;
      ...
      {
         param2.push(new PropertyStruct(const_1037,param1.toolTipCaption,PropertyStruct.STRING,param1.toolTipCaption != const_746));
         param2.push(new PropertyStruct(KEY_TOOLTIP_DELAY,param1.toolTipDelay,PropertyStruct.const_879,param1.toolTipDelay != const_1410));
         return param2;
      }
      ...
      {
         var_954 = param1 == null ? const_746 : param1;
      }
