package com.sulake.core.window.components
{
   ...
   public class SelectorController extends InteractiveController implements ISelectorWindow, IIterable
   {
      ...
      protected var var_2291:Boolean = true;
      ...
      {
         if(param2.type == WindowNotifyEvent.const_194)
         {
         ...
         if(param1 != null)
         {
            if(param1 != _selected)
            {
               ...
               if(getChildIndex(param1) > -1)
               {
                  ...
                  notifyEventListeners(new WindowNotifyEvent(WindowNotifyEvent.const_335,this,_selected));
               }
            }
         }
      }
