package com.sulake.core.window.components
{
   ...
   public class SelectableButtonController extends ButtonController implements ISelectableWindow
   {
      ...
      {
         var _loc3_:* = null;
         if(param2.type == WindowNotifyEvent.const_297)
         {
            if(var_8)
            {
               if(!(var_8 is ISelectorWindow))
               {
                  ...
                  while(_loc3_)
                  {
                     ...
                     {
                        _loc3_.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_194,this,null));
                        break;
                     }
      ...
      public function select() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_468,this,null);
         update(this,_loc1_);
      ...
      public function unselect() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_521,this,null);
         update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
         ...
         _loc1_.type = WindowNotifyEvent.const_656;
         update(this,_loc1_);
         return true;
      }
   }
