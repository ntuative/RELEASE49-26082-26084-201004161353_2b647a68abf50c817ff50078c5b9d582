package com.sulake.core.window.components
{
   ...
   public class TextFieldController extends TextController implements ITextFieldWindow
   {
      ...
      protected var var_928:Boolean = false;
      
      protected var var_953:uint = 500;
      
      protected var var_949:Boolean = false;
      ...
      override public function getGraphicContext(param1:Boolean) : IGraphicContext
      {
         if(param1 && !var_16)
         {
            var_16 = new GraphicContext("GC {" + _name + "}",GraphicContext.const_936,var_7);
         }
         return var_16;
      }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct("focus_capturer",var_949,PropertyStruct.const_59,var_949 != false));
         return _loc1_;
      }
      ...
      protected function refreshAutoSize() : void
      {
         ...
         var _loc2_:* = null;
         var _loc3_:* = null;
         if(var_928 && autoSize != TextFieldAutoSize.NONE)
         {
            if(false)
            {
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         for each(_loc2_ in param1)
         {
            ...
            {
               var_949 = _loc2_.value as Boolean;
               if(var_949)
               {
