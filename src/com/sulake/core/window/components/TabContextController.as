package com.sulake.core.window.components
{
   ...
   public class TabContextController extends WindowController implements ITabContextWindow, IIterable
   {
      ...
      protected var var_943:ITabSelectorWindow;
      ...
      public function get container() : IWindowContainer
      {
         if(var_1612 == null)
         {
            var_1612 = findChildByTag(TabContextController.const_1068) as IWindowContainer;
         }
         return var_1612;
      }
      ...
      public function get selector() : ITabSelectorWindow
      {
         if(var_943 == null)
         {
            var_943 = findChildByTag(TabContextController.const_1067) as ITabSelectorWindow;
            if(var_943 != null)
            {
               var_943.procedure = selectorEventProc;
            }
         }
         return var_943;
      }
      ...
      {
         return !!var_928 ? selector.iterator : null;
      }
