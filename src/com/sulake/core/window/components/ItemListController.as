package com.sulake.core.window.components
{
   ...
   public class ItemListController extends WindowController implements IItemListWindow
   {
      ...
      protected static const const_1031:String = "resize_on_item_update";
      
      protected static const const_1032:String = "spacing";
      ...
      protected static const const_1034:String = "auto_arrange_items";
      ...
      protected var var_1115:Boolean = false;
      ...
      protected var var_1393:Boolean = false;
      ...
      public function ItemListController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         var_88 = 0;
         var_66 = 0;
         _horizontal = param2 == WindowType.const_299;
         super(param1,param2,param3,param4,param5,param6,param7,param8,param9,param10,param11);
         var_159 = var_640 || !testParamFlag(WindowParam.const_34);
         _container = var_15.create("_CONTAINER","",WindowType.const_295,WindowStyle.const_310,0 | 0 | 0,new Rectangle(0,0,width,height),null,this,0,null,[WindowController.INTERNAL_CHILD_TAG,WindowController.EXCLUDE_CHILD_TAG]) as IWindowContainer;
         _container.addEventListener(WindowEvent.const_46,containerEventHandler);
         _container.addEventListener(WindowEvent.const_472,containerEventHandler);
         _container.addEventListener(WindowEvent.const_245,containerEventHandler);
         _container.addEventListener(WindowEvent.const_481,containerEventHandler);
         resizeOnItemUpdate = var_1115;
      }
      ...
      {
         return new Rectangle(var_542 * maxScrollH,var_544 * maxScrollV,width,height);
      }
      ...
      override public function dispose() : void
      {
         ...
         _container.removeEventListener(WindowEvent.const_472,containerEventHandler);
         _container.removeEventListener(WindowEvent.const_245,containerEventHandler);
         _container.removeEventListener(WindowEvent.const_481,containerEventHandler);
         super.dispose();
      }
      ...
      public function set scrollH(param1:Number) : void
      {
         ...
         if(param1 != var_542)
         {
            ...
            var_15.invalidate(_container,visibleRegion,WindowRedrawFlag.const_75);
         }
      }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(const_1032,_spacing,PropertyStruct.const_64,_spacing != DEF_SPACING));
         _loc1_.push(new PropertyStruct(const_1034,var_771,PropertyStruct.const_59,var_771 != const_1406));
         _loc1_.push(new PropertyStruct(const_1033,var_543,PropertyStruct.const_59,var_543 != const_1407));
         _loc1_.push(new PropertyStruct(const_1031,var_1115,PropertyStruct.const_59,var_1115 != DEF_RESIZE_ON_ITEM_UPDATE));
         return _loc1_;
      }
      ...
      public function set scrollV(param1:Number) : void
      {
         ...
         {
            var_544 = param1;
            _container.y = -var_544 * maxScrollV;
            var_15.invalidate(_container,visibleRegion,WindowRedrawFlag.const_75);
         }
      }
      ...
      private function containerEventHandler(param1:Event) : void
      {
         switch(param1.type)
         {
            case WindowEvent.const_472:
               updateScrollAreaRegion();
               break;
            case WindowEvent.const_245:
               if(!var_1393)
               {
                  updateScrollAreaRegion();
               }
               break;
            case WindowEvent.const_481:
               updateScrollAreaRegion();
               break;
      ...
      public function set resizeOnItemUpdate(param1:Boolean) : void
      {
         ...
         if(_container)
         {
            if(_horizontal)
            {
               _container.setParamFlag(WindowParam.const_371,param1);
            }
            else
            {
