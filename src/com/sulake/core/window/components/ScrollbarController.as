package com.sulake.core.window.components
{
   ...
   public class ScrollbarController extends InteractiveController implements IScrollbarWindow
   {
      ...
      private static const const_1050:String = "increment";
      
      private static const const_488:String = "slider_bar";
      
      private static const const_1049:String = "decrement";
      
      private static const const_750:String = "slider_track";
      ...
      public function ScrollbarController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function, param9:Array = null, param10:Array = null, param11:uint = 0, param12:IScrollableWindow = null)
      {
         ...
         var_159 = false;
         var_20 = param12;
         _horizontal = param2 == WindowType.const_400;
      ...
      override public function update(param1:WindowController, param2:Event) : Boolean
      {
         switch(param1.name)
         {
            case ScrollbarController.const_488:
               if(param2.type == WindowNotifyEvent.const_249)
               {
                  if(!var_561)
                  {
                     if(_horizontal)
      ...
      {
         return findChildByName(ScrollbarController.const_750) as WindowController;
      }
      ...
      {
         return track.findChildByName(ScrollbarController.const_488) as WindowController;
      }
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         while(_loc4_ < _loc2_)
         {
            ...
            {
               var_796 = _loc3_.value as String;
            }
            _loc4_++;
         }
      ...
      private function resolveScrollTarget() : Boolean
      {
         ...
         if(var_796 != null)
         {
            _loc1_ = findParentByName(var_796) as IScrollableWindow;
            if(_loc1_ == null && var_8 is IWindowContainer)
            {
               _loc1_ = IWindowContainer(var_8).findChildByName(var_796) as IScrollableWindow;
               if(_loc1_)
               {
                  scrollable = _loc1_;
                  return true;
      ...
      private function scrollButtonEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            if(param2.name == ScrollbarController.const_1050)
            {
               if(var_20)
               {
                  var_561 = true;
            ...
            else if(param2.name == ScrollbarController.const_1049)
            {
               if(var_20)
               {
                  var_561 = true;
            ...
            else if(param2.name == ScrollbarController.const_750)
            {
               _loc4_ = new Point();
               ...
               _loc5_ = WindowController(param2).getChildByName(ScrollbarController.const_488).rectangle;
               if(_horizontal)
               {
         ...
         if(param1.type == WindowMouseEvent.const_943)
         {
