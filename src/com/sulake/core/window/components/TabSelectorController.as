package com.sulake.core.window.components
{
   ...
   public class TabSelectorController extends SelectorController implements ITabSelectorWindow
   {
      ...
      {
         if(param2.type == WindowNotifyEvent.const_328)
         {
            updateSelectableRegion();
         }
         else if(param2.type == WindowNotifyEvent.const_254)
         {
            updateSelectableRegion();
         }
         else if(param2.type == WindowNotifyEvent.const_249)
         {
            updateSelectableRegion();
         }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct("spacing",_spacing,PropertyStruct.const_64,_spacing != 0));
         return _loc1_;
      }
