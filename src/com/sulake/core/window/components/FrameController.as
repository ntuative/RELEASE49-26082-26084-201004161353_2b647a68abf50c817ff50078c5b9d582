package com.sulake.core.window.components
{
   ...
   public class FrameController extends ContainerController implements IFrameWindow
   {
      ...
      private static const const_1077:String = "_HEADER";
      
      private static const const_756:String = "margin_right";
      
      private static const const_1078:String = "_SCALER";
      
      private static const const_1040:String = "_TITLE";
      
      private static const const_1076:String = "_CONTENT";
      
      private static const const_759:String = "margin_left";
      
      private static const const_758:String = "margin_bottom";
      ...
      private var var_1180:IHeaderWindow;
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(const_759,_loc3_.left,PropertyStruct.const_64,_loc2_));
         _loc1_.push(new PropertyStruct(const_757,_loc3_.top,PropertyStruct.const_64,_loc2_));
         _loc1_.push(new PropertyStruct(const_756,0 - _loc3_.right,PropertyStruct.const_64,_loc2_));
         _loc1_.push(new PropertyStruct(const_758,0 - _loc3_.bottom,PropertyStruct.const_64,_loc2_));
         return _loc1_;
      }
      ...
      private function setupScaling() : void
      {
         ...
         var _loc2_:Boolean = testParamFlag(WindowParam.const_256);
      ...
      public function get header() : IHeaderWindow
      {
         if(var_1180 == null)
         {
            var_1180 = findChildByTag(const_1077) as IHeaderWindow;
            if(!var_1180)
            {
      ...
      {
         return findChildByTag(const_1078) as IScalerWindow;
      }
      ...
      private function marginsCallback(param1:IMargins) : void
      {
         ...
         if(_loc5_)
         {
            _loc2_.setParamFlag(WindowParam.const_242,false);
         }
      ...
      {
         return content != null && var_1394 ? content.iterator : new Iterator(this);
      }
      ...
      public function get content() : IWindowContainer
      {
         if(var_19 == null)
         {
            var_19 = findChildByTag(const_1076) as IWindowContainer;
            if(!var_19)
            {
