package com.sulake.core.communication.connection
{
   ...
   public class SocketConnection extends EventDispatcher implements IConnection, IDisposable
   {
      ...
      public static const const_1314:int = 10000;
      ...
      private var var_647:IEncryption;
      ...
      private var var_554:IProtocol;
      
      private var var_781:IMessageClassManager;
      ...
      public function SocketConnection(param1:String, param2:ICoreCommunicationManager, param3:IConnectionStateListener)
      {
         ...
         var_781 = new MessageClassManager();
         var_73 = new Socket();
         var_337 = new Timer(const_1314,1);
      ...
      public function send(param1:IMessageComposer, param2:int = -1) : Boolean
      {
         ...
         var _loc4_:int = this.var_781.getMessageComposerID(param1);
         if(_loc4_ < 0)
         {
            return false;
         }
         var _loc5_:ByteArray = var_554.encoder.encode(_loc4_,param1.getMessageArray(),param2);
         if(var_335)
         {
         ...
         if(var_647 != null)
         {
            _loc3_ = var_647.encipher(_loc5_);
         }
         else
         {
            _loc3_ = _loc5_;
      ...
      private function onRead(param1:ProgressEvent) : void
      {
         ...
         while(false)
         {
            var_336.writeByte(var_73.readUnsignedByte());
         }
      }
      ...
      {
         var_289.addConnectionMessageEvent(_id,param1);
      }
      ...
      {
         var_781.registerMessages(param1);
      }
      ...
      public function processReceivedData() : void
      {
         ...
         var _loc2_:uint = var_554.getMessages(var_336,_loc1_);
         ...
         for each(_loc4_ in _loc1_)
         {
            ...
            _loc7_ = var_781.getMessageEventClasses(_loc5_);
            _loc8_ = new Array();
            for each(_loc9_ in _loc7_)
            {
               _loc13_ = var_289.getMessageEvents(this,_loc9_);
            ...
            for each(_loc12_ in _loc8_)
            {
               ...
               if(_loc14_ != null)
               {
                  ...
                  if(_loc14_ != _loc11_)
                  {
                     ...
                     _loc10_ = var_289.getMessageParser(_loc14_);
                     if(_loc10_.flush())
                     {
      ...
      override public function toString() : String
      {
         ...
         return _loc1_ + ("Encryption: " + var_647 + "\n");
      }
   }
}
