package com.sulake.core.communication
{
   ...
   public class CoreCommunicationManager extends Component implements ICoreCommunicationManager, IUpdateReceiver
   {
      ...
      private var var_1240:IConnectionStateListener;
      ...
      public function CoreCommunicationManager(param1:IContext, param2:uint = 0)
      {
         ...
         var_713 = new Dictionary();
         var_712 = new Dictionary();
         var_1239 = new Array();
      ...
      public function getMessageEvents(param1:IConnection, param2:Class) : Array
      {
         ...
         var _loc5_:Array = var_712[_loc3_];
      ...
      {
         var _loc3_:Array = var_712[param1];
         if(_loc3_ == null)
         {
            _loc3_ = new Array();
            var_712[param1] = _loc3_;
         }
         _loc3_.push(param2);
      }
      ...
      public function getMessageParser(param1:Class) : IMessageParser
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         for each(var _loc6_ in var_1239)
         {
            _loc3_ = _loc6_;
            _loc6_;
            if(_loc3_ is param1)
      ...
      {
         var _loc2_:Class = var_713[param1];
         var _loc3_:* = null;
         if(_loc2_ != null)
         {
      ...
      public function createConnection(param1:String, param2:uint = 0) : IConnection
      {
         ...
         switch(param2)
         {
            case ConnectionType.const_865:
               _loc3_ = new SocketConnection(param1,this,var_1240);
               break;
            default:
