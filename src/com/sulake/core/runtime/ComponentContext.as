   ...
   public class ComponentContext extends Component implements IContext
   {
      ...
      protected final function announceInterfaceAvailability(param1:IID, param2:Component) : void
      {
         ...
         while(_loc6_ < _loc5_)
         {
            ...
            if(_loc4_ == null)
            {
               error("Interface " + param1 + " still unavailabe!",true,Core.const_1268);
            }
      ...
      protected function loadErrorHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         removeLibraryLoader(_loc2_);
         error("Failed to download component resource \"" + _loc2_.url + "\"!" + "\r" + _loc3_,true,Core.const_593);
      }
         ...
         while(i < componentList.length())
         {
            ...
            if(assetCount > 0)
            {
               ...
               while(k < assetCount)
               {
                  ...
                  {
                     error("Manifest for component " + componentString + " contains broken asset \"" + assetName + "\"!",true,Core.const_684);
                  }
                  k++;
               }
            }
            ...
            if(componentClass == null)
            {
               error("Invalid component class " + componentString + "!",true,Core.const_684);
               return false;
            }
            ...
            if(component != null)
            {
               if(assetLibrary != null)
               {
                  if(component.assets != assetLibrary)
                  {
                     ...
                     error("Component \"" + componentString + "\" did not save provided asset library!",true,Core.const_684);
                  }
               }
