package com.sulake.core.runtime
{
   ...
   public class Component implements IUnknown
   {
      ...
      public static const const_1445:uint = 1;
      
      public static const COMPONENT_EVENT_DEBUG:String = "COMPONENT_EVENT_DEBUG";
      
      public static const const_806:uint = 4;
      ...
      protected var var_2089:Boolean = false;
      ...
      public function release(param1:IID) : uint
      {
         ...
         if(_loc2_ == null)
         {
            var_948 = "Attempting to release unknown interface:" + param1 + "!";
            throw new Error(var_948);
         }
         var _loc3_:uint = _loc2_.release();
         if(var_1113 & const_806)
         {
            if(_loc3_ == 0)
            {
