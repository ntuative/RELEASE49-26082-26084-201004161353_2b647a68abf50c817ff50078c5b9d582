package com.sulake.core.assets
{
   ...
   public class AssetLibrary extends EventDispatcher implements IAssetLibrary
   {
      ...
      private static var var_1082:Array = new Array();
      
      private static var _sharedListOfTypesByMime:Dictionary;
      
      private static var var_622:uint = 0;
      
      public static const const_981:String = "AssetLibraryReady";
      
      public static const const_1247:String = "AssetLibraryUnloaded";
      
      public static const const_433:String = "AssetLibraryLoaded";
      
      public static const const_1337:String = "AssetLibraryLoadError";
       
      
      private var var_529:XML;
      ...
      private var var_530:Boolean = true;
      
      private var var_366:Class;
      ...
      public function getAssetTypeDeclarationByFileName(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         for(_loc5_ in var_440)
         {
            _loc4_ = AssetTypeDeclaration(var_440[_loc5_]);
            if(_loc4_ != null)
            {
               if(_loc4_.fileTypes.indexOf(_loc3_))
               {
      ...
      public function unload() : void
      {
         ...
         for(_loc1_ in var_754)
         {
            delete var_754[_loc1_];
         }
         if(var_14 != null)
         {
            var_14.dispose();
      ...
      private function libraryLoadedHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         var_529 = _loc2_.manifest.copy();
         var_366 = _loc2_.resource;
         if(var_530)
         {
            AssetLibrary.fetchLibraryContents(this,var_529,var_366);
         }
         var_315 = true;
         dispatchEvent(new Event(AssetLibrary.const_433));
         dispatchEvent(new Event(AssetLibrary.const_981));
         if(var_530)
         {
            var_14.dispose();
            var_14 = null;
      ...
      public function loadAssetFromFile(param1:String, param2:URLRequest, param3:String = null) : AssetLoaderStruct
      {
         ...
         var _loc4_:AssetLoaderStruct = var_439[param2.url];
         if(_loc4_ != null)
         {
         ...
         _loc6_.addEventListener(AssetLoaderEvent.const_957,assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_978,assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_949,assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_985,assetLoadEventHandler);
         _loc4_ = new AssetLoaderStruct(param1,_loc6_);
         var_439[param2.url] = _loc4_;
         return _loc4_;
      }
      ...
      public function registerAssetTypeDeclaration(param1:AssetTypeDeclaration, param2:Boolean = true) : Boolean
      {
         ...
         {
            if(var_440.hasOwnProperty(param1.mimeType))
            {
               throw new Error("Asset type " + param1.mimeType + " already registered!");
            }
            var_440[param1.mimeType] = param1;
         }
         return true;
      }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            unload();
            super.dispose();
            var_1082.splice(var_1082.indexOf(this),1);
            --var_622;
            var_439 = null;
            var_754 = null;
            _loadedAssets = null;
      ...
      {
         return param1 < var_365.length ? getAssetByName(var_365[param1]) : null;
      }
      ...
      private function loadErrorHandler(param1:Event) : void
      {
         ...
         dispatchEvent(new Event(AssetLibrary.const_1337));
      }
      ...
      public function getAssetTypeDeclarationByClass(param1:Class, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         for(_loc4_ in var_440)
         {
            _loc3_ = AssetTypeDeclaration(var_440[_loc4_]);
            if(_loc3_ != null)
            {
               if(_loc3_.assetClass == param1)
               {
      ...
      {
         var _loc2_:Class = var_754[param1];
         if(_loc2_ != null)
         {
            return _loc2_;
         }
      ...
      private function fetchAssetFromResource(param1:String) : IAsset
      {
         ...
         var _loc2_:XMLList = var_529.child("library");
         if(_loc2_ == null)
         {
         ...
         if(_loc2_ != null)
         {
            ...
            while(_loc6_ < _loc2_.length())
            {
               ...
               if(_loc3_.attribute("name") == param1)
               {
                  ...
                  _loc5_.setUnknownContent(var_366[param1]);
      ...
      private function assetLoadEventHandler(param1:AssetLoaderEvent) : void
      {
         ...
         var struct:AssetLoaderStruct = var_439[loader.url];
         if(struct == null)
         {
      ...
      public function removeAsset(param1:IAsset) : IAsset
      {
         ...
         if(param1)
         {
            for(_loc2_ in _loadedAssets)
            {
               if(_loadedAssets[_loc2_] == param1)
               {
                  var_365.splice(var_365.indexOf(_loc2_),1);
      ...
      public function getAssetTypeDeclarationByMimeType(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         _loc3_ = AssetTypeDeclaration(var_440[param1]);
         if(_loc3_ != null)
         {
            return _loc3_;
         }
      ...
      {
         return var_366 != null ? false : false;
      }
   }
}
