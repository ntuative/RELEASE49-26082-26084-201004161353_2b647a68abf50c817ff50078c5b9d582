   ...
   public class BitmapDataAsset implements IAsset
   {
      ...
      public function setUnknownContent(param1:Object) : void
      {
         ...
         if(param1 is BitmapDataAsset)
         {
            _bitmap = BitmapDataAsset(param1)._bitmap;
            _offset = BitmapDataAsset(param1)._offset;
            var_979 = BitmapDataAsset(param1).var_979;
            var_978 = BitmapDataAsset(param1).var_978;
            if(_bitmap != null)
            {
               return;
            }
         ...
         while(_loc2_ < param1.length())
         {
            ...
            switch(_loc3_)
            {
               case "offset":
                  ...
                  break;
               case "flipH":
                  var_979 = _loc4_ == "1" || _loc4_ == "RoomReadyMessageParser";
                  break;
               case "flipV":
                  var_978 = _loc4_ == "1" || _loc4_ == "RoomReadyMessageParser";
                  break;
            }
            _loc2_++;
         }
