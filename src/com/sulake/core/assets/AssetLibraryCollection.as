package com.sulake.core.assets
{
   ...
   public class AssetLibraryCollection extends EventDispatcher implements IAssetLibrary
   {
      ...
      protected var var_1114:LoaderContext;
      
      protected var var_30:Array;
      
      protected var var_545:Array;
      
      private var var_642:uint = 0;
      ...
      public function AssetLibraryCollection(param1:String)
      {
         ...
         var_30 = new Array();
         var_545 = new Array();
         var_1114 = new LoaderContext(false,ApplicationDomain.currentDomain,null);
         var_375 = new AssetLibrary("lib-" + var_642++);
         var_30.push(var_375);
      }
      ...
      public function loadFromFile(param1:URLRequest, param2:Boolean = false, param3:LoaderContext = null) : LibraryLoader
      {
         ...
         var _loc4_:IAssetLibrary = new AssetLibrary("lib-" + var_642++);
         var_545.push(_loc4_);
