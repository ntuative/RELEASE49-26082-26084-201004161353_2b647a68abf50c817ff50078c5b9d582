package com.sulake.room.renderer
{
   ...
   public class RoomSpriteCanvas implements IRoomRenderingCanvas
   {
      ...
      private static const const_774:int = 50;
      ...
      private var var_1963:Number = -10000000;
      
      private var var_1962:Number = -10000000;
      ...
      public function update() : void
      {
         if(var_1020 == 0)
         {
            checkMouseHits(var_1018.x,var_1018.y,MouseEvent.MOUSE_MOVE);
         }
         var_1020 = 0;
         ++var_1479;
      }
      ...
      {
         var _loc11_:Number = param1 - var_701 / 2;
         var _loc12_:Number = param2 - var_700 / 2;
         var _loc13_:* = null;
      ...
      public function render(param1:int) : void
      {
         ...
         if(var_701 != var_1964 || var_700 != var_1960)
         {
            _loc10_ = true;
         }
         _loc5_ = 0;
         ...
         var_409.sortOn("z",0 | 0);
         if(_loc6_ < var_409.length)
         {
            var_409.splice(_loc6_);
         }
         var _loc11_:* = null;
         _loc5_ = 0;
         while(_loc5_ < _loc6_)
         {
            _loc11_ = var_409[_loc5_] as SortableSprite;
            if(_loc11_ != null)
            {
         ...
         var_842.push(_loc12_ - _loc2_);
         if(var_842.length == const_774)
         {
            _loc13_ = 0;
            _loc14_ = 0;
            while(_loc14_ < const_774)
            {
               _loc13_ += var_842[_loc14_];
               _loc14_++;
            }
            var_842 = [];
         }
      ...
      private function processMouseEvents() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         if(_container == null || var_303 == null)
         {
            return;
         }
         var _loc1_:int = 0;
         ...
         {
            _loc2_ = var_303.getKey(_loc1_);
            _loc3_ = var_303.getWithIndex(_loc1_);
            if(_loc2_ != null && _loc3_ != null)
            {
               ...
               if(_loc4_ != null)
               {
                  if(var_1019 != null)
                  {
                     var_1019.processRoomCanvasMouseEvent(_loc3_,_loc4_,_id + var_1479,geometry);
                  }
                  else
                  {
      ...
      {
         if(param1 < 0 || param1 >= var_409.length)
         {
            return null;
         }
         return var_409[param1] as SortableSprite;
      }
      
      private function bufferMouseEvent(param1:RoomSpriteMouseEvent, param2:String) : void
      {
         if(var_303 != null && param1 != null)
         {
            var_303.add(param2,param1);
         }
      }
            ...
            if(_loc10_ != null && _loc10_.hitTestPoint(param1 - _loc10_.x,param2 - _loc10_.y))
            {
               if(param3 != MouseEvent.CLICK && param3 != MouseEvent.DOUBLE_CLICK || !_loc10_.clickHandling)
               {
                  ...
                  if(_loc12_.indexOf(_loc9_) < 0)
                  {
                     ...
                     if(param3 != MouseEvent.MOUSE_MOVE || param1 != var_1963 || param2 != var_1962)
                     {
                        bufferMouseEvent(_loc11_,_loc9_);
                     }
                     _loc12_.push(_loc9_);
      ...
      private function renderObject(param1:IRoomObject, param2:String, param3:int, param4:Boolean) : int
      {
         ...
         _loc12_ += int(var_701 / 2);
         _loc13_ += int(var_700 / 2);
         var _loc15_:int = 0;
         var _loc16_:* = null;
         var _loc17_:* = null;
         var _loc18_:int = 0;
         ...
         while(_loc21_ < _loc11_)
         {
            ...
            if(_loc17_ != null && _loc17_.visible)
            {
               ...
               if(_loc22_ != null)
               {
                  ...
                  if(_loc18_ + _loc22_.width >= 0 && _loc18_ < var_701 && (_loc19_ + _loc22_.height >= 0 && _loc19_ < var_700))
                  {
