package com.sulake.room
{
   ...
   public class RoomManager extends Component implements IRoomManager, IRoomInstanceContainer
   {
      ...
      private var var_848:XML = null;
      
      private var var_31:int = 0;
      
      private var var_108:IRoomManagerListener;
      ...
      private var var_499:IRoomObjectFactory = null;
      
      private var var_1419:int;
      
      private var var_2384:IRoomContentLoader;
      ...
      public function RoomManager(param1:IContext, param2:uint = 0)
      {
         ...
         _events.addEventListener(RoomContentLoadedEvent.const_367,onContentLoaded);
      ...
      public function createRoomObject(param1:String, param2:int, param3:String, param4:int) : IRoomObject
      {
         ...
         var _loc19_:IRoomObjectEventHandler = var_499.createRoomObjectLogic(_loc11_);
      ...
      private function objectFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_499 = param2 as IRoomObjectFactory;
      ...
      public function createRoomObjectManager() : IRoomObjectManager
      {
         if(var_499 != null)
         {
            return var_499.createRoomObjectManager();
         }
         return null;
      }
      ...
      private function onContentLoaded(param1:RoomContentLoadedEvent) : void
      {
         ...
         if(_loc2_ == null)
         {
            if(var_108 != null)
            {
               var_108.contentLoaded(null,false);
            }
            return;
         }
         ...
         if(_loc3_ == null)
         {
            if(var_108 != null)
            {
               var_108.contentLoaded(_loc2_,false);
            }
            return;
         }
         ...
         if(var_108 != null)
         {
            var_108.contentLoaded(_loc2_,true);
         }
         if(false)
         {
      ...
      private function processInitialContentLoad(param1:String) : void
      {
         ...
         if(var_42.getGraphicAssetCollection(param1) != null)
         {
            _loc2_ = var_501.indexOf(param1);
            if(_loc2_ >= 0)
            {
               var_501.splice(_loc2_,1);
            }
            if(false)
            {
               ...
               if(var_108 != null)
               {
                  var_108.roomManagerInitialized();
               }
            }
         }
         else
         {
            var_31 = const_644;
            var_108.roomManagerInitialized(false);
         }
      }
                        ...
                        if(_loc16_ == param1)
                        {
                           ...
                           if(_loc19_ != null)
                           {
                              ...
                              else
                              {
                                 ...
                                 _loc20_ = var_499.createRoomObjectLogic(_loc18_);
                                 ...
                                 if(var_108 != null)
                                 {
                                    var_108.objectInitialized(_loc8_,_loc14_.getId(),_loc11_);
                                 }
                              }
                           }
                           else
