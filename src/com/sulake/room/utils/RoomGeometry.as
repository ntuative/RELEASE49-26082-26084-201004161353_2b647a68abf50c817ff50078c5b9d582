package com.sulake.room.utils
{
   ...
   public class RoomGeometry implements IRoomGeometry
   {
      ...
      public static const const_551:Number = 64;
      
      public static const const_956:Number = 32;
      ...
      private var var_1545:Number = 1;
      
      private var var_2360:Number = 500;
      
      private var var_1544:Number = 1;
      
      private var var_83:Vector3d;
      
      private var var_84:Vector3d;
      
      private var var_2361:Number = -500;
      ...
      public function RoomGeometry(param1:Number, param2:IVector3d, param3:IVector3d, param4:IVector3d = null)
      {
         ...
         _y = new Vector3d();
         var_84 = new Vector3d();
         var_1065 = new Vector3d();
         var_1546 = 1;
         var_1544 = 1;
         x_scale = 1;
         y_scale = 1;
         var_1545 = Math.sqrt(0.5) / Math.sqrt(0.75);
         z_scale = 1;
      ...
      {
         if(var_426 != param1 * var_1545)
         {
            var_426 = param1 * var_1545;
            ++var_76;
         }
      }
      ...
      {
         if(var_427 != param1 * var_1546)
         {
            var_427 = param1 * var_1546;
            ++var_76;
         }
      }
      ...
      {
         if(var_428 != param1 * var_1544)
         {
            var_428 = param1 * var_1544;
            ++var_76;
         }
      }
      ...
      public function setDisplacement(param1:IVector3d, param2:IVector3d) : void
      {
         ...
         if(var_425 != null)
         {
            ...
            var_425.remove(_loc3_);
            _loc4_ = new Vector3d();
            _loc4_.assign(param2);
            var_425.add(_loc3_,_loc4_);
            ++var_76;
         }
      }
      ...
      public function setDepthVector(param1:IVector3d) : void
      {
         ...
         if(_loc7_ != 0)
         {
            ...
            var_1065.assign(_loc22_);
         }
         else
         {
            var_1065.assign(_loc17_);
         }
         ++var_76;
      }
      ...
      public function getScreenPosition(param1:IVector3d) : IVector3d
      {
         ...
         _loc2_.y *= var_428;
         _loc2_.z *= var_426;
         var _loc3_:Number = Vector3d.scalarProjection(_loc2_,var_1065);
         if(_loc3_ < var_2361 || _loc3_ > var_2360)
         {
            return null;
         }
         ...
         if(_loc6_ != null)
         {
            ...
            _loc2_.y *= var_428;
            _loc2_.z *= var_426;
            _loc3_ = Vector3d.scalarProjection(_loc2_,var_1065);
         }
      ...
      {
         return new Vector3d(0 * var_427,0 * var_428,0 * var_426);
      }
      ...
      {
         return scale == const_551;
      }
      
      public function get scale() : Number
      {
         return var_186 / Math.sqrt(0.5);
      }
      ...
      private function getDisplacenent(param1:IVector3d) : IVector3d
      {
         ...
         if(var_425 != null)
         {
            ...
            return var_425.getValue(_loc2_);
         }
         return null;
      }
      ...
      public function getPlanePosition(param1:Point, param2:IVector3d, param3:IVector3d, param4:IVector3d) : Point
      {
         ...
         var _loc5_:Number = param1.x / var_186;
         var _loc6_:Number = -param1.y / var_186;
         var _loc7_:IVector3d = Vector3d.sum(Vector3d.product(var_83,_loc5_),Vector3d.product(_y,_loc6_));
         var _loc8_:Vector3d = new Vector3d(0 * var_427,0 * var_428,0 * var_426);
         var _loc9_:IVector3d = Vector3d.sum(_loc8_,_loc7_);
         var _loc10_:IVector3d = var_84;
         var _loc11_:Vector3d = new Vector3d(param2.x * var_427,param2.y * var_428,param2.z * var_426);
         var _loc12_:Vector3d = new Vector3d(param3.x * var_427,param3.y * var_428,param3.z * var_426);
         var _loc13_:Vector3d = new Vector3d(param4.x * var_427,param4.y * var_428,param4.z * var_426);
