package com.sulake.habbo.session
{
   ...
   public class SessionDataManager extends Component implements ISessionDataManager
   {
      ...
      private var var_1469:UserTagManager;
      ...
      private var var_1470:GroupDetailsView;
      
      private var _name:String;
      
      private var var_492:int = 0;
      
      private var var_1013:FurnitureDataParser;
      ...
      private var var_837:IgnoredUsersManager;
      ...
      private var var_1012:ProductDataParser;
      ...
      public function SessionDataManager(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         var_695 = [];
         var_1469 = new UserTagManager(events);
         var_1014 = new HabboGroupInfoManager(this,events);
         var_837 = new IgnoredUsersManager(this);
      ...
      {
         var_1012.removeEventListener(ProductDataParser.READY,onProductsReady);
         var_1012 = null;
         var_582 = new Map();
         var_470 = new Map();
         var_408 = new Map();
         ...
         var_1013 = new FurnitureDataParser(_loc2_,var_582,var_470,var_408,_localization);
         var_1013.addEventListener(FurnitureDataParser.READY,onFurnitureReady);
      }
      
      public function getUserTags(param1:int) : Array
      {
         return var_1469.getTags(param1);
      }
      ...
      {
         var_899 = new Dictionary();
         var _loc2_:String = var_147.getKey("productdata.load.url");
         var _loc3_:String = var_147.getKey("external.hash");
         _loc2_ = _loc2_.replace("%hash%",_loc3_);
         var_1012 = new ProductDataParser(_loc2_,var_899);
         var_1012.addEventListener(ProductDataParser.READY,onProductsReady);
      }
      
      public function getProductData(param1:String) : IProductData
      {
         return var_899[param1];
      }
      ...
      {
         return var_1222.getBadgeImage(param1,BadgeImageManager.const_1030);
      }
      ...
      private function onUserObject(param1:IMessageEvent) : void
      {
         ...
         _id = _loc3_.id;
         _name = _loc3_.name;
         var_2123 = _loc3_.respectTotal;
         var_838 = _loc3_.respectLeft;
         var_492 = _loc3_.petRespectLeft;
         var_294 = _loc3_.figure;
         var_628 = _loc3_.sex;
         var_1130 = _loc3_.realName;
         var_837.initIgnoreList();
      }
      ...
      {
         return var_837.isIgnored(param1);
      }
      ...
      private function onAvailabilityStatus(param1:IMessageEvent) : void
      {
         ...
         var_1930 = _loc2_.isOpen;
         var_1929 = _loc2_.onShutDown;
      }
      ...
      public function giveRespect(param1:int) : void
      {
         ...
         if(param1 < 0 || var_838 < 1 || _loc2_ == null)
         {
      ...
      public function showGroupBadgeInfo(param1:int) : void
      {
         if(var_1470 == null)
         {
            var_1470 = new GroupDetailsView(this);
         }
         var _loc2_:HabboGroupDetails = var_1014.getGroupDetails(param1);
         if(_loc2_ != null)
         {
            var_1470.showGroupDetails(param1);
         }
      }
      
      private function onFurnitureReady(param1:Event = null) : void
      {
         var_1013.removeEventListener(FurnitureDataParser.READY,onFurnitureReady);
         var_1013 = null;
      }
      ...
      {
         var _loc2_:IConnection = _communication.getHabboMainConnection(null);
         if(param1 < 0 || var_492 < 1 || _loc2_ == null)
         {
      ...
      private function onUserChange(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.id == -1)
         {
            var_294 = _loc2_.figure;
            var_628 = _loc2_.sex;
            events.dispatchEvent(new HabboSessionFigureUpdatedEvent(_id,var_294,var_628));
         }
      }
      ...
      public function hasUserRight(param1:String) : Boolean
      {
         ...
         return var_695.indexOf(param1) >= 0;
      }
      ...
      {
         var_837.ignoreUser(param1);
      }
      
      private function onUserRights(param1:IMessageEvent) : void
      {
         var _loc2_:UserRightsMessageEvent = param1 as UserRightsMessageEvent;
         var_695 = _loc2_.rights;
      }
      ...
      private function onHabboCommunicationReady(param1:IID, param2:IUnknown) : void
      {
         ...
         var_1469.communication = _communication;
         var_1014.communication = _communication;
         var_837.registerMessageEvents();
      }
      ...
      public function getFloorItemData(param1:int) : IFurnitureData
      {
         ...
         return var_582.getValue(param1.toString());
      }
      ...
      public function get isAnyRoomController() : Boolean
      {
         ...
         return var_695.indexOf("fuse_any_room_controller") >= 0;
      }
      ...
      private function initBadgeImageManager() : void
      {
         ...
         var_1222 = new BadgeImageManager(_loc1_,events,var_147,_localization);
      }
