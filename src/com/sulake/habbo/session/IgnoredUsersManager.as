package com.sulake.habbo.session
{
   ...
   public class IgnoredUsersManager
   {
      ...
      private var var_37:SessionDataManager;
      ...
      {
         var_1270.push(param1);
         var _loc2_:IConnection = var_37.communication.getHabboMainConnection(null);
         _loc2_.send(new IgnoreUserMessageComposer(param1));
      }
      
      public function initIgnoreList() : void
      {
         var _loc1_:IConnection = var_37.communication.getHabboMainConnection(null);
         _loc1_.send(new GetIgnoredUsersMessageComposer(var_37.userName));
      }
      ...
      private function onIgnoreResult(param1:IMessageEvent) : void
      {
         ...
         var _loc3_:String = String(var_1270.shift());
