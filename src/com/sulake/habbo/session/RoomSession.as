package com.sulake.habbo.session
{
   ...
   public class RoomSession implements IRoomSession
   {
      ...
      private var var_967:UserDataManager;
      ...
      {
         if(var_31 == RoomSessionEvent.const_305 && _connection != null)
         {
            var_31 = RoomSessionEvent.const_100;
            if(isPrivateRoom)
            {
      ...
      {
         return var_967 as IUserDataManager;
      }
