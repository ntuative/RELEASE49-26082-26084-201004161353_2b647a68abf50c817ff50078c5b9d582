package com.sulake.habbo.moderation
{
   ...
   public class RoomVisitsCtrl implements IDisposable, TrackedWindow
   {
      ...
      {
         var _loc3_:IWindowContainer = IWindowContainer(var_2156.clone());
      ...
      {
         var_2156 = IWindowContainer(_main.getXmlWindow("roomvisits_row"));
         ...
         var_49 = IItemListWindow(var_54.findChildByName("visits_list"));
