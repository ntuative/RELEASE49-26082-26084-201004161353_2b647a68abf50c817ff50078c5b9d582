package com.sulake.habbo.moderation
{
   ...
   public class RoomToolCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_1075:ICheckBoxWindow;
      ...
      private var var_740:ICheckBoxWindow;
      ...
      private function onChatlog(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _main.windowTracker.show(new ChatlogCtrl(new GetRoomChatlogMessageComposer(0,_data.flatId),_main,WindowTracker.const_539,_data.flatId),var_54,false,false,true);
      }
      ...
      {
         Logger.log("GOT ROOM INFO: " + param1.flatId + ", " + var_394);
         if(param1.flatId != var_394)
         {
            Logger.log("NOT THE SAME FLAT: " + param1.flatId + ", " + var_394);
            return;
         }
         _data = param1;
         populate();
      ...
      private function act(param1:Boolean) : void
      {
         ...
         var _loc2_:int = determineAction(param1,var_740.isSelected);
         _main.connection.send(new ModeratorActionMessageComposer(ModeratorActionMessageComposer.const_1273,_loc2_,var_385.text,"",""));
         if(false)
         {
            _main.connection.send(new ModerateRoomMessageComposer(_data.flatId,var_1075.isSelected,var_1076.isSelected,var_740.isSelected));
         }
         this.dispose();
      }
      ...
      private function determineAction(param1:Boolean, param2:Boolean) : int
      {
         ...
         return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1308);
      }
      
      public function populate() : void
      {
         var_49 = IItemListWindow(var_54.findChildByName("list_cont"));
         ...
         var_740 = ICheckBoxWindow(var_54.findChildByName("kick_check"));
         var_1075 = ICheckBoxWindow(var_54.findChildByName("lock_check"));
         var_1076 = ICheckBoxWindow(var_54.findChildByName("changename_check"));
      ...
      public function show() : void
      {
         ...
         _main.connection.send(new GetModeratorRoomInfoMessageComposer(var_394));
         Logger.log("BEGINNING TO SHOW: " + var_394);
      }
   }
}
