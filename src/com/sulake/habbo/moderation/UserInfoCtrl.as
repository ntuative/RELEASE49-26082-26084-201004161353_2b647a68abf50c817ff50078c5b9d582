package com.sulake.habbo.moderation
{
   ...
   public class UserInfoCtrl implements IDisposable
   {
      ...
      private static const const_791:int = 31536000;
      
      private static const const_788:int = 86400;
      
      private static const const_790:int = 3600;
      
      private static const const_789:int = 60;
      ...
      {
         if(param1 < 2 * const_789)
         {
            return param1 + " secs ago";
         }
         if(param1 < 2 * const_790)
         {
            return Math.round(param1 / const_789) + " mins ago";
         }
         if(param1 < 2 * const_788)
         {
            return Math.round(param1 / const_790) + " hours ago";
         }
         if(param1 < 2 * const_791)
         {
            return Math.round(param1 / const_788) + " days ago";
         }
         return Math.round(param1 / const_791) + " years ago";
      }
      ...
      private function onChatlogButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _main.windowTracker.show(new ChatlogCtrl(new GetUserChatlogMessageComposer(_data.userId),_main,WindowTracker.const_892,_data.userId),_callerFrame,var_1085,false,true);
      }
      
      private function prepare() : IWindowContainer
      {
         var _loc1_:IWindowContainer = IWindowContainer(var_918.findChildByName("user_info"));
         if(_loc1_ == null)
         {
            _loc1_ = IWindowContainer(_main.getXmlWindow("user_info"));
            var_918.addChild(_loc1_);
      ...
      private function onModActionButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _main.windowTracker.show(new ModActionCtrl(_main,_data.userId,_data.userName,var_1159),_callerFrame,var_1085,false,true);
      }
      ...
      private function onRoomVisitsButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _main.windowTracker.show(new RoomVisitsCtrl(_main,_data.userId),_callerFrame,var_1085,false,true);
      }
      ...
      private function onMessageButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _main.windowTracker.show(new SendMsgsCtrl(_main,_data.userId,_data.userName,var_1159),_callerFrame,var_1085,false,true);
      }
