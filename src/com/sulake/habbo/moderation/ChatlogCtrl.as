package com.sulake.habbo.moderation
{
   ...
   public class ChatlogCtrl implements IDisposable, TrackedWindow
   {
      ...
      {
         var_813 = IWindowContainer(_main.getXmlWindow("chatlog_roomheader"));
         var_812 = IWindowContainer(_main.getXmlWindow("chatlog_chatline"));
         var_434 = new Timer(300,1);
         var_434.addEventListener(TimerEvent.TIMER,onResizeTimer);
         var_54 = IFrameWindow(_main.getXmlWindow("chatlog_frame"));
         var_49 = IItemListWindow(var_54.findChildByName("chatline_list"));
         var_54.procedure = onWindow;
         var _loc1_:IWindow = var_54.findChildByTag("close");
         _loc1_.procedure = onClose;
         _main.connection.send(var_1508);
      ...
      {
         var _loc5_:* = null;
         var _loc2_:IWindowContainer = IWindowContainer(var_813.clone());
         var _loc3_:ITextWindow = ITextWindow(_loc2_.findChildByName("room_name_txt"));
         if(param1.roomId > 0)
         {
            _loc3_.caption = param1.roomName;
            new OpenRoomTool(var_54,_main,_loc3_,param1.isPublic,param1.roomId);
         }
         else
         {
      ...
      {
         if(param1.type != WindowEvent.const_46 || param2 != var_54)
         {
            return;
         }
      ...
      {
         var _loc4_:IWindowContainer = IWindowContainer(var_812.clone());
         _loc4_.color = var_1178[param2.chatterId] != null ? (!!param3 ? 4294623571 : uint(4294959680)) : (!!param3 ? 4288861930 : uint(4294967295));
         ...
         if(param2.chatterId > 0)
         {
            ...
            new OpenUserInfo(var_54,_main,_loc6_,param2.chatterId);
         }
