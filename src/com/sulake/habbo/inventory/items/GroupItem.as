package com.sulake.habbo.inventory.items
{
   ...
   public class GroupItem implements IGetImageListener
   {
      ...
      private const const_1646:int = 13421772;
      ...
      protected var var_2278:BitmapData;
      ...
      protected var var_452:int = 0;
      
      protected var var_1396:String;
      
      private const const_1645:int = 8947848;
      ...
      private const const_1420:Number = 0.2;
      
      protected var var_1385:Boolean;
      
      private const const_1419:Number = 1;
      ...
      public function getTotalCount() : int
      {
         ...
         var _loc2_:int = 0;
         var _loc3_:* = null;
         if(category == FurniCategory.const_590)
         {
            _loc1_ = 0;
            _loc2_ = 0;
            while(_loc2_ < _items.length)
      ...
      public function initImage() : void
      {
         ...
         {
            _loc1_ = _roomEngine.getFurnitureIcon(_type,this,String(var_1409));
         }
         else
         {
            _loc1_ = _roomEngine.getWallItemIcon(_type,this,var_1396);
         }
         if(_loc1_.id > 0)
         {
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc1_)
         {
            ...
            if(_loc2_ <= 0)
            {
               _window.blend = const_1420;
               _loc1_.blend = const_1420;
            }
            else
            {
               _window.blend = const_1419;
               _loc1_.blend = const_1419;
            }
         }
         if(isSelected)
         {
         ...
         if(_loc5_)
         {
            if(var_1385 && getRecyclableCount() > 0)
            {
               _loc5_.bitmap = var_2278;
               _loc5_.visible = true;
            }
            else
            {
