package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniModel implements IInventoryModel
   {
      ...
      public static const const_285:String = "pets";
      ...
      public function FurniModel(param1:HabboInventory, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IHabboCommunicationManager, param5:IAssetLibrary, param6:IRoomEngine, param7:IHabboLocalizationManager, param8:IHabboConfigurationManager)
      {
         ...
         _assets = param5;
         _roomEngine = param6;
         _roomEngine.events.addEventListener(RoomEngineObjectEvent.const_222,onObjectPlaced);
         var_487 = new Timer(const_1086,1);
         var_487.addEventListener(TimerEvent.TIMER_COMPLETE,onImageUpdateTimerEvent);
      ...
      {
         return var_47.getSubCategoryViewId() == InventorySubCategory.const_250;
      }
      ...
      public function getAllStripIds(param1:Array) : void
      {
         ...
         var _loc7_:int = 0;
         var _loc8_:int = 0;
         var _loc2_:Array = var_397.getKeys();
         var _loc3_:int = 0;
         while(_loc3_ < _loc2_.length)
         {
            _loc4_ = var_397.getValue(_loc2_[_loc3_]) as Array;
            if(_loc4_ != null)
            {
               _loc5_ = 0;
               while(_loc5_ < _loc4_.length)
               {
                  ...
                  if(_loc6_.category == FurniCategory.const_590)
                  {
                     _loc7_ = 1;
                  }
                  _loc8_ = 0;
      ...
      public function dispose() : void
      {
         if(!_disposed)
         {
            ...
            if(_roomEngine != null)
            {
               if(false)
               {
                  _roomEngine.events.removeEventListener(RoomEngineObjectEvent.const_222,onObjectPlaced);
               }
               _roomEngine = null;
            }
            _communication = null;
            ...
            if(var_487 != null)
            {
               var_487.removeEventListener(TimerEvent.TIMER_COMPLETE,onImageUpdateTimerEvent);
               var_487.stop();
               var_487 = null;
            }
            if(var_123 != null)
            {
               var_123.removeEventListener(TimerEvent.TIMER_COMPLETE,initTimeout);
               var_123.stop();
               var_123 = null;
            }
            if(var_680 != null)
      ...
      private function requestSelectedFurniToMover(param1:IItem) : void
      {
         ...
         if(param1.category == FurniCategory.const_175)
         {
      ...
      public function createNewGroupItemTemplate(param1:int, param2:String, param3:int, param4:String = null, param5:Number = NaN, param6:Boolean = false) : GroupItem
      {
         ...
         var _loc8_:* = null;
         var _loc9_:* = null;
         if(param3 == FurniCategory.const_291)
         {
         ...
         else if(param3 == FurniCategory.const_292)
         {
         ...
         else if(param3 == FurniCategory.const_283)
         {
         ...
         if(var_680 == null)
         {
            var_680 = _windowManager.buildFromXML(_groupItemWindowBase) as IWindowContainer;
         }
         var _loc11_:IWindowContainer = var_680.clone() as IWindowContainer;
      ...
      public function subCategorySwitch(param1:String) : void
      {
         switch(param1)
         {
            case InventorySubCategory.const_250:
               ...
               break;
            case InventorySubCategory.const_922:
               removeAllLocks();
               if(_view != null)
               {
                  _view.updateActionView();
      ...
      public function requestInitialization(param1:int = 0) : void
      {
         if(param1 > 0)
         {
            ...
            var_123.addEventListener(TimerEvent.TIMER_COMPLETE,initTimeout);
            var_123.start();
         }
         else
         {
      ...
      {
         var_47.checkCategoryInitilization(InventoryCategory.const_337);
      ...
      {
         if(param1 == InventoryCategory.const_76 && false)
         {
            switch(_view.visibleCategoryId)
            {
               ...
               case const_45:
                  ...
                  break;
               case const_285:
                  var_47.toggleInventoryPage(InventoryCategory.const_137);
            }
         }
      }
      ...
      {
         if(var_817 && param1.type == RoomEngineObjectEvent.const_222)
         {
            var_47.showView();
            var_817 = false;
         }
      ...
      public function requestSelectedFurniPlacement(param1:Boolean = false) : Boolean
      {
         ...
         if(_loc3_.category == FurniCategory.const_292 || _loc3_.category == FurniCategory.const_291 || _loc3_.category == FurniCategory.const_283)
         {
            if(param1)
            {
               return false;
      ...
      {
         return var_397.getValue(param1);
      }
      
      public function clearFurniList() : void
      {
         var_397 = new Map();
         var_397.add(const_44,new Array());
         var_397.add(const_45,new Array());
         if(_view != null)
         {
            _view.clearViews();
         }
