package com.sulake.habbo.inventory
{
   ...
   public class HabboInventory extends Component implements IHabboInventory
   {
      ...
      private var var_869:IRoomSession;
      ...
      override public function dispose() : void
      {
         ...
         if(var_18 != null)
         {
            var_18.events.removeEventListener(RoomSessionEvent.const_100,roomSessionEventHandler);
            var_18.events.removeEventListener(RoomSessionEvent.const_103,roomSessionEventHandler);
            var_18.events.removeEventListener(RoomSessionPropertyUpdateEvent.const_460,roomSessionEventHandler);
      ...
      private function roomSessionEventHandler(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            ...
            case RoomSessionEvent.const_103:
               var_869 = null;
               break;
            case RoomSessionPropertyUpdateEvent.const_460:
               petsModel.updatePetsAllowed();
         }
      }
      ...
      {
         return EffectsModel(var_46.getValue(InventoryCategory.const_604));
      }
      
      public function get furniModel() : FurniModel
      {
         return FurniModel(var_46.getValue(InventoryCategory.const_76));
      }
      ...
      {
         var_116.clubPeriods = param1;
         var_116.clubDays = param2;
         var_116.clubHasEverBeenMember = param3;
         var_116.method_2 = param4;
      ...
      {
         return PetsModel(var_46.getValue(InventoryCategory.const_137));
      }
      
      public function notifyChangedEffects() : void
      {
         events.dispatchEvent(new HabboInventoryEffectsEvent(HabboInventoryEffectsEvent.const_898));
      }
      ...
      public function requestInventoryCategoryInit(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.requestInitialization(const_1648);
         }
      }
      
      public function get achievementsModel() : AchievementsModel
      {
         return AchievementsModel(var_46.getValue(InventoryCategory.const_327));
      }
      ...
      public function toggleInventorySubPage(param1:String) : void
      {
         ...
         switch(param1)
         {
            case InventorySubCategory.const_250:
      ...
      public function setInventoryCategoryInit(param1:String, param2:Boolean = true) : void
      {
         ...
         {
            _loc3_ = var_868.indexOf(param1);
            if(_loc3_ >= 0)
            {
               var_868.splice(_loc3_,1);
            }
         }
      }
      ...
      {
         return TradingModel(var_46.getValue(InventorySubCategory.const_250));
      }
      
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         var_343 = ISessionDataManager(param2);
         queueInterface(new IIDHabboConfigurationManager(),onConfigurationManagerReady);
      }
      
      public function isInventoryCategoryInit(param1:String) : Boolean
      {
         if(var_868.indexOf(param1) >= 0)
         {
            return true;
         }
         return false;
      ...
      {
         return var_116.creditBalance;
      }
      
      public function get marketplaceModel() : MarketplaceModel
      {
         return var_46.getValue(InventoryCategory.const_337) as MarketplaceModel;
      }
      ...
      private function onCommunicationComponentInit(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_1043 = new IncomingMessages(this);
      ...
      {
         return var_116.clubHasEverBeenMember;
      }
      
      public function get clubPastPeriods() : int
      {
         return var_116.clubPastPeriods;
      }
      ...
      {
         return BadgesModel(var_46.getValue(InventoryCategory.const_270));
      }
      ...
      private function onRoomSessionManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_18.events.addEventListener(RoomSessionEvent.const_100,roomSessionEventHandler);
         var_18.events.addEventListener(RoomSessionEvent.const_103,roomSessionEventHandler);
         var_18.events.addEventListener(RoomSessionPropertyUpdateEvent.const_460,roomSessionEventHandler);
         ...
         var_46.add(InventoryCategory.const_337,_loc3_);
         ...
         var_46.add(InventoryCategory.const_76,_loc4_);
         var _loc5_:BadgesModel = new BadgesModel(this,_windowManager,_communication,_assetLibrary,_localization,var_343);
         var_46.add(InventoryCategory.const_270,_loc5_);
         var _loc6_:EffectsModel = new EffectsModel(this,_windowManager,_communication,_assetLibrary,_localization);
         var_46.add(InventoryCategory.const_604,_loc6_);
         var _loc7_:AchievementsModel = new AchievementsModel(this,_windowManager,_communication,_assetLibrary,_localization,var_343);
         var_46.add(InventoryCategory.const_327,_loc7_);
         var _loc8_:TradingModel = new TradingModel(this,_windowManager,_communication,_assetLibrary,_roomEngine,_localization);
         var_46.add(InventorySubCategory.const_250,_loc8_);
         ...
         var_46.add(InventoryCategory.const_137,_loc10_);
