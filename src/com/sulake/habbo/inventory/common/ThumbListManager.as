package com.sulake.habbo.inventory.common
{
   ...
   public class ThumbListManager
   {
      ...
      private var var_964:IThumbListDataProvider;
      ...
      public function ThumbListManager(param1:IAssetLibrary, param2:IThumbListDataProvider, param3:String, param4:String, param5:int, param6:int)
      {
         ...
         if(_loc7_ != null)
         {
            var_557 = BitmapData(_loc7_.content);
         }
         ...
         _thumbWidth = var_557.width;
         var_89 = var_557.height;
         var_965 = param5;
         var_791 = param6;
         var_213 = Math.floor(var_965 / _thumbWidth);
         var_17 = new BitmapData(var_965,var_791);
      }
      ...
      private function removeItemInImage(param1:Point) : void
      {
         ...
         if(var_17.height < var_791)
         {
            _loc12_ = new BitmapData(var_17.width,var_791);
      ...
      {
         var _loc4_:* = null;
         var _loc3_:BitmapData = new BitmapData(var_557.width,var_557.height);
         if(param2)
         {
            _loc3_.copyPixels(_itemBgImageSelected,var_557.rect,new Point(0,0),null,null,false);
         }
         else
         {
            _loc3_.copyPixels(var_557,var_557.rect,new Point(0,0),null,null,false);
         }
         if(param1 != null)
         {
      ...
      private function getList() : Array
      {
         ...
         if(var_964 != null)
         {
            _loc1_ = var_964.getDrawableList();
         }
      ...
      public function updateImageFromList() : void
      {
         ...
         var _loc5_:* = null;
         var _loc6_:* = null;
         var_466 = resolveRowCountFromList();
         if(var_466 == 0)
         {
            var_17 = new BitmapData(var_965,var_791);
            return;
         }
         var_17 = new BitmapData(Math.max(var_213 * _thumbWidth,var_965),Math.max(var_466 * var_89,var_791),true,16777215);
         var_17.fillRect(var_17.rect,4294967295);
         var _loc1_:int = 0;
         var _loc2_:Array = getList();
         var _loc3_:int = 0;
         while(_loc3_ < var_466)
         {
            _loc4_ = 0;
      ...
      public function addItemAsFirst(param1:IThumbListDrawableItem) : void
      {
         ...
         if(_loc3_.x == var_213 && var_17.height < _loc3_.y * var_89)
         {
         ...
         _loc4_ = new Rectangle(0,0,_thumbWidth * (var_213 - 1),var_89);
         ...
         _loc4_ = new Rectangle(0,var_89,_thumbWidth * (var_213 - 1),0 - var_89);
