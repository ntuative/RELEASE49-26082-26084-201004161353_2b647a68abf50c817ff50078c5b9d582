package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingView implements IInventoryView, IGetImageListener
   {
      ...
      private static const const_777:uint = 4284532064;
      
      private static const const_776:uint = 2577770;
      ...
      private var var_355:ItemPopupCtrl;
      ...
      public function TradingView(param1:TradingModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IRoomEngine, param5:IHabboLocalizationManager)
      {
         ...
         var_355 = new ItemPopupCtrl(_loc8_,_assetLibrary);
      }
      ...
      private function ownThumbEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            if(_loc4_.category == FurniCategory.const_175)
            {
               _loc6_ = "${poster_" + _loc4_.stuffData + "_name}";
            }
            if(_loc4_.category == FurniCategory.const_947)
            {
            ...
            var_355.updateContent(param2 as IWindowContainer,_loc6_,_loc5_,ItemPopupCtrl.const_436);
            var_355.show();
         }
      ...
      public function dispose() : void
      {
         if(!_disposed)
         {
            ...
            if(var_172)
            {
               var_172.removeEventListener(TimerEvent.TIMER,timerEventHandler);
               var_172.stop();
               var_172 = null;
            }
            if(var_355 != null)
      ...
      public function getWindowContainer() : IWindowContainer
      {
         ...
         if(var_1500 == null)
         {
            var_1500 = createMinimizedWindow();
         }
         if(!var_2019)
         {
            return var_61;
      ...
      public function startConfirmCountdown() : void
      {
         if(var_172 == null)
         {
            var_172 = new Timer(1000,3);
            var_172.addEventListener(TimerEvent.TIMER,timerEventHandler);
         }
         var_172.reset();
         var_172.repeatCount = 3;
         var_172.start();
      ...
      public function updateUserInterface() : void
      {
         ...
         if(var_61)
         {
            ...
            if(_loc1_)
            {
               _loc1_.color = !true ? uint(const_777) : uint(const_776);
            }
