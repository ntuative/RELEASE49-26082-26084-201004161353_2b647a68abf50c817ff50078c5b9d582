package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsGridItem
   {
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         switch(param1.type)
         {
            case WindowMouseEvent.const_52:
               var_1064.setSelectedGridItem(this);
               var_888 = true;
               break;
            ...
            case WindowMouseEvent.const_32:
               ...
               {
                  var_888 = false;
                  var_1064.placePetToRoom(var_1228.id,true);
               }
         }
      }
      ...
      public function setSelected(param1:Boolean) : void
      {
         ...
         _window.color = !!_isSelected ? uint(const_1645) : uint(const_1646);
      }
