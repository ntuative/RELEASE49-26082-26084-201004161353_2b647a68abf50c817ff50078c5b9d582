package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsView implements IInventoryView
   {
      ...
      private var var_316:PetsGridItem;
      ...
      private var var_531:IItemGridWindow;
      ...
      public function PetsView(param1:PetsModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager, param5:IAvatarRenderManager)
      {
         ...
         var_531 = _view.findChildByName("grid") as IItemGridWindow;
      ...
      {
         if(var_624 == null || false)
         {
            updatePreview();
            return;
         }
         setSelectedGridItem(var_624.getWithIndex(0));
      }
      ...
      public function setSelectedGridItem(param1:PetsGridItem) : void
      {
         if(var_316 != null)
         {
            var_316.setSelected(false);
         }
         var_316 = param1;
         if(var_316 != null)
         {
            var_316.setSelected(true);
         }
      ...
      private function placeButtonClickHandler(param1:WindowMouseEvent) : void
      {
         ...
         var _loc2_:PetData = var_316.pet;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      {
         var _loc2_:PetsGridItem = var_624.remove(param1) as PetsGridItem;
         if(_loc2_ == null)
         {
            return;
         }
         var_531.removeGridItem(_loc2_.window);
         if(var_316 == _loc2_)
         {
            var_316 = null;
            selectFirst();
      ...
      public function addPet(param1:PetData) : void
      {
         ...
         if(var_624.getValue(param1.id) != null)
         {
            return;
         }
         ...
         if(_loc2_ != null)
         {
            var_531.addGridItem(_loc2_.window);
            var_624.add(param1.id,_loc2_);
            if(var_316 == null)
            {
               selectFirst();
            }
