package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsModel implements IInventoryModel
   {
      ...
      {
         if(param1 == InventoryCategory.const_137 && false)
         {
      ...
      public function onObjectPlaced(param1:Event) : void
      {
         ...
         if(var_1230 && param1.type == RoomEngineObjectEvent.const_222)
         {
            var_47.showView();
            var_1230 = false;
         }
      ...
      public function placePetToRoom(param1:int, param2:Boolean = false) : void
      {
         ...
         {
            var_1230 = _roomEngine.initializeRoomObjectInsert(_loc3_.id,RoomObjectCategoryEnum.const_38,RoomObjectTypeEnum.const_303,_loc3_.figure);
            var_47.closeView();
            return;
         }
      ...
      {
         if(var_980.add(param1.id,param1))
         {
            _view.addPet(param1);
         }
      }
