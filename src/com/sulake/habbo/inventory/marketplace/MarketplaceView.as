package com.sulake.habbo.inventory.marketplace
{
   ...
   public class MarketplaceView implements IGetImageListener
   {
      ...
      public function showMakeOffer(param1:IItem) : void
      {
         ...
         var_1918 = _localization.getKey("roomItem.name." + param1.type);
      ...
      {
         _localization.registerParameter("inventory.marketplace.confirm_offer.info","furniname",var_1918);
      ...
      {
         var _loc1_:* = null;
         if(false && "RoomReadyMessageParser" == _config.getKey("client.credits.embed.enabled"))
         {
