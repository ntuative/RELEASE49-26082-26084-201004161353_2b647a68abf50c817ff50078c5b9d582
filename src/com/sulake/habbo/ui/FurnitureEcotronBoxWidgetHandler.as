package com.sulake.habbo.ui
{
   ...
   public class FurnitureEcotronBoxWidgetHandler implements IRoomWidgetHandler, IGetImageListener
   {
      ...
      {
         var _loc3_:RoomWidgetEcotronBoxDataUpdateEvent = new RoomWidgetEcotronBoxDataUpdateEvent(RoomWidgetEcotronBoxDataUpdateEvent.const_80,0,_name,false,param2);
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_640,RoomWidgetEcotronBoxOpenMessage.const_577,RoomWidgetEcotronBoxOpenedMessage.const_1361];
      }
            ...
            switch(param1.type)
            {
               case RoomSessionPresentEvent.const_240:
                  ...
                  if(_loc2_ != null)
                  {
                     ...
                     if(_loc3_ != null)
                     {
                        _loc5_ = new RoomWidgetEcotronBoxDataUpdateEvent(RoomWidgetEcotronBoxDataUpdateEvent.const_80,0,_name,false,_loc3_.data);
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_640:
               ...
               break;
            case RoomWidgetEcotronBoxOpenMessage.const_577:
