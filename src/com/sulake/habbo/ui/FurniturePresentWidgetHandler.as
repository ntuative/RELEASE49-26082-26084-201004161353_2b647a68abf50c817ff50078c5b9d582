package com.sulake.habbo.ui
{
   ...
   public class FurniturePresentWidgetHandler implements IRoomWidgetHandler, IGetImageListener
   {
      ...
      private static const const_1085:String = "poster";
      ...
      {
         var _loc3_:RoomWidgetPresentDataUpdateEvent = new RoomWidgetPresentDataUpdateEvent(RoomWidgetPresentDataUpdateEvent.const_80,0,_name,false,param2);
      ...
      {
         return [RoomSessionPresentEvent.const_240];
      }
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_549,RoomWidgetPresentOpenMessage.const_625,RoomWidgetPresentOpenedMessage.const_1299];
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         if(_container != null && false && param1 != null)
         {
            switch(param1.type)
            {
               case RoomSessionPresentEvent.const_240:
                  ...
                  if(_loc2_ != null)
                  {
                     ...
                     switch(_loc2_.itemType)
                     {
                        case ProductTypeEnum.const_84:
                           if(_loc3_ != null && _loc3_.name == const_185)
                           {
                              _loc5_ = new RoomWidgetPresentDataUpdateEvent(RoomWidgetPresentDataUpdateEvent.const_360,0,_container.localization.getKey("inventory.furni.item.floor.name"),false,null);
                           }
                           else if(_loc3_ != null && _loc3_.name == const_184)
                           {
                              _loc5_ = new RoomWidgetPresentDataUpdateEvent(RoomWidgetPresentDataUpdateEvent.const_471,0,_container.localization.getKey("inventory.furni.item.landscape.name"),false,null);
                           }
                           else if(_loc3_ != null && _loc3_.name == const_183)
                           {
                              _loc5_ = new RoomWidgetPresentDataUpdateEvent(RoomWidgetPresentDataUpdateEvent.const_448,0,_container.localization.getKey("inventory.furni.item.wallpaper.name"),false,null);
                           }
                           else
                           {
                              if(_loc3_ != null && _loc3_.name == const_1085)
                              {
                                 break;
                              }
                              ...
                              if(_loc4_ != null)
                              {
                                 _loc5_ = new RoomWidgetPresentDataUpdateEvent(RoomWidgetPresentDataUpdateEvent.const_80,0,_name,false,_loc4_.data);
                              }
                           }
                           break;
                        case ProductTypeEnum.const_322:
                           _loc5_ = new RoomWidgetPresentDataUpdateEvent(RoomWidgetPresentDataUpdateEvent.const_366,0,_container.localization.getKey("widget.furni.present.hc"),false,null);
                           break;
                        default:
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_549:
               ...
               if(_loc3_ != null)
               {
                  ...
                  {
                     var_146 = _loc2_.id;
                     _loc6_ = _loc5_.getString(RoomObjectVariableEnum.const_145);
                     if(_loc6_ == null)
                     {
                        _loc6_ = "";
                     }
               ...
               break;
            case RoomWidgetPresentOpenMessage.const_625:
               _loc4_ = param1 as RoomWidgetPresentOpenMessage;
               if(_loc4_.objectId != var_146)
               {
                  return null;
               }
