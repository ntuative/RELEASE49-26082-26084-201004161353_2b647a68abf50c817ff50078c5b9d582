package com.sulake.habbo.ui
{
   ...
   public class RoomDesktop implements IRoomDesktop, IRoomWidgetMessageListener, IRoomWidgetHandlerContainer
   {
      ...
      private var var_883:IRoomWidgetFactory = null;
      ...
      private var var_563:IAvatarRenderManager = null;
      ...
      private var var_343:ISessionDataManager = null;
      
      private var var_2216:uint = 16777215;
      ...
      public function set roomEngine(param1:IRoomEngine) : void
      {
         ...
         {
            _roomEngine.events.addEventListener(RoomContentLoadedEvent.const_284,onRoomContentLoaded);
            _roomEngine.events.addEventListener(RoomContentLoadedEvent.const_367,onRoomContentLoaded);
      ...
      public function init() : void
      {
         ...
         {
            var_761 = _roomEngine.loadRoomResources(var_37.roomResources);
            if(false)
            {
               var_1349 = false;
         ...
         {
            var_1350 = !var_269.showInterstitial();
         }
         checkInterrupts();
      }
      ...
      private function onRoomViewResized(param1:WindowEvent) : void
      {
         ...
         _roomEngine.modifyRoomCanvas(var_37.roomId,var_37.roomCategory,var_280[0],_loc2_.width,_loc2_.height);
      ...
      public function dispose() : void
      {
         ...
         if(_friendList && false)
         {
            ...
            _friendList.events.removeEventListener(FriendRequestEvent.const_264,processEvent);
         }
         _friendList = null;
         var_179.dispose();
         var_179 = null;
         if(_roomEngine != null && false)
         {
            _roomEngine.events.removeEventListener(RoomContentLoadedEvent.const_284,onRoomContentLoaded);
            _roomEngine.events.removeEventListener(RoomContentLoadedEvent.const_367,onRoomContentLoaded);
      ...
      private function resizeColorizer(param1:WindowEvent) : void
      {
         ...
         _loc3_.graphics.beginFill(var_2216);
      ...
      public function set layout(param1:XML) : void
      {
         ...
         if(var_199 != null)
         {
            var_179.toolbarSize = var_199.size;
            var_179.toolbarOrientation = var_199.orientation;
         }
      }
      ...
      public function canvasMouseHandler(param1:Event) : void
      {
         ...
         if(_loc4_ == _loc2_.target)
         {
            ...
            _roomEngine.handleRoomCanvasMouseEvent(var_280[0],_loc6_,_loc7_,_loc3_,_loc2_.altKey,_loc2_.ctrlKey,_loc2_.shiftKey,_loc2_.buttonDown);
         }
      ...
      public function createWidget(param1:String) : void
      {
         ...
         _loc2_ = var_883.createWidget(param1);
         if(_loc2_ == null)
         {
            return;
         }
      ...
      public function roomObjectEventHandler(param1:RoomEngineObjectEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineObjectEvent.const_743:
               _loc4_ = new RoomWidgetRoomObjectUpdateEvent(RoomWidgetRoomObjectUpdateEvent.const_336,_loc2_,_loc3_,param1.roomId,param1.roomCategory);
               if(var_729 != null && _loc3_ == RoomObjectCategoryEnum.const_38)
               {
                  _loc7_ = var_37.userDataManager.getUserDataByIndex(_loc2_);
                  if(_loc7_ != null && _loc7_.type == RoomObjectTypeEnum.const_320)
                  {
                     var_729.userSelected(_loc7_.webID,_loc7_.name);
                  }
               }
               break;
            ...
            case RoomEngineObjectEvent.const_398:
               _loc4_ = new RoomWidgetRoomObjectUpdateEvent(RoomWidgetRoomObjectUpdateEvent.const_233,_loc2_,_loc3_,param1.roomId,param1.roomCategory);
               break;
            case RoomEngineObjectEvent.const_572:
               if(true)
               {
                  return;
               }
            ...
            case RoomEngineObjectEvent.const_130:
               _loc5_ = new RoomWidgetFurniToWidgetMessage(RoomWidgetFurniToWidgetMessage.const_507,_loc2_,_loc3_,param1.roomId,param1.roomCategory);
               processWidgetMessage(_loc5_);
               break;
            case RoomEngineObjectEvent.const_124:
               _loc5_ = new RoomWidgetFurniToWidgetMessage(RoomWidgetFurniToWidgetMessage.const_640,_loc2_,_loc3_,param1.roomId,param1.roomCategory);
               processWidgetMessage(_loc5_);
               break;
      ...
      public function createRoomView(param1:int) : void
      {
         ...
         if(_loc7_ != null)
         {
            _loc12_ = _roomEngine.getRoomNumberValue(var_37.roomId,var_37.roomCategory,RoomVariableEnum.const_554);
            _loc13_ = _roomEngine.getRoomNumberValue(var_37.roomId,var_37.roomCategory,RoomVariableEnum.const_610);
            _loc14_ = _roomEngine.getRoomNumberValue(var_37.roomId,var_37.roomCategory,RoomVariableEnum.const_609);
            _loc15_ = _roomEngine.getRoomNumberValue(var_37.roomId,var_37.roomCategory,RoomVariableEnum.const_648);
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         ...
         if(param1.iconId == HabboToolbarIconEnum.ZOOM)
         {
            if(var_37 != null)
            {
               ...
               {
                  _loc2_.performZoom();
                  _loc3_ = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_164,HabboToolbarIconEnum.ZOOM);
      ...
      private function handleRoomAdClick(param1:RoomEngineObjectEvent) : void
      {
         ...
         var _loc4_:String = _loc3_.getString(RoomObjectVariableEnum.const_307);
      ...
      private function handleRoomAdTooltip(param1:RoomEngineObjectEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineObjectEvent.const_358:
               ...
               var_178 = _windowManager.createWindow("room_ad_tooltip",_loc3_,WindowType.const_326,WindowStyle.const_310,WindowParam.const_91) as IToolTipWindow;
               var_178.setParamFlag(WindowParam.const_49,false);
      ...
      {
         if(var_18 != null && var_37 != null && var_1350 && var_1349)
         {
            var_18.startSession(var_37);
            processEvent(new RoomWidgetLoadingBarUpdateEvent(RoomWidgetLoadingBarUpdateEvent.const_271));
         }
      }
      ...
      public function set friendList(param1:IHabboFriendList) : void
      {
         ...
         if(_friendList)
         {
            ...
            _friendList.events.addEventListener(FriendRequestEvent.const_264,processEvent);
         }
      }
