   ...
   public class MeMenuWidgetHandler implements IRoomWidgetHandler
   {
      ...
      private function setMeMenuToolbarIcon(param1:Boolean) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            Logger.log("MeMenuWidgetHandler: set toolbar icon: " + var_199 + " " + _loc7_);
            if(var_199 != null && _loc7_ != null)
            {
               _loc9_ = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_822,HabboToolbarIconEnum.MEMENU);
               _loc9_.bitmapData = _loc7_;
               var_199.events.dispatchEvent(_loc9_);
            }
         }
      }
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(_container != null)
         {
            if(false)
            {
               _container.sessionDataManager.events.removeEventListener(HabboSessionFigureUpdatedEvent.const_617,onFigureUpdate);
            }
            if(false)
            {
            ...
            if(false)
            {
               _container.habboHelp.events.removeEventListener(HabboHelpTutorialEvent.const_425,onHelpTutorialEvent);
         ...
         if(_container != null && false)
         {
            _container.sessionDataManager.events.addEventListener(HabboSessionFigureUpdatedEvent.const_617,onFigureUpdate);
         ...
         if(var_10 != null)
         {
            (var_10 as Component).events.addEventListener(HabboInventoryEffectsEvent.const_898,onAvatarEffectsChanged);
            (var_10 as Component).events.addEventListener(HabboInventoryHabboClubEvent.const_826,onHabboClubSubscriptionChanged);
         }
         var_199 = _container.toolbar;
         if(var_199)
         {
         ...
         if(false)
         {
            _container.habboHelp.events.addEventListener(HabboHelpTutorialEvent.const_425,onHelpTutorialEvent);
      ...
      private function onHelpTutorialEvent(param1:HabboHelpTutorialEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case HabboHelpTutorialEvent.const_425:
               _container.events.dispatchEvent(new RoomWidgetTutorialEvent(RoomWidgetTutorialEvent.const_456));
         }
      }
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetWaveMessage.const_564);
         _loc1_.push(RoomWidgetDanceMessage.const_516);
         _loc1_.push(RoomWidgetGetEffectsMessage.const_529);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_598);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_673);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_639);
         _loc1_.push(RoomWidgetOpenInventoryMessage.const_730);
         _loc1_.push(RoomWidgetOpenCatalogMessage.const_588);
         _loc1_.push(RoomWidgetStopEffectMessage.const_736);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1367);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_962);
         _loc1_.push(RoomWidgetToolbarMessage.const_548);
         _loc1_.push(RoomWidgetToolbarMessage.const_616);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_645);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_1239);
         _loc1_.push(RoomWidgetSelectOutfitMessage.const_1017);
         _loc1_.push(RoomWidgetShowOwnRoomsMessage.const_691);
         _loc1_.push(RoomWidgetRequestWidgetMessage.const_534);
         _loc1_.push(RoomWidgetGetSettingsMessage.const_719);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_1231);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_541);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_653);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_671);
         return _loc1_;
      }
      ...
      private function onAvatarEditorClosed(param1:Event = null) : void
      {
         ...
         _container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_569));
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomWidgetDanceMessage.const_516:
               ...
               break;
            case RoomWidgetGetEffectsMessage.const_529:
               if(var_10 != null)
               {
            ...
            case RoomWidgetSelectEffectMessage.const_598:
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_673:
               if(var_10 != null)
               {
            ...
            case RoomWidgetOpenCatalogMessage.const_588:
               ...
               if(_catalog != null && _loc2_.pageKey == RoomWidgetOpenCatalogMessage.const_989)
               {
                  _catalog.openCatalogPage(CatalogPageName.const_226,true);
               }
               break;
            case RoomWidgetOpenInventoryMessage.const_730:
               ...
               if(var_10 != null)
               {
                  ...
                  {
                     case RoomWidgetOpenInventoryMessage.const_1027:
                        _catalog.openCatalogPage(CatalogPageName.const_1355,true);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1021:
                        var_10.toggleInventoryPage(InventoryCategory.const_270);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1328:
                        var_10.toggleInventoryPage(InventoryCategory.const_76);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1331:
                        break;
                     default:
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_639:
            case RoomWidgetStopEffectMessage.const_736:
               ...
               break;
            case RoomWidgetSetToolbarIconMessage.const_880:
               ...
               break;
            case RoomWidgetNavigateToRoomMessage.const_962:
               ...
               break;
            case RoomWidgetShowOwnRoomsMessage.const_691:
               if(_container != null)
               {
                  _container.navigator.showOwnRooms();
               }
               break;
            case RoomWidgetToolbarMessage.const_548:
               ...
               if(var_199)
               {
                  var_199.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_50,HabboToolbarIconEnum.MEMENU,_loc5_.window));
                  if(var_10 != null)
                  {
                     _loc12_ = false;
                     if(_container != null && false)
               ...
               break;
            case RoomWidgetToolbarMessage.const_616:
               ...
               if(var_199 && false)
               {
                  var_199.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_378,HabboToolbarIconEnum.MEMENU,_loc6_.window));
               }
               break;
            case RoomWidgetAvatarEditorMessage.const_645:
               ...
               if(_container)
               {
                  ...
                  {
                     _container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_388));
                  }
               }
               break;
            case RoomWidgetGetSettingsMessage.const_719:
