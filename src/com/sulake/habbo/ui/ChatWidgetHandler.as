package com.sulake.habbo.ui
{
   ...
   public class ChatWidgetHandler implements IRoomWidgetHandler
   {
      ...
      private var var_929:Number = 0;
      
      private var var_538:Point = null;
      
      private var var_763:Map = null;
      
      private var var_536:Vector3d;
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = 0;
            while(_loc1_ < var_537.length)
            {
               _loc2_ = var_537.getWithIndex(_loc1_) as BitmapData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
                  ...
                  if(_loc4_ != null)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        if(_loc10_ != null)
                        {
                           ...
                           _loc13_ = var_537.getValue(_loc15_) as BitmapData;
                           _loc12_ = uint(var_763.getValue(_loc15_));
                           if(_loc13_ == null)
                           {
                              if(false)
                              {
                                 switch(_loc10_.type)
                                 {
                                    case RoomObjectTypeEnum.const_303:
                                 ...
                                 if(_loc13_ != null)
                                 {
                                    var_537.add(_loc15_,_loc13_);
                                 }
                                 if(_loc12_ != 0)
                                 {
                                    var_763.add(_loc15_,_loc12_);
                                 }
                                 if(_loc16_ != null)
                                 {
                                    _loc16_.dispose();
      ...
      {
         return [RoomWidgetChatMessage.const_526,RoomWidgetChatSelectAvatarMessage.const_635];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetChatMessage.const_526:
                     ...
                     if(_loc5_.length > 0)
                     {
                        ...
                        switch(_loc6_.toLowerCase())
                        {
                           ...
                           case ":sign":
                              ...
                              return null;
                           case ":v":
                              _loc10_ = new RoomSessionChatEvent(RoomSessionChatEvent.const_150,_container.roomSession,0,"Version 26082-26084-201004161309");
               ...
               break;
            case RoomWidgetChatSelectAvatarMessage.const_635:
      ...
      private function updateWidgetPosition() : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(var_929 > 0)
            {
               _loc5_ = Number(_loc4_.scale / var_929);
            }
            if(var_538 == null)
            {
               var_536.x = 0;
               var_536.y = 0;
               var_536.z = 0;
               var_538 = _loc4_.getScreenPoint(var_536);
               var_929 = _loc4_.scale - 10;
            }
            _loc6_ = "";
            _loc7_ = null;
            var_536.x = 0;
            var_536.y = 0;
            var_536.z = 0;
            _loc8_ = _loc4_.getScreenPoint(var_536);
            if(_loc8_ != null)
            {
               if(_loc8_.x != var_538.x || _loc8_.y != var_538.y)
               {
                  _loc9_ = PointMath.sub(_loc8_,PointMath.mul(var_538,_loc5_));
