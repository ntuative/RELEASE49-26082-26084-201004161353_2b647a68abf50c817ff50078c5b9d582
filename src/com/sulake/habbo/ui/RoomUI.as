package com.sulake.habbo.ui
{
   ...
   public class RoomUI extends Component implements IRoomUI, IUpdateReceiver
   {
      ...
      private var var_535:IHabboSoundManager;
      
      private var var_1281:IHabboAvatarEditor = null;
      
      private var var_269:IAdManager;
      
      private var var_883:IRoomWidgetFactory;
      ...
      public function createDesktop(param1:IRoomSession) : IRoomDesktop
      {
         ...
         _loc3_.roomWidgetFactory = var_883;
      ...
      private function onSoundManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_535 = param2 as IHabboSoundManager;
      }
         ...
         switch(param1.type)
         {
            ...
            case RoomSessionEvent.const_103:
               if(param1.session != null)
               {
                  ...
                  var_199.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_156,HabboToolbarIconEnum.ZOOM));
                  var_199.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_156,HabboToolbarIconEnum.MEMENU));
                  var_199.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_156,HabboToolbarIconEnum.INVENTORY));
               }
         }
      }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         {
            var_269.events.addEventListener(AdEvent.const_409,adEventHandler);
            var_269.events.addEventListener(AdEvent.const_389,adEventHandler);
            var_269.events.addEventListener(AdEvent.const_423,adEventHandler);
         }
      }
      ...
      private function onRoomWidgetFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_883 = param2 as IRoomWidgetFactory;
      }
      ...
      override public function dispose() : void
      {
         ...
         if(var_883 != null)
         {
            var_883.release(new IIDHabboRoomWidget());
            var_883 = null;
         }
         if(var_10 != null)
         {
         ...
         if(var_535 != null)
         {
            var_535.release(new IIDHabboSoundManager());
            var_535 = null;
         }
         if(var_269 != null)
         {
      ...
      public function disposeDesktop(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc3_ = _loc2_.getWidgetState(RoomWidgetEnum.const_241);
      ...
      private function roomEventHandler(param1:RoomEngineEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineEvent.const_741:
               _loc5_ = false;
               ...
               _loc3_.createWidget(RoomWidgetEnum.const_241);
               if(var_1529 != RoomDesktop.const_540)
               {
                  _loc3_.initializeWidget(RoomWidgetEnum.const_241,var_1529);
               }
               if(var_269 != null)
               {
                  var_269.showRoomAd();
            ...
            case RoomEngineEvent.const_725:
               ...
               break;
            case RoomEngineRoomColorEvent.const_659:
      ...
      private function roomSessionDialogEventHandler(param1:RoomSessionEvent) : void
      {
         ...
         switch(event.type)
         {
            ...
            case RoomSessionErrorMessageEvent.const_228:
               ...
               break;
            case RoomSessionErrorMessageEvent.const_537:
      ...
      private function initializeRoomEngineEvents() : void
      {
         ...
         {
            _roomEngine.events.addEventListener(RoomEngineEvent.const_693,roomEngineEventHandler);
            _roomEngine.events.addEventListener(RoomEngineEvent.const_741,roomEventHandler);
            _roomEngine.events.addEventListener(RoomEngineEvent.const_725,roomEventHandler);
            _roomEngine.events.addEventListener(RoomEngineDimmerStateEvent.const_65,roomEventHandler);
            _roomEngine.events.addEventListener(RoomEngineRoomColorEvent.const_659,roomEventHandler);
            ...
            _roomEngine.events.addEventListener(RoomEngineObjectEvent.const_572,roomObjectEventHandler);
      ...
      private function registerSessionEvents() : void
      {
         if(var_18)
         {
            ...
            var_18.events.addEventListener(RoomSessionChatEvent.const_150,roomSessionEventHandler);
            ...
            var_18.events.addEventListener(RoomSessionPresentEvent.const_240,roomSessionEventHandler);
            ...
            var_18.events.addEventListener(RoomSessionErrorMessageEvent.const_699,roomSessionDialogEventHandler);
            var_18.events.addEventListener(RoomSessionErrorMessageEvent.const_1009,roomSessionDialogEventHandler);
            var_18.events.addEventListener(RoomSessionErrorMessageEvent.const_877,roomSessionDialogEventHandler);
            ...
            var_18.events.addEventListener(RoomSessionErrorMessageEvent.const_212,roomSessionDialogEventHandler);
            ...
            var_18.events.addEventListener(RoomSessionErrorMessageEvent.const_537,roomSessionDialogEventHandler);
            var_18.events.addEventListener(RoomSessionErrorMessageEvent.const_536,roomSessionDialogEventHandler);
            var_18.events.addEventListener(RoomSessionErrorMessageEvent.const_154,roomSessionDialogEventHandler);
            var_18.events.addEventListener(RoomSessionErrorMessageEvent.const_742,roomSessionDialogEventHandler);
            var_18.events.addEventListener(RoomSessionErrorMessageEvent.const_596,roomSessionDialogEventHandler);
            var_18.events.addEventListener(RoomSessionQueueEvent.const_467,roomSessionEventHandler);
            var_18.events.addEventListener(RoomSessionVoteEvent.const_120,roomSessionEventHandler);
            ...
            var_18.events.addEventListener(RoomSessionDimmerPresetsEvent.const_374,roomSessionEventHandler);
            var_18.events.addEventListener(RoomSessionFriendRequestEvent.const_114,roomSessionEventHandler);
         }
      }
      ...
      private function roomEngineEventHandler(param1:RoomEngineEvent) : void
      {
         ...
         if(param1.type == RoomEngineEvent.const_693)
         {
            if(var_18 != null)
            {
               var_18.roomEngineReady = true;
