package com.sulake.habbo.ui
{
   ...
   public class FriendRequestWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetGetUserLocationMessage.const_586);
         _loc1_.push(RoomWidgetFriendRequestMessage.const_733);
         _loc1_.push(RoomWidgetFriendRequestMessage.const_688);
         return _loc1_;
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionFriendRequestEvent.const_114:
            ...
            case FriendRequestEvent.const_264:
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetGetUserLocationMessage.const_586:
               ...
               break;
            case RoomWidgetFriendRequestMessage.const_733:
               ...
               break;
            case RoomWidgetFriendRequestMessage.const_688:
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomSessionFriendRequestEvent.const_114);
         _loc1_.push(FriendRequestEvent.const_57);
         _loc1_.push(FriendRequestEvent.const_264);
         return _loc1_;
      }
