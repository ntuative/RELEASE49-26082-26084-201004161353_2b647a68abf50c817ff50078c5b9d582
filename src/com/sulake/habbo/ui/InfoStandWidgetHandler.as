   ...
   public class InfoStandWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(_container != null)
         {
            if(false)
            {
               _container.sessionDataManager.events.removeEventListener(UserTagsReceivedEvent.const_138,onUserTags);
            ...
            if(false)
            {
               ...
               _container.roomSessionManager.events.removeEventListener(RoomSessionPetInfoUpdateEvent.const_151,onPetInfo);
         ...
         if(false)
         {
            _container.sessionDataManager.events.addEventListener(UserTagsReceivedEvent.const_138,onUserTags);
         ...
         if(false)
         {
            ...
            _container.roomSessionManager.events.addEventListener(RoomSessionPetInfoUpdateEvent.const_151,onPetInfo);
      ...
      private function handleGetObjectInfoMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_31:
               ...
               _loc6_ = new RoomWidgetFurniInfoUpdateEvent(RoomWidgetFurniInfoUpdateEvent.const_585);
               _loc6_.id = param1.id;
               ...
               {
                  _loc22_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_304);
               ...
               _loc9_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_952);
               _loc10_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_963);
            ...
            case RoomObjectCategoryEnum.const_38:
               ...
               if(_loc11_.type == RoomObjectTypeEnum.const_303)
               {
                  _container.roomSession.userDataManager.requestPetInfo(_loc11_.webID);
                  return null;
               }
               if(_loc11_.type == RoomObjectTypeEnum.const_320)
               {
                  _loc12_ = "null";
               ...
               {
                  if(_loc11_.type != RoomObjectTypeEnum.const_889)
                  {
                     return null;
                  }
                  _loc12_ = "null";
               ...
               if(_loc16_ != null)
               {
                  _loc13_.carryItem = _loc16_.getModel().getNumber(RoomObjectVariableEnum.const_599);
               }
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.const_196)
               {
                  _loc13_.realName = _container.sessionDataManager.realName;
               }
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.const_195)
               {
                  ...
                  if(_loc16_ != null)
                  {
                     _loc30_ = _loc16_.getModel().getString(RoomObjectVariableEnum.const_687);
                  ...
                  _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_1159;
                  if(!_loc25_)
                  {
                  ...
                  if(!_loc26_)
                  {
                     _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_802;
                  }
                  if(!_loc27_)
                  {
                     _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_1014;
                  }
               ...
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.BOT)
               {
                  ...
                  _loc14_.push(RoomWidgetUserInfoUpdateEvent.const_1333);
               }
               else
               {
               ...
               if(_loc19_ != null)
               {
                  _loc19_.setDirection(AvatarSetType.const_39,4);
                  _loc13_.image = _loc19_.getImage(AvatarSetType.const_39,true);
                  _loc19_.dispose();
               }
      ...
      private function onFigureUpdate(param1:RoomSessionUserFigureUpdateEvent) : void
      {
         ...
         if(false)
         {
            ...
            if(_loc5_ != null)
            {
               ...
               _loc4_ = _loc5_.getImage(AvatarSetType.const_39,true);
               _loc5_.dispose();
            }
      ...
      private function onPetInfo(param1:RoomSessionPetInfoUpdateEvent) : void
      {
         ...
         var _loc5_:IAvatarImage = var_613.getValue(_loc2_.petId) as IAvatarImage;
         if(_loc5_ == null)
         {
            _loc5_ = _container.avatarRenderManager.createPetImageFromFigure(_loc4_,AvatarScaleType.const_55);
            var_613.add(_loc2_.petId,_loc5_);
         }
         ...
         if(_container != null && false)
         {
            ...
            if(_loc13_ != null)
            {
               ...
               if(_loc14_ != null)
               {
                  _loc15_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_687);
      ...
      {
         return [RoomSessionUserBadgesEvent.const_108];
      }
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetRoomObjectMessage.const_298);
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_744);
         _loc1_.push(RoomWidgetUserActionMessage.const_626);
         _loc1_.push(RoomWidgetUserActionMessage.const_462);
         ...
         _loc1_.push(RoomWidgetFurniActionMessage.const_265);
         _loc1_.push(RoomWidgetFurniActionMessage.const_660);
         _loc1_.push(RoomWidgetFurniActionMessage.const_595);
         _loc1_.push(RoomWidgetRoomTagSearchMessage.const_702);
         _loc1_.push(RoomWidgetGetBadgeDetailsMessage.const_515);
         _loc1_.push(RoomWidgetUserActionMessage.const_463);
         _loc1_.push(RoomWidgetUserActionMessage.const_704);
         _loc1_.push(RoomWidgetUserActionMessage.const_552);
         _loc1_.push(RoomWidgetUserActionMessage.const_1162);
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionUserBadgesEvent.const_108:
      ...
      public function dispose() : void
      {
         ...
         if(var_613 != null)
         {
            _loc1_ = var_613.getKeys();
            for each(_loc2_ in _loc1_)
            {
               _loc3_ = var_613.getValue(_loc2_);
               if(_loc3_)
               {
                  _loc3_.dispose();
               }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(_loc4_.type == RoomWidgetUserActionMessage.const_463)
            {
         ...
         switch(param1.type)
         {
            case RoomWidgetRoomObjectMessage.const_298:
            ...
            case RoomWidgetUserActionMessage.const_550:
               _loc8_ = new RoomWidgetChatInputContentUpdateEvent(RoomWidgetChatInputContentUpdateEvent.const_944,_loc3_.name);
               _container.events.dispatchEvent(_loc8_);
               break;
            case RoomWidgetUserActionMessage.const_744:
               _container.sessionDataManager.ignoreUser(_loc3_.name);
               break;
            case RoomWidgetUserActionMessage.const_626:
               _container.sessionDataManager.unignoreUser(_loc3_.name);
               break;
            case RoomWidgetUserActionMessage.const_462:
            ...
            case RoomWidgetUserActionMessage.const_415:
               ...
               break;
            case RoomWidgetRoomTagSearchMessage.const_702:
               ...
               break;
            case RoomWidgetGetBadgeDetailsMessage.const_515:
