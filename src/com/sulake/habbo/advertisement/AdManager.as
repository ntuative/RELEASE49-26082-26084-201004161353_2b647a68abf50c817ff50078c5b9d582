package com.sulake.habbo.advertisement
{
   ...
   public class AdManager extends Component implements IAdManager
   {
      ...
      private var var_856:BitmapData = null;
      ...
      private function roomAdImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(isValidAdImage(_loc3_))
         {
            ...
            events.dispatchEvent(new AdEvent(AdEvent.const_423,0,0,_loc4_,var_1497,var_855,var_856));
         }
      }
      ...
      private function onConfigurationInit(param1:Event = null) : void
      {
         ...
         var_2005 = int(_config.getKey("interstitial.show.time","5000"));
         var_1499 = int(_config.getKey("interstitial.max.displays.flash","-1"));
      ...
      private function onRoomAd(param1:RoomAdMessageEvent) : void
      {
         ...
         var_1242 = _loc2_.imageUrl;
         var_1497 = _loc2_.clickUrl;
         if(var_1242 != "" && var_1497 != "")
         {
            _loc3_ = var_1242;
            ...
            _loc4_ = new URLRequest(var_1242);
      ...
      private function onInterstitial(param1:InterstitialMessageEvent) : void
      {
         ...
         var_1243 = _loc2_.imageUrl;
         var_2004 = _loc2_.clickUrl;
         var_718 = getTimer();
         if(var_1243 != "")
         {
            _loc3_ = var_1243;
            ...
            var_226.start();
            _loc4_ = new URLRequest(var_1243);
            _loc5_ = _assets.loadAssetFromFile(_loc3_,_loc4_,"image/jpeg");
      ...
      private function startInterstitial(param1:Bitmap) : void
      {
         ...
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_389,0,0,param1.bitmapData,var_2004));
            var_718 = getTimer();
         }
         else
         {
      ...
      private function adWarningRightReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            var_856 = emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
      ...
      public function showInterstitial() : Boolean
      {
         ...
         if(var_1499 > 0 && var_1498 >= var_1499)
         {
            return false;
         }
         var _loc1_:int = getTimer() - var_718;
         if(_loc1_ > var_2006)
         {
            ++var_1498;
      ...
      {
         var_289 = param2 as IHabboCommunicationManager;
         if(var_289 == null)
         {
            return;
         }
         _connection = var_289.getHabboMainConnection(onConnectionReady);
         if(_connection != null)
         {
      ...
      private function adWarningLeftReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            var_855 = emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
