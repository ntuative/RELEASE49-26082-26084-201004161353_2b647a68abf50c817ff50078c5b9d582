package com.sulake.habbo.tracking
{
   ...
   public class HabboTracking extends Component implements IHabboTracking, IUpdateReceiver
   {
      ...
      private static const const_764:uint = 11;
       
      
      private var var_224:LatencyTracker = null;
      
      private var var_223:PerformanceTracker = null;
      
      private var var_269:IAdManager;
      
      private var _roomEngine:IRoomEngine = null;
      
      private var var_151:IHabboHelp;
      
      private var _coreComponent:CoreComponent;
      
      private var var_1001:int = -1;
      
      private var var_820:LagWarningLogger = null;
      
      private var var_819:IHabboWindowManager;
      ...
      public function HabboTracking(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         var_223 = new PerformanceTracker();
         var_224 = new LatencyTracker();
         var_820 = new LagWarningLogger();
         var_1203 = new Array(const_764);
         var _loc4_:int = 0;
         while(_loc4_ < const_764)
         {
            var_1203[_loc4_] = 0;
            _loc4_++;
         }
         ...
         if(_loc5_ != null)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1348,new Date().getTime().toString());
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1246,!true ? ExternalInterface.call("window.navigator.userAgent.toString") : "unknown");
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1217,Capabilities.serverString);
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_675,String(false));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_961,String(0));
         }
      ...
      private function onConnectionEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case HabboCommunicationEvent.INIT:
               trackLoginStep(HabboLoginTrackingStep.const_1399);
               break;
            case HabboCommunicationEvent.const_605:
               trackLoginStep(HabboLoginTrackingStep.const_1319,String(_communication.port));
               break;
            case HabboCommunicationEvent.const_193:
               trackLoginStep(HabboLoginTrackingStep.const_193);
               break;
            case HabboCommunicationEvent.const_167:
               trackLoginStep(HabboLoginTrackingStep.const_167);
               break;
      ...
      private function onFriendlistTrackingEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            ...
            case HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST:
               ...
               break;
            case HabboFriendListTrackingEvent.const_289:
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(var_147)
         {
            Component(var_147).events.addEventListener(HabboConfigurationEvent.const_166,onConfigurationLoaded);
            if(var_224 != null)
            {
               var_224.configuration = var_147;
            }
            if(var_223 != null)
            {
               var_223.configuration = var_147;
            }
         }
      }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_269.events.addEventListener(AdEvent.const_423,onRoomAdLoad);
      }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         if(!var_1846)
         {
            trackLoginStep(HabboLoginTrackingStep.const_1365);
            var_1846 = true;
         }
         var _loc2_:RoomEntryInfoMessageParser = RoomEntryInfoMessageEvent(param1).getParser();
         if(_loc2_.guestRoom)
         {
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_961,String(_loc2_.guestRoomId));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_675,String(true));
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(context).events.addEventListener(HabboCommunicationEvent.const_605,onConnectionEvent);
         Component(context).events.addEventListener(HabboCommunicationEvent.const_193,onConnectionEvent);
         Component(context).events.addEventListener(HabboCommunicationEvent.const_157,onConnectionEvent);
         Component(context).events.addEventListener(HabboCommunicationEvent.const_167,onConnectionEvent);
         Component(context).events.addEventListener(HabboCommunicationEvent.const_223,onConnectionEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_705,onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_66,onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_459,onHotelViewEvent);
      }
      ...
      private function onLagWarningEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case AvatarWalkWarpingWarningEvent.const_426:
               var_820.warpingDetected();
         }
      }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(var_819)
            {
               var_819.release(new IIDHabboWindowManager());
               var_819 = null;
            }
            if(var_269)
            {
            ...
            if(var_167)
            {
               if(true)
               {
                  ...
                  Component(var_167).events.removeEventListener(HabboFriendListTrackingEvent.const_289,onFriendlistTrackingEvent);
               }
            ...
            if(var_151)
            {
               if(true)
               {
                  var_151.events.removeEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_CLOSED,onHelpTrackingEvent);
                  var_151.events.removeEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_DEFAULT,onHelpTrackingEvent);
               }
               var_151.release(new IIDHabboHelp());
               var_151 = null;
            }
            if(_roomEngine)
            {
               if(true)
               {
                  Component(_roomEngine).events.removeEventListener(AvatarWalkWarpingWarningEvent.const_426,onLagWarningEvent);
               }
      ...
      private function onConfigurationLoaded(param1:Event) : void
      {
         ...
         if(var_147)
         {
            if(var_820 != null)
            {
               var_820.configure(var_147);
            }
            Component(var_147).events.removeEventListener(HabboConfigurationEvent.const_166,onConfigurationLoaded);
         }
      }
      ...
      {
         var_151 = param2 as IHabboHelp;
         var_151.events.addEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_CLOSED,onHelpTrackingEvent);
         var_151.events.addEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_DEFAULT,onHelpTrackingEvent);
      }
      ...
      {
         trackLoginStep(HabboLoginTrackingStep.const_800);
         if(_coreComponent != null)
         {
            _coreComponent.events.removeEventListener(HabboLoginTrackingStep.const_800,onCoreRunning);
         }
      }
      ...
      {
         var_819 = IHabboWindowManager(param2);
         if(var_819)
         {
      ...
      public function update(param1:uint) : void
      {
         ...
         if(var_1001 > -1 && _loc2_ < var_1001)
         {
            ++var_1446;
            ErrorReportStorage.addDebugData("Invalid time counter","Invalid times: " + var_1446);
         }
         if(var_1001 > -1 && _loc2_ - var_1001 > 15000)
         {
            ++var_1445;
            ErrorReportStorage.addDebugData("Time leap counter","Time leaps: " + var_1445);
         }
         var_1001 = _loc2_;
         if(var_223 != null)
         {
            var_223.update(param1);
         }
         if(var_224 != null)
         {
      ...
      private function onRoomEngineReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(_roomEngine).events.addEventListener(AvatarWalkWarpingWarningEvent.const_426,onLagWarningEvent);
         Component(_roomEngine).events.addEventListener(RoomObjectRoomAdEvent.const_258,onRoomAdClick);
      }
      ...
      private function onFriendlistReady(param1:IID, param2:IUnknown) : void
      {
         ...
         Component(var_167).events.addEventListener(HabboFriendListTrackingEvent.const_289,onFriendlistTrackingEvent);
      }
      ...
      private function onError(param1:ErrorEvent) : void
      {
         ...
         {
            _crashed = true;
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_9,new Date().getTime().toString());
            if(var_147)
            {
               if(var_147.keyExists("client.fatal.error.url"))
               {
                  ...
                  if(var_223 != null)
                  {
                     _loc4_["null"] = var_223.flashVersion;
                     _loc4_["null"] = var_223.averageUpdateInterval;
                  }
      ...
      {
         if(param1.type == HabboHotelViewEvent.const_705)
         {
            trackLoginStep(HabboLoginTrackingStep.const_1238);
         }
         else if(param1.type == HabboHotelViewEvent.const_459)
         {
            trackLoginStep(HabboLoginTrackingStep.const_1301);
         }
         else if(param1.type == HabboHotelViewEvent.const_66)
         {
            trackLoginStep(HabboLoginTrackingStep.const_1199);
         }
      }
   }
}
