package com.sulake.habbo.tracking
{
   ...
   public class LagWarningLogger
   {
      ...
      {
         var _loc2_:* = null;
         if(!var_1326 || var_1603 <= 0)
         {
            return;
         }
         var _loc1_:int = getTimer();
         if(var_1604 == 0 || _loc1_ - var_1604 > var_1603)
         {
            if(_connection != null)
            {
      ...
      {
         var_1326 = Boolean(int(param1.getKey("lagWarningLog.enabled","0")));
         var_1603 = int(param1.getKey("lagWarningLog.interval.minutes","10")) * 1000 * 60;
      }
