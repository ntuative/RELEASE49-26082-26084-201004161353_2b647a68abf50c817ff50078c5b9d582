package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarView
   {
      ...
      public function ToolbarView(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IEventDispatcher)
      {
         ...
         var_129 = _window.width;
         var_196 = param1.createWindow("extrabar_container_window","",HabboWindowType.const_61,HabboWindowStyle.const_841,0 | 0,new Rectangle(0,0,1,1),null,0,0) as IWindowContainer;
         ...
         var_1058 = String(_loc7_.relocate_by_drag.@state) == "RoomReadyMessageParser";
         if(var_1058)
         {
         ...
         var_1287 = _loc7_.toolbar.@margin_bottom;
         var_1532 = _loc7_.toolbar.@min_group_margin;
         var_1533 = _loc7_.toolbar.@margin_to_extrabar;
         var_260 = new ToolbarBarMenuAnimator(param1,this);
         var _loc8_:XMLList = XMLList(_loc7_.toolbar).children();
         var _loc9_:XMLList = XMLList(_loc7_.extras).children();
         createGroupsFromXmlList(_loc8_,var_270,param1,param2,_window,var_260);
         createGroupsFromXmlList(_loc9_,var_607,param1,param2,var_196,var_260);
         alignWindows();
      }
      ...
      public function dispose() : void
      {
         ...
         while(false)
         {
            _loc1_ = var_270.shift();
            _loc1_.dispose();
            _loc1_ = null;
         }
         while(false)
         {
            _loc1_ = var_607.shift();
            _loc1_.dispose();
            _loc1_ = null;
         }
         if(_window != null)
      ...
      public function animateWindowIn(param1:String, param2:IWindowContainer, param3:Point = null) : void
      {
         ...
         if(_loc4_ != null)
         {
            _loc4_.animateWindowIn(param1,param2,var_129,var_509,param3);
         }
      }
      ...
      private function alignWindows() : void
      {
         ...
         {
            case "LEFT":
               _window.width = var_129;
               _window.height = _loc1_.height;
               _window.x = 0;
               _window.y = 0;
               var_196.x = var_129 + var_1533;
               var_196.y = 0;
               _loc4_ = 0;
               break;
            case "RIGHT":
               _window.width = var_129;
               _window.height = _loc1_.height;
               _window.x = _loc1_.width - var_129;
               _window.y = 0;
               var_196.x = 0;
               var_196.y = 0;
               _loc4_ = 0;
            ...
            case "TOP":
               ...
               _window.height = var_129;
               _window.x = 0;
               _window.y = 0;
               var_196.x = 0;
               var_196.y = var_129 + var_1533;
               _loc4_ = 0;
               break;
            case "BOTTOM":
               _window.width = _loc1_.width;
               _window.height = var_129;
               _window.x = 0;
               _window.y = _loc1_.height - var_129;
               var_196.x = 0;
               var_196.y = 0;
               _loc4_ = 0;
         }
         ...
         else
         {
            ...
            if(false)
            {
               ...
               {
                  _loc7_ = Number(Math.max(var_1532,(0 - _loc6_ * _loc9_ - _toolbarMarginTop - var_1287) / -1));
               }
               else
               {
                  _loc7_ = Number(Math.max(var_1532,(0 - _loc6_ * _loc9_ - _toolbarMarginTop - var_1287) / -1));
      ...
      private function createGroupsFromXmlList(param1:XMLList, param2:Array, param3:IHabboWindowManager, param4:IAssetLibrary, param5:IWindowContainer, param6:ToolbarBarMenuAnimator) : void
      {
         ...
         while(_loc10_ < param1.length())
         {
            ...
            _loc9_ = new ToolbarIconGroup(param3,param4,_loc10_,_events,param5,param6,var_129);
      ...
      private function getTargetOrientationFromXY(param1:Number, param2:Number) : String
      {
         ...
         if(param1 >= _loc3_.width - var_129)
         {
            return "RIGHT";
         }
         if(param2 <= var_129)
         ...
         if(param2 >= _loc3_.height - var_129)
         {
            return "BOTTOM";
         }
         return null;
      ...
      public function hideWindow(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.hideWindow(param1,param2,var_129,var_509);
         }
      }
      ...
      private function getGroupForIcon(param1:String) : ToolbarIconGroup
      {
         ...
         var _loc3_:int = 0;
         _loc3_ = 0;
         while(_loc3_ < var_270.length)
         {
            _loc2_ = var_270[_loc3_];
         ...
         _loc3_ = 0;
         while(_loc3_ < var_607.length)
         {
            _loc2_ = var_607[_loc3_];
            if(_loc2_.acceptsIcon(param1))
            {
               return _loc2_;
            }
      ...
      public function animateWindowOut(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.animateWindowOut(param1,param2,var_509);
         }
      }
      ...
      public function positionWindow(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.positionWindow(param1,param2,var_129,var_509);
         }
      }
