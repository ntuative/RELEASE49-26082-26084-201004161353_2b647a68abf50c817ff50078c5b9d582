package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarBarMenuAnimator
   {
      ...
      private static const const_763:int = 50;
      
      private static const const_1070:Number = 25;
      ...
      private var var_994:ToolbarView;
      ...
      public function ToolbarBarMenuAnimator(param1:IHabboWindowManager, param2:ToolbarView)
      {
         ...
         var_994 = param2;
         var_570 = new Timer(const_1070);
         var_570.addEventListener(TimerEvent.TIMER,animationUpdate);
      }
      ...
      private function registerWindow(param1:IWindowContainer, param2:String) : void
      {
         ...
         var_483.push(param2);
         param1.addEventListener(WindowEvent.const_368,windowEventListener);
         param1.addEventListener(WindowEvent.const_232,windowEventListener);
      }
      ...
      private function createItemObject(param1:String, param2:ToolbarIcon) : MenuAnimatorItem
      {
         ...
         if(_loc3_ == null)
         {
            ...
            _loc4_ = var_994.getIconByMenuId(param1);
            if(_loc4_ == null)
            {
               return null;
            }
      ...
      public function removeItem(param1:String) : void
      {
         if(var_298.indexOf(param1) > -1)
         {
            ...
            else
            {
               ...
               var_298.splice(var_298.indexOf(param1),1);
            }
         }
      }
      ...
      {
         var _loc2_:Point = var_994.getIconLoc(param1.iconId);
      ...
      public function refresh() : void
      {
         ...
         {
            repositionWindow(var_298[_loc1_],true);
            _loc1_++;
         }
      }
      ...
      private function registerDependentMenu(param1:String, param2:Array) : void
      {
         ...
         while(_loc4_ < param2.length)
         {
            ...
            if(true)
            {
               var_569[_loc3_] = new Array();
            }
            if(var_569[_loc3_].indexOf(param1) < 0)
            {
               var_569[_loc3_].push(param1);
            }
            _loc4_++;
         }
      }
      ...
      {
         return param1.x + param1.width < const_763 + _toolbarSize || param1.y < 0 || param1.desktop.width - param1.x < const_763 || param1.desktop.height - param1.y < const_1084;
      }
      ...
      public function windowEventListener(param1:WindowEvent) : void
      {
         ...
         while(_loc2_ < var_482.length)
         {
            if(var_482[_loc2_] == param1.window.name)
            {
               ...
               {
                  _loc4_ = 0;
                  while(_loc4_ < var_569[_loc3_].length)
                  {
                     repositionWindow(var_569[_loc3_][_loc4_],false);
                     _loc4_++;
                  }
               }
            }
