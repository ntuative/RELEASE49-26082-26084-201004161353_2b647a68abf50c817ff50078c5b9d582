package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarIconAnimator
   {
      ...
      public function ToolbarIconAnimator(param1:StateItem, param2:IAssetLibrary, param3:IBitmapWrapperWindow, param4:Number, param5:Number, param6:BitmapData = null)
      {
         ...
         var_1166 = param1.loop;
         if(param1.background != null)
         {
            var_806 = getBitmapDataFromAsset(param1.background,param2);
         }
         ...
         else
         {
            ...
            if(_loc8_ != null)
            {
               var_808.push(new XML());
               var_807.push(_loc8_);
            }
         }
         if(param6 != null)
         {
            var_807[var_54] = param6.clone();
         }
      ...
      {
         if(var_1166 == true || var_667 == 0)
         {
            if(false)
            {
               ++var_54;
               if(var_54 >= var_808.length)
               {
                  var_54 = 0;
                  ++var_667;
               }
      ...
      {
         return var_808.length;
      }
      
      public function hasNextState() : Boolean
      {
         return var_1166 == false && var_667 == 1 && var_1181 != var_31;
      }
      ...
      private function setAsset(param1:IBitmapWrapperWindow, param2:BitmapData) : void
      {
         ...
         if(var_806 != null)
         {
            _loc3_ = new BitmapData(Math.max(param2.width,var_806.width),Math.max(param2.height,var_806.height));
            _loc3_.copyPixels(var_806,var_806.rect,new Point(0,0));
      ...
      {
         var _loc2_:* = null;
         if(var_54 <= var_807.length)
         {
            _loc2_ = var_807[var_54];
