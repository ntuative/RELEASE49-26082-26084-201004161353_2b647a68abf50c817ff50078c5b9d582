package com.sulake.habbo.toolbar
{
   ...
   public class HabboToolbar extends Component implements IHabboToolbar
   {
      ...
      private function onWindowManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_289.addHabboConnectionMessageEvent(new AuthenticationOKMessageEvent(onAuthenticationOK));
      }
      ...
      private function onAuthenticationOK(param1:IMessageEvent) : void
      {
         ...
         events.addEventListener(HabboToolbarSetIconEvent.const_822,onSetToolbarIconBitmapEvent);
         events.addEventListener(HabboToolbarSetIconEvent.const_156,onRemoveToolbarIconEvent);
         events.addEventListener(HabboToolbarSetIconEvent.const_164,onSetToolbarIconStateEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_50,onAnimateWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_378,onAnimateWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_724,onDisplayWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_940,onHideWindowEvent);
         var_31 = true;
         events.dispatchEvent(new HabboToolbarEvent(HabboToolbarEvent.const_88));
      }
      ...
      private function onAnimateWindowEvent(param1:HabboToolbarShowMenuEvent) : void
      {
         if(var_31 && _view != null)
         {
            if(param1.type == HabboToolbarShowMenuEvent.const_50)
            {
