package com.sulake.habbo.friendlist
{
   ...
   public class FriendsView implements ITabView, IFriendsView
   {
      ...
      public static const const_608:String = "bg";
       
      
      private var var_2040:IContainerButtonWindow;
      ...
      private var var_355:AvatarPopupCtrl;
      ...
      {
         _friendList = param1;
         var_355 = new AvatarPopupCtrl(_friendList);
      }
      ...
      public function fillFooter(param1:IWindowContainer) : void
      {
         ...
         var_2043 = initButton("open_homepage",onHomeButtonClick,param1);
         var_2040 = initButton("room_invite",onInviteButtonClick,param1);
         var_2041 = initButton("remove_friend",onRemoveButtonClick,param1);
         refreshButtons();
      }
      ...
      private function refreshFriendEntry(param1:FriendCategory, param2:Friend) : void
      {
         ...
         _loc3_.id = param2.id;
         var _loc4_:IWindow = _loc3_.findChildByName(const_608);
         if(_loc4_ == null)
         {
            return;
         }
         _loc4_.procedure = method_10;
         _loc4_.visible = true;
         if(param2.selected)
         {
      ...
      private function refreshPageLink(param1:IWindowContainer, param2:int, param3:int, param4:Boolean) : void
      {
         ...
         _loc6_.color = _friendList.laf.getRowShadingColor(FriendListTab.const_86,param4);
         _loc6_.visible = true;
      }
      ...
      private function method_10(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            this.var_355.setData(_loc3_.online,_loc3_.name,_loc3_.motto,_loc3_.figure,_loc3_.lastAccess);
            this.var_355.showPopup(_friendList.view.mainWindow,_loc3_.view);
         }
         else if(param1.type == WindowMouseEvent.const_32)
         {
            this.var_355.closePopup();
         }
      ...
      private function refreshButtons() : void
      {
         ...
         setEnabled(var_2043,isEnableHomeButton(_loc1_));
         setEnabled(var_2040,isEnableInviteButton(_loc1_));
         setEnabled(var_2041,isEnableRemoveButton(_loc1_));
      }
      ...
      private function refreshEntry(param1:Boolean, param2:int, param3:FriendCategory, param4:Friend) : Boolean
      {
         ...
         _loc6_.height = 20;
         _loc6_.visible = true;
         var _loc7_:IWindow = _loc6_.findChildByName(const_608);
         _loc7_.color = _friendList.laf.getRowShadingColor(FriendListTab.const_86,_loc5_);
         if(param4 == null)
         {
            param3.view = _loc6_;
      ...
      {
         _friendList.tabs.findTab(FriendListTab.const_86).setNewMessageArrived(true);
      }
      ...
      {
         return _friendList.laf.getRowShadingColor(FriendListTab.const_86,param1);
      }
