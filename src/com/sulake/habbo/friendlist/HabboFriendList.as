package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList
   {
      ...
      private var var_1476:OpenedToWebPopup;
      
      private var var_839:IAvatarRenderManager;
      ...
      private var var_138:IHabboMessenger;
      
      private var var_1475:AvatarSearchResults;
      
      private var _windowManager:IHabboWindowManager;
      
      private var var_584:ISessionDataManager;
      
      private var var_351:FriendRequests;
      
      private var var_1944:int;
      
      var var_87:FriendCategories;
      
      private var var_1943:FriendListLookAndFeel;
      
      private var _communication:IHabboCommunicationManager;
      
      private var var_840:IHabboNotifications;
      
      public function HabboFriendList(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         var_1943 = new FriendListLookAndFeel();
         super(param1,param2,param3);
         var_87 = new FriendCategories(new FriendCategoriesDeps(this));
         var_1475 = new AvatarSearchResults(new AvatarSearchDeps(this));
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         var_351.clearAndUpdateView(false);
         for each(_loc3_ in _loc2_.reqs)
         {
            var_351.addRequest(new FriendRequest(_loc3_));
         }
         if(_loc2_.reqs.length > 0)
         {
            var_402.findTab(FriendListTab.const_87).setNewMessageArrived(true);
            refreshToolBarIcon();
         }
      ...
      {
         var_584 = param2 as ISessionDataManager;
      }
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         var_351 = new FriendRequests(new FriendRequestsDeps(this),_loc2_.userFriendLimit,_loc2_.extendedFriendLimit,_loc2_.evenMoreExtendedFriendLimit);
         for each(_loc3_ in _loc2_.categories)
         {
            var_87.addCategory(new FriendCategory(_loc3_.id,_loc3_.name));
         }
         var_87.addCategory(new FriendCategory(FriendCategory.const_884,getText("friendlist.friends")));
         var_87.addCategory(new FriendCategory(FriendCategory.const_443,getText("friendlist.friends.offlinecaption")));
         for each(_loc4_ in getSortedFriends(_loc2_.friends))
         {
            var_87.addFriend(new Friend(_loc4_));
         }
         var_402 = new FriendListTabs(new FriendListTabsDeps(this));
         if(!var_494)
         {
            var_494 = new Timer(120000);
            var_494.addEventListener(TimerEvent.TIMER,sendFriendListUpdate);
            var_494.start();
         }
         getBuddyRequests();
         registerListeners();
         var_199.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_110,HabboToolbarIconEnum.FRIENDLIST));
      ...
      override public function dispose() : void
      {
         ...
         {
            var_494.stop();
            var_494.removeEventListener(TimerEvent.TIMER,sendFriendListUpdate);
            var_494 = null;
         }
         if(_windowManager)
         {
         ...
         if(var_138)
         {
            var_138.release(new IIDHabboMessenger());
            var_138 = null;
         }
         if(var_147)
         {
         ...
         if(var_839)
         {
            var_839.release(new IIDAvatarRenderManager());
            var_839 = null;
         }
         if(var_840)
         {
            var_840.release(new IIDHabboNotifications());
            var_840 = null;
         }
         if(var_199)
         {
         ...
         if(var_584)
         {
            var_584.release(new IIDSessionDataManager());
            var_584 = null;
         }
         super.dispose();
      }
      ...
      private function onMessengerComponentInit(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_138 = param2 as IHabboMessenger;
      ...
      {
         var_87.onFriendListUpdate(param1);
      ...
      public function openFriendList() : void
      {
         ...
         var _loc1_:FriendListTab = tabs.findTab(FriendListTab.const_86);
      ...
      public function isEmbeddedMinimailEnabled() : Boolean
      {
         ...
         return _loc1_ == "RoomReadyMessageParser";
      }
      ...
      private function toggleWindow() : void
      {
         ...
         else
         {
            ...
            if(_loc1_ == null)
            {
               events.dispatchEvent(new Event(HabboFriendListTrackingEvent.const_289));
            }
            else
            {
               switch(_loc1_.id)
               {
                  case FriendListTab.const_86:
      ...
      {
         var_199 = IHabboToolbar(param2) as IHabboToolbar;
      ...
      private function onHabboSearchResult(param1:IMessageEvent) : void
      {
         ...
         var_1475.searchReceived(_loc2_.friends,_loc2_.others);
      ...
      {
         var _loc1_:HabboToolbarSetIconEvent = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_164,HabboToolbarIconEnum.FRIENDLIST);
         _loc1_.iconState = String(var_351.getCountOfOpenRequests() > 0 ? "2" : "0");
         var_199.events.dispatchEvent(_loc1_);
      }
      ...
      public function getFriend(param1:int) : IFriend
      {
         ...
         return var_87.findFriend(param1);
      }
      ...
      private function onUserRights(param1:IMessageEvent) : void
      {
         ...
         var _loc2_:int = 0;
         if(var_584.hasUserRight("fuse_super_extended_buddylist"))
         {
            _loc2_ = 0;
         }
         else if(var_584.hasUserRight("fuse_extended_buddylist"))
         {
            _loc2_ = 0;
         }
         if(_loc2_ > var_351.limit)
         {
            var_351.limit = _loc2_;
         }
      }
      
      public function declineFriendRequest(param1:int) : void
      {
         var _loc2_:FriendListTab = var_402.findTab(FriendListTab.const_87);
         if(!_loc2_)
         {
            return;
         }
      ...
      {
         var _loc2_:IAvatarImage = var_839.createAvatarImage(param1,AvatarScaleType.SMALL);
         if(!_loc2_)
         {
            return null;
         }
         var _loc3_:BitmapData = _loc2_.getCroppedImage(AvatarSetType.const_48);
         _loc2_.dispose();
         return _loc3_;
      }
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         var_351.addRequestAndUpdateView(_loc3_);
         var _loc4_:FriendListTab = var_402.findTab(FriendListTab.const_87);
      ...
      public function getFriendCount(param1:Boolean, param2:Boolean) : int
      {
         ...
         return this.var_87.getFriendCount(param1,param2);
      }
      ...
      public function openHabboWebPage(param1:String, param2:Dictionary, param3:int, param4:int) : void
      {
         ...
         if(var_1476 == null)
         {
            var_1476 = new OpenedToWebPopup(this);
         }
         var_1476.show(x,y);
      }
