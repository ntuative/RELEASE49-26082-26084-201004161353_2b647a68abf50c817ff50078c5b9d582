package com.sulake.habbo.friendlist.domain
{
   ...
   public class FriendCategory implements IDisposable
   {
      ...
      public static const const_290:int = 100;
      ...
      {
         return Math.ceil(this.var_230.length / const_290);
      }
      ...
      {
         if(this.var_895 >= this.getPageCount())
         {
            this.var_895 = Math.max(0,this.getPageCount() - 1);
         }
      }
      ...
      public function addFriend(param1:Friend) : void
      {
         ...
         {
            _loc4_ = var_230[_loc3_];
            if(_loc2_ < _loc4_.name.toLowerCase())
            {
               var_230.splice(_loc3_,0,param1);
               return;
            }
            _loc3_++;
         }
      ...
      {
         checkPageIndex();
         return Math.min((this.var_895 + 1) * const_290,this.var_230.length);
      }
