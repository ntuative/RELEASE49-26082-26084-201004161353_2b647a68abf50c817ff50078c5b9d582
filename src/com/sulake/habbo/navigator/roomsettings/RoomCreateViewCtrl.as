package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomCreateViewCtrl
   {
      ...
      private var var_1286:Boolean = true;
      
      private var var_884:RoomLayout;
      ...
      public function RoomCreateViewCtrl(param1:HabboNavigator)
      {
         super();
         _navigator = param1;
         var_508 = new Timer(100);
         var_508.addEventListener(TimerEvent.TIMER,updateArrowPos);
         var_38 = new Array();
         var_38.push(new RoomLayout(HabboClubLevelEnum.const_53,104,"a"));
         var_38.push(new RoomLayout(HabboClubLevelEnum.const_53,94,"b"));
         var_38.push(new RoomLayout(HabboClubLevelEnum.const_53,36,"c"));
         var_38.push(new RoomLayout(HabboClubLevelEnum.const_53,84,"d"));
         var_38.push(new RoomLayout(HabboClubLevelEnum.const_53,80,"e"));
         var_38.push(new RoomLayout(HabboClubLevelEnum.const_53,80,"f"));
         var_38.push(new RoomLayout(HabboClubLevelEnum.const_53,416,"i"));
         var_38.push(new RoomLayout(HabboClubLevelEnum.const_53,320,"j"));
         var_38.push(new RoomLayout(HabboClubLevelEnum.const_53,448,"k"));
         var_38.push(new RoomLayout(HabboClubLevelEnum.const_53,352,"l"));
         var_38.push(new RoomLayout(HabboClubLevelEnum.const_53,384,"m"));
         var_38.push(new RoomLayout(HabboClubLevelEnum.const_53,372,"n"));
      ...
      private function prepare() : void
      {
         ...
         var_1057 = new TextFieldManager(_navigator,ITextFieldWindow(var_19.findChildByName("room_name_input")),25,null,_navigator.getText("navigator.createroom.roomnameinfo"));
      ...
      public function dispose() : void
      {
         if(var_508)
         {
            var_508.removeEventListener(TimerEvent.TIMER,updateArrowPos);
            var_508.reset();
            var_508 = null;
         }
      }
      ...
      {
         var_1057.goBackToInitialState();
         var_1057.input.textBackgroundColor = 4294967295;
         var_884 = var_38[0];
      ...
      {
         return IWindowContainer(_navigator.windowManager.createWindow("","",HabboWindowType.const_61,HabboWindowStyle.const_42,HabboWindowParam.const_74,new Rectangle(0,0,100,300)));
      }
      ...
      private function onCreateButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:String = var_1057.getText();
      ...
      {
         var _loc1_:Boolean = var_1057.checkMandatory(_navigator.getText("navigator.createroom.nameerr"));
      ...
      {
         var _loc3_:IBitmapWrapperWindow = IBitmapWrapperWindow(var_884.view.findChildByName("select_arrow"));
         var _loc6_:int = Math.abs(_loc3_.y - 0) < 2 || Math.abs(_loc3_.y - 15) < 2 ? 1 : 2;
         _loc3_.y += !!var_1286 ? _loc6_ : -_loc6_;
         if(_loc3_.y < 0)
         {
            var_1286 = true;
            _loc3_.y = 1;
