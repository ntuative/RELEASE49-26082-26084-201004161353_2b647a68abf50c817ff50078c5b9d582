package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomSettingsCtrl
   {
      ...
      private var var_816:TextFieldManager;
      ...
      private var var_1834:ITextWindow;
      
      private var var_990:IWindowContainer;
      
      private var var_849:TextFieldManager;
      
      private var var_1438:IWindowContainer;
      
      private var var_1833:ITextWindow;
      
      private var var_395:IRoomSettingsCtrlOwner;
      
      private var _inRoom:Boolean;
      
      private var var_1184:TextFieldManager;
      ...
      private var var_850:TextFieldManager;
      ...
      private var var_989:TextFieldManager;
      ...
      {
         close();
         this.var_395.roomSettingsRefreshNeeded();
      }
      ...
      {
         this.var_816.clearErrors();
         this.var_1184.clearErrors();
         this.var_849.clearErrors();
         this.var_850.clearErrors();
         this.var_989.clearErrors();
      ...
      private function populateForm() : void
      {
         ...
         var_816.setText(_loc1_.name);
         var_1184.setText(_loc1_.description);
         var_989.setText("");
         var_1183.setText("");
         ...
         setTag(var_849,_loc1_.tags[0]);
         setTag(var_850,_loc1_.tags[1]);
         if(var_1188)
         {
            if(_loc1_.allowPets)
            {
               this.var_1188.select();
            }
            else
            {
               this.var_1188.unselect();
            }
         }
         if(var_1186)
         {
      ...
      private function onConfirmRoomDelete(param1:WindowMouseEvent, param2:int) : void
      {
         ...
         close();
         var_395.roomSettingsRefreshNeeded();
      ...
      {
         Logger.log("[RoomSettingsCtrl.onDeleteButtonClick] " + var_394);
         _navigator.registerParameter("navigator.roomsettings.deleteroom.confirm.message","room_name",var_81.name);
         var _loc2_:ConfirmDialogView = new ConfirmDialogView(IFrameWindow(_navigator.getXmlWindow("ros_room_delete_confirm")),this,onConfirmRoomDelete,[var_394]);
         _loc2_.show();
      }
      ...
      {
         return IWindowContainer(_navigator.windowManager.createWindow(param1,"",HabboWindowType.const_61,HabboWindowStyle.const_42,HabboWindowParam.const_74,new Rectangle(0,0,100,20)));
      }
      ...
      public function refresh(param1:IWindowContainer) : void
      {
         ...
         var_1438.visible = _inRoom;
         var_1437.visible = _inRoom;
         var_1834.visible = var_481;
         var_1833.visible = !var_481;
         if(var_481)
         {
            var_986.visible = true;
            var_1185.visible = false;
            refreshFlatControllers();
            var_986.height = Util.getLowestPoint(this.var_986) + 4;
         }
         else
         {
            populateForm();
            var_990.visible = true;
            var_1185.visible = true;
            var_1187.visible = _inRoom;
            _navigator.thumbRenderer.refreshThumbnail(IWindowContainer(var_1187.findChildByName("picframe")),_navigator.data.enteredGuestRoom.thumbnail,false);
            var_990.height = Util.getLowestPoint(this.var_990) + 4;
         }
         var_1440.text = !!var_481 ? "${navigator.roomsettings.tobasicsettings}" : "${navigator.roomsettings.toadvancedsettings}";
         Util.moveChildrenToColumn(_window,[var_1438.name,var_1187.name,var_990.name,var_986.name,var_1185.name,var_1437.name],0,0);
      ...
      {
         this.var_394 = param1;
         _navigator.send(new GetRoomSettingsMessageComposer(var_394));
         if(var_988 != null)
         {
      ...
      private function onSaveButtonClick(param1:WindowMouseEvent) : void
      {
         ...
         _loc2_.name = var_816.getText();
         _loc2_.description = var_1184.getText();
         ...
         {
            _loc8_ = var_989.getText();
            _loc9_ = var_1183.getText();
            if(_loc8_ != _loc9_)
            {
               this.var_989.clearErrors();
         ...
         _loc2_.allowPets = var_1188.isSelected;
         _loc2_.allowFoodConsume = var_1186.isSelected;
         _loc2_.allowWalkThrough = var_1189.isSelected;
         _loc2_.tags = new Array();
         addTag(var_849,_loc2_.tags);
         addTag(var_850,_loc2_.tags);
         this.clearErrors();
         this.var_987 = _loc2_.roomId;
      ...
      private function onRemoveAllFlatCtrlsClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _navigator.send(new RemoveAllRightsMessageComposer(this.var_394));
      }
      
      public function onRoomSettingsSaved(param1:int) : void
      {
         if(param1 != this.var_394 || var_987 < 1)
         {
            return;
         }
         close();
      ...
      public function onRoomSettingsSaveError(param1:int, param2:int, param3:String) : void
      {
         ...
         var_987 = 0;
         if(param2 == RoomSettingsSaveErrorMessageParser.const_1229)
         {
            this.var_816.displayError("${navigator.roomsettings.roomnameismandatory}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1142)
         {
            this.var_816.displayError("${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1250)
         {
            this.var_1184.displayError("${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1305)
         {
            ...
            setTagError(this.var_850,param3,"${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1274)
         {
            ...
            setTagError(this.var_850,param3,"${navigator.roomsettings.nonuserchoosabletag}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1297)
         {
            this.var_989.displayError("${navigator.roomsettings.passwordismandatory}");
         }
         else
         {
            this.var_816.displayError("Update failed: error " + param2);
         }
      }
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         _loc2_.addEventListener(WindowEvent.const_712,onDoorModePasswordSelect);
         _loc2_.addEventListener(WindowEvent.const_970,onDoorModePasswordUnselect);
         ...
         this.var_816 = new TextFieldManager(_navigator,ITextFieldWindow(_window.findChildByName("room_name")),60);
         this.var_1184 = new TextFieldManager(_navigator,ITextFieldWindow(_window.findChildByName("description")),255);
         this.var_849 = new TextFieldManager(_navigator,ITextFieldWindow(_window.findChildByName("tag1")),30);
         this.var_850 = new TextFieldManager(_navigator,ITextFieldWindow(_window.findChildByName("tag2")),30);
         this.var_989 = new TextFieldManager(_navigator,ITextFieldWindow(_window.findChildByName("password")),30);
         this.var_1183 = new TextFieldManager(_navigator,ITextFieldWindow(_window.findChildByName("password_confirm")),30);
         this.var_1188 = ICheckBoxWindow(_window.findChildByName("allow_pets_checkbox"));
         this.var_1186 = ICheckBoxWindow(_window.findChildByName("allow_foodconsume_checkbox"));
         this.var_1189 = ICheckBoxWindow(_window.findChildByName("allow_walk_through_checkbox"));
         var_1438 = IWindowContainer(_window.findChildByName("header_container"));
         var_1187 = IWindowContainer(_window.findChildByName("thumbnail_container"));
         var_990 = IWindowContainer(_window.findChildByName("basic_settings_container"));
         var_986 = IWindowContainer(_window.findChildByName("advanced_settings_container"));
         var_1437 = IWindowContainer(_window.findChildByName("switch_view_container"));
         var_1185 = IWindowContainer(_window.findChildByName("footer_container"));
         var_253 = IWindowContainer(_window.findChildByName("flat_controllers_container"));
         var_988 = IWindowContainer(_window.findChildByName("password_container"));
         var_1833 = ITextWindow(_window.findChildByName("basic_caption"));
         var_1834 = ITextWindow(_window.findChildByName("advanced_caption"));
         var_1440 = ITextWindow(_window.findChildByName("switch_view_text"));
         var_1440.procedure = onSwitchView;
         var_988.visible = false;
         if(!_inRoom)
         {
