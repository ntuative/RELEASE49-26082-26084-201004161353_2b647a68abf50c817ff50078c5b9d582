package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class RoomThumbnailCtrl
   {
      ...
      {
         setEnabled(_bgTabButton,this._model.mode != ThumbnailEditorModel.const_40);
         setEnabled(var_1584,this._model.mode != ThumbnailEditorModel.const_56);
         setEnabled(var_1583,this._model.mode != ThumbnailEditorModel.const_35);
      }
      ...
      private function onBgTabButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this._model.mode = ThumbnailEditorModel.const_40;
         this.reload();
      }
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         var_1584 = IButtonWindow(find("top_tab"));
         var_1583 = IButtonWindow(find("obj_tab"));
         var_2208 = IWindowContainer(find("tile_grid"));
         var_2207 = IWindowContainer(find("now_editing_container"));
         ...
         Util.setProcDirectly(var_1584,onTopTabButton);
         Util.setProcDirectly(var_1583,onObjTabButton);
      }
      ...
      private function refreshPositionGrid() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc1_:IWindowContainer = var_2208;
         _loc1_.visible = true;
      ...
      {
         var _loc1_:IWindowContainer = var_2207;
      ...
      private function populateImgList(param1:IItemListWindow, param2:int) : void
      {
         ...
         while(_loc8_ < _loc6_.length)
         {
            ...
            if(_loc9_ == 0)
            {
               _loc7_ = IWindowContainer(_navigator.windowManager.createWindow("row_" + _loc8_,"",HabboWindowType.const_61,HabboWindowStyle.const_42,HabboWindowParam.const_74,new Rectangle(0,0,param1.width,66)));
      ...
      {
         refreshImgSelector(ThumbnailEditorModel.const_40);
