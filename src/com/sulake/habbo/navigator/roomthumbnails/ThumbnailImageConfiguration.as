package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class ThumbnailImageConfiguration
   {
      ...
      private var var_1950:Rectangle;
      ...
      public function getImg() : BitmapData
      {
         ...
         {
            this.var_1948 = this._navigator.getButtonImage(this.var_1949);
         }
      ...
      private function refreshListImg() : void
      {
         ...
         if(this.var_1950 == null)
         {
            ...
            this.var_1950 = new Rectangle(var_1477,var_1477,_loc1_.width - 2 * var_1477,_loc1_.height - 2 * var_1477);
         }
         var_698.bitmap.fillRect(var_698.bitmap.rect,4281545523);
         var_698.bitmap.fillRect(this.var_1950,4284900966);
         copyTo(var_698.bitmap);
         if(_selected)
         {
            var_698.bitmap.copyPixels(var_1951,var_1951.rect,new Point(0,0),null,null,true);
         }
         var_698.invalidate();
      }
