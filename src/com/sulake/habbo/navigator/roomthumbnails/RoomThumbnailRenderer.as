package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class RoomThumbnailRenderer
   {
      ...
      private static const const_1105:int = -16;
      
      private static const const_781:int = 32;
      
      private static const const_1103:int = 8;
      ...
      private var var_1048:Dictionary;
      
      private var var_2039:Dictionary;
      ...
      {
         var_1048 = new Dictionary();
         super();
         _navigator = param1;
         var_875 = new ThumbnailImageConfigurations(_navigator);
      ...
      public function refreshThumbnail(param1:IWindowContainer, param2:RoomThumbnailData, param3:Boolean) : void
      {
         ...
         if(_loc5_ == null)
         {
            ...
            _loc5_ = IBitmapWrapperWindow(_navigator.windowManager.createWindow("bitmap","",HabboWindowType.BITMAP_WRAPPER,HabboWindowStyle.const_41,0 | (!!param3 ? HabboWindowParam.const_43 : HabboWindowParam.const_41),new Rectangle(0,0,_loc7_.width,_loc7_.height)));
      ...
      {
         var _loc3_:ThumbnailImageConfiguration = this.var_875.getImage(ThumbnailEditorModel.const_35,param2.imgId);
         if(_loc3_ == null)
         {
         ...
         param1.copyPixels(_loc5_,_loc5_.rect,new Point(_loc4_.x + const_1105,_loc4_.y + const_1104 - _loc5_.height),null,null,true);
      }
      ...
      {
         return Point(this.var_2039[param1]);
      }
      ...
      private function refreshBg(param1:BitmapData, param2:int) : void
      {
         ...
         var _loc3_:ThumbnailImageConfiguration = this.var_875.getImage(ThumbnailEditorModel.const_40,param2);
         if(_loc3_ == null)
         {
            Logger.log("Unknown bg image id: " + param2);
            _loc3_ = this.var_875.getImage(ThumbnailEditorModel.const_40,1);
         }
      ...
      private function refreshFront(param1:BitmapData, param2:int) : void
      {
         ...
         var _loc3_:ThumbnailImageConfiguration = this.var_875.getImage(ThumbnailEditorModel.const_56,param2);
         if(_loc3_ == null)
         {
      ...
      {
         var _loc3_:int = param2 % 2 == 0 ? 0 : int(const_781 / 2);
         return new Point(param1 * const_781 + _loc3_,param2 * const_1103);
      }
      ...
      private function refreshObjects(param1:BitmapData, param2:Array) : void
      {
         ...
         {
            var_1048[_loc3_] = null;
            _loc3_++;
         }
         for each(_loc4_ in param2)
         {
            var_1048[_loc4_.pos] = _loc4_;
         }
         _loc3_ = 0;
         while(_loc3_ <= const_402)
         {
            if(false)
            {
               refreshObj(param1,var_1048[_loc3_]);
            }
            _loc3_++;
         }
      }
      ...
      private function refreshCover(param1:BitmapData) : void
      {
         if(var_1274 == null)
         {
            var_1274 = _navigator.getButtonImage("rico_rnd");
         }
         param1.copyPixels(var_1274,var_1274.rect,new Point(0,0),null,null,true);
      }
   }
}
