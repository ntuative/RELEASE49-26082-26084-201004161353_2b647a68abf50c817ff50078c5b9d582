package com.sulake.habbo.navigator
{
   ...
   public class RoomPopupCtrl extends PopupCtrl
   {
      ...
      public function RoomPopupCtrl(param1:HabboNavigator, param2:int, param3:int)
      {
         ...
         var_1975 = new RoomThumbnailRenderer(param1);
         var_874 = new TagRenderer(param1,hideInstantly);
      }
      
      private function refreshOwnerName() : void
      {
         refreshTextWithCaption("roomowner",var_174,var_112.ownerName);
      ...
      private function refreshExtraCont() : void
      {
         ...
         var_874.refreshTags(_loc1_,var_112.tags);
         refreshTextWithCaption("rating",_loc1_,"undefined");
         if(false)
         {
            refreshTextWithCaption("startedat",_loc1_,"undefined");
         }
         var_1975.refreshThumbnail(_loc1_,var_112.thumbnail,false);
      ...
      override public function refreshContent(param1:IWindowContainer) : void
      {
         ...
         refreshRoomName(var_174,var_112);
         if(true)
         {
         }
         refreshOwnerName();
         refreshTextWithCaption("roomctg",var_174,!true ? getEventCtg(var_112.categoryId) : getRoomCtg(var_112.categoryId));
         refreshRoomDesc(var_174,var_112);
         refreshExtraCont();
         refreshInfo(var_174,"trading_allowed",var_112.allowTrading);
      ...
      private function onOwnerName(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(_loc3_ != null)
         {
            navigator.mainViewCtrl.startSearch(Tabs.const_197,Tabs.const_205,_loc3_.text);
            this.hideInstantly();
         }
      }
   }
