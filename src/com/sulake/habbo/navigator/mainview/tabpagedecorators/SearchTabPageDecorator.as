package com.sulake.habbo.navigator.mainview.tabpagedecorators
{
   ...
   public class SearchTabPageDecorator implements ITabPageDecorator
   {
      ...
      private var var_1567:TextSearchInputs;
      ...
      private function onClearResultsClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _navigator.mainViewCtrl.startSearch(Tabs.const_197,Tabs.const_205,"-1",MainViewCtrl.const_556);
      }
      ...
      public function refreshCustomContent(param1:IWindowContainer) : void
      {
         ...
         if(var_1567 == null)
         {
            ...
            var_1567 = new TextSearchInputs(_navigator,false,_loc4_);
            initClearResults(_loc4_);
         }
         var _loc3_:IWindowContainer = param1.getChildByName("search_header") as IWindowContainer;
         if(_navigator.data.guestRoomSearchArrived && _navigator.data.guestRoomSearchResults.searchType == Tabs.const_205)
         {
            var_1567.searchStr.setText(_navigator.data.guestRoomSearchResults.searchParam);
         }
