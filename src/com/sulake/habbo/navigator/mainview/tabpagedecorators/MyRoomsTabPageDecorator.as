package com.sulake.habbo.navigator.mainview.tabpagedecorators
{
   ...
   public class MyRoomsTabPageDecorator implements ITabPageDecorator
   {
      ...
      private var var_527:IDropMenuWindow;
      ...
      private function getSearchTypeForIndex(param1:int) : int
      {
         if(param1 == 1)
         {
            return Tabs.const_713;
         }
         if(param1 == 2)
         {
            return Tabs.const_512;
         }
         if(param1 == 3)
         {
         ...
         return Tabs.const_230;
      }
      
      private function startSearch() : void
      {
         var _loc1_:int = var_527 == null ? 0 : int(var_527.selection);
         Logger.log("Me subNavi selection changed: " + _loc1_);
         _navigator.mainViewCtrl.startSearch(Tabs.const_246,getSearchTypeForIndex(_loc1_));
      }
      ...
      public function refreshCustomContent(param1:IWindowContainer) : void
      {
         ...
         if(var_527 == null)
         {
            var_527 = IDropMenuWindow(_loc3_.findChildByName("meSubNavi"));
            var_527.procedure = onChangeSubNavi;
            prepareSubNavi();
         }
         _loc3_.visible = true;
      }
