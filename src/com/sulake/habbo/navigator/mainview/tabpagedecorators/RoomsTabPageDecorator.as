package com.sulake.habbo.navigator.mainview.tabpagedecorators
{
   ...
   public class RoomsTabPageDecorator implements ITabPageDecorator
   {
      ...
      private var var_474:IDropMenuWindow;
      ...
      private function startSearch() : void
      {
         var _loc2_:* = null;
         var _loc3_:int = 0;
         var _loc1_:int = var_474 == null ? 0 : int(var_474.selection);
         Logger.log("Room filter changed: " + _loc1_);
         if(_loc1_ == 0)
         {
            _navigator.mainViewCtrl.startSearch(Tabs.const_275,Tabs.const_294);
         }
         else if(_loc1_ == 1)
         {
            _navigator.mainViewCtrl.startSearch(Tabs.const_275,Tabs.const_615);
         }
         else
         {
            ...
            _navigator.mainViewCtrl.startSearch(Tabs.const_275,Tabs.const_294,"" + _loc3_);
         }
      }
      ...
      public function refreshCustomContent(param1:IWindowContainer) : void
      {
         ...
         if(var_474 == null)
         {
            var_474 = IDropMenuWindow(_loc3_.findChildByName("roomCtgFilter"));
            var_474.procedure = onChangeFilter;
