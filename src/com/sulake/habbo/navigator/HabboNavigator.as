package com.sulake.habbo.navigator
{
   ...
   public class HabboNavigator extends Component implements IHabboNavigator
   {
      ...
      private var var_843:RoomCreateViewCtrl;
      
      private var var_1975:RoomThumbnailRenderer;
      ...
      private var var_989:GuestRoomPasswordInput;
      ...
      public function HabboNavigator(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         var_586 = new RoomInfoViewCtrl(this);
         var_843 = new RoomCreateViewCtrl(this);
         var_1975 = new RoomThumbnailRenderer(this);
         var_989 = new GuestRoomPasswordInput(this);
      ...
      public function performTagSearch(param1:String) : void
      {
         ...
         var_258.startSearch(Tabs.const_197,Tabs.const_334,param1);
      ...
      {
         if(param1 != null && var_199 != null)
         {
            var_199.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_50,HabboToolbarIconEnum.NAVIGATOR,param1));
         }
      }
      ...
      private function setHabboToolbarIcon() : void
      {
         if(var_199 != null)
         {
            var_199.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_110,HabboToolbarIconEnum.NAVIGATOR));
            if(this._data != null && this._data.settings != null && this._data.settings.homeRoomId > 0)
            {
               var_199.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_110,HabboToolbarIconEnum.EXITROOM));
            }
         }
      }
      ...
      public function showOwnRooms() : void
      {
         ...
         var_258.startSearch(Tabs.const_246,Tabs.const_230);
         var_402.getTab(Tabs.const_246).tabPageDecorator.tabSelected();
      }
