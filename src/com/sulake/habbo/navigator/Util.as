package com.sulake.habbo.navigator
{
   ...
   public class Util
   {
      ...
      private static var var_1530:CutToHeight = new CutToHeight();
      
      private static var var_1531:CutToWidth = new CutToWidth();
      ...
      public static function cutTextToHeight(param1:ITextWindow, param2:String, param3:int) : void
      {
         ...
         var_1530.beforeSearch(param2,param1,param3);
         binarySearch(var_1530,param2.length - 1);
      }
      ...
      public static function cutTextToWidth(param1:ITextWindow, param2:String, param3:int) : void
      {
         ...
         var_1531.beforeSearch(param2,param1,param3);
         binarySearch(var_1531,param2.length - 1);
      }
   }
}
