package com.sulake.habbo.navigator.inroom
{
   ...
   public class RoomEventViewCtrl
   {
      ...
      private var var_1984:IButtonWindow;
      
      private var var_1238:IButtonWindow;
      ...
      private var var_851:IDropMenuWindow;
      ...
      private function onEditButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc5_:String = var_711.getText();
         var _loc6_:Array = new Array();
         addTag(_loc6_,var_849.getText());
         addTag(_loc6_,var_850.getText());
      ...
      private function editEvent(param1:RoomEventData) : void
      {
         ...
         var_1983.text = _navigator.getText("roomevent_type_" + param1.eventType);
         _eventNameInput.setText(param1.eventName);
         var_711.setText(param1.eventDescription);
         var_849.setText(getTagFromEvent(param1,1));
         var_850.setText(getTagFromEvent(param1,2));
         var_1238.visible = false;
         var_1237.visible = true;
         var_1236.visible = true;
         var_1491.visible = false;
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         if(_window == null)
         {
            ...
            var_1490 = IWindowContainer(find("event_type_disabled_cont"));
            var_1983 = ITextWindow(find("event_type_disabled_text"));
            var_1491 = ITextWindow(find("create_caption"));
            var_1489 = ITextWindow(find("edit_caption"));
            var_1238 = IButtonWindow(find("create_button"));
            var_1237 = IButtonWindow(find("edit_button"));
            var_1984 = IButtonWindow(find("cancel_button"));
            var_1236 = IButtonWindow(find("end_button"));
            var_851 = IDropMenuWindow(find("event_type"));
            prepareEventTypes();
            Util.setProcDirectly(var_1238,onCreateButtonClick);
            Util.setProcDirectly(var_1237,onEditButtonClick);
            Util.setProcDirectly(var_1236,onEndButtonClick);
            Util.setProcDirectly(var_1984,onCancelButtonClick);
            _eventNameInput = new TextFieldManager(_navigator,getInput("event_name"),25);
            var_711 = new TextFieldManager(_navigator,getInput("event_desc"),100);
            var_849 = new TextFieldManager(_navigator,getInput("event_tag_1"),25);
            var_850 = new TextFieldManager(_navigator,getInput("event_tag_2"),25);
      ...
      private function isMandatoryFieldsFilled() : Boolean
      {
         ...
         if(!var_711.checkMandatory(_navigator.getText("navigator.eventsettings.descerr")))
         {
            return false;
         }
         return true;
      ...
      private function createEvent() : void
      {
         ...
         var_850.goBackToInitialState();
         var_851.selection = 0;
         var_1491.visible = true;
