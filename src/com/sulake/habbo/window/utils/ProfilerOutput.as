package com.sulake.habbo.window.utils
{
   ...
   public class ProfilerOutput implements IDisposable
   {
      ...
      public function ProfilerOutput(param1:IProfiler, param2:IHabboWindowManager, param3:IWindowRenderer)
      {
         ...
         var_446.addStopEventListener(refresh);
      ...
      {
         var _loc2_:Array = var_446.getProfilerAgentsInArray();
      ...
      public function dispose() : void
      {
         if(!_disposed)
         {
            _window.dispose();
            _window = null;
            var_446.removeStopEventListener(refresh);
            var_446 = null;
            _windowManager = null;
            var_677 = null;
            _disposed = true;
