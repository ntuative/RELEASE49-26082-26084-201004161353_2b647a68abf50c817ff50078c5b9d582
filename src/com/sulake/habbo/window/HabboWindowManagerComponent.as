package com.sulake.habbo.window
{
   ...
   public class HabboWindowManagerComponent extends Component implements IHabboWindowManager, ICoreWindowManager, IWindowFactory, IUpdateReceiver, IWindowContextStateListener
   {
      ...
      private static const const_347:uint = 3;
      ...
      private var var_1191:ProfilerAgentTask;
      
      private var var_1192:IEventDispatcher;
      
      private var var_2381:uint = 0;
      
      private var var_1190:ProfilerAgentTask;
      
      private var var_1193:ProfilerOutput;
      
      private var var_677:IWindowRenderer;
      ...
      public function HabboWindowManagerComponent(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         _instance = this;
         var_1192 = Component(param1).events;
         var_396 = new Array();
      ...
      {
         return var_221[param2].getDesktopWindow().getChildByName(param1);
      }
      ...
      {
         return var_221[param9].create(param1,param2,param3,param4,param5,param6,param7,null,param8,null,null);
      }
      ...
      private function initialize(param1:IID, param2:IUnknown) : void
      {
         ...
         var_678 = new SkinContainer(_loc3_.content as XML,assets);
         var_677 = new WindowRenderer(var_678);
         var_221 = new Array(const_347);
         var _loc5_:int = 0;
         while(_loc5_ < const_347)
         {
            _loc4_ = new WindowContext("layer_" + _loc5_,var_677,this,_localization,context.displayObjectContainer,new Rectangle(0,0,context.displayObjectContainer.stage.stageWidth,context.displayObjectContainer.stage.stageHeight),this);
            var_221[_loc5_] = _loc4_;
            _loc5_++;
         }
         _windowContext = var_221[const_1083];
         registerUpdateReceiver(this,0);
         _loc6_ = new Bitmap(assets.getAssetByName("habbo_cursor_link_png").content as BitmapData);
         _windowContext.getMouseCursor().defineCustomCursorType(MouseCursorType.const_286,_loc6_);
         _loc6_ = new Bitmap(assets.getAssetByName("habbo_cursor_drag_png").content as BitmapData);
         _windowContext.getMouseCursor().defineCustomCursorType(MouseCursorType.const_1322,_loc6_);
      }
      
      public function removeWindow(param1:String, param2:uint = 1) : void
      {
         var _loc3_:IDesktopWindow = var_221[param2].getDesktopWindow();
      ...
      override public function dispose() : void
      {
         if(!_isDisposed)
         {
            ...
            while(false)
            {
               IDisposable(var_221.pop()).dispose();
            }
            var_221 = null;
            while(false)
            {
      ...
      {
         return var_221[param1].getDesktopWindow().getChildAt(_windowContext.getDesktopWindow().numChildren - 1);
      }
      
      public function getLayoutByTypeAndStyle(param1:uint, param2:uint) : XML
      {
         var _loc3_:Dictionary = var_396[param2] as Dictionary;
         if(_loc3_ == null)
         {
            return null;
         }
         var _loc4_:XML = _loc3_[param1] as XML;
         return _loc4_ == null ? var_396[0][param1] as XML : _loc4_;
      }
      ...
      private function receiveProfilerInterface(param1:IID, param2:IUnknown) : void
      {
         ...
         if(var_1193 == null)
         {
            ...
            if(_loc3_ != null)
            {
               var_1193 = new ProfilerOutput(_loc3_,this,var_677);
               var_1191 = new ProfilerAgentTask("Update","Event processing");
               _loc3_.getProfilerAgentForReceiver(this).addSubTask(var_1191);
               var_1190 = new ProfilerAgentTask("Redraw","Window rasterizer");
               _loc3_.getProfilerAgentForReceiver(this).addSubTask(var_1190);
               var_991 = true;
            }
         }
      }
      ...
      {
         return var_678.getDefaultAttributesByTypeAndStyle(param1,param2);
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         if(WindowContext.var_942.length > 0)
         {
            var_1192.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_INPUT));
            _loc2_ = const_347 - 1;
            while(_loc2_ >= 0)
            {
               var_221[_loc2_].update(param1);
               _loc2_--;
            }
         }
         if(var_991)
         ...
         var_1192.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_RENDER));
         _loc2_ = 0;
         while(_loc2_ < const_347)
         {
            var_221[_loc2_].render(param1);
            _loc2_++;
         }
         if(var_991)
         {
         ...
         if(WindowContext.var_942.length > 0)
         {
            WindowContext.var_942.flush();
         }
         if(WindowContext.var_1380.length > 0)
         {
            WindowContext.var_1380.flush();
         }
         var_1192.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_SLEEP));
      }
      ...
      public function mouseEventReceived(param1:String, param2:IWindow) : void
      {
         if(param2 != null)
         {
            ...
            {
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1338,new Date().getTime().toString());
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1277,param2.name + ": " + param2.toString());
            }
            else if(param1 == MouseEvent.MOUSE_UP)
            {
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1197,new Date().getTime().toString());
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1168,param2.name + ": " + param2.toString());
            }
         }
      }
   }
