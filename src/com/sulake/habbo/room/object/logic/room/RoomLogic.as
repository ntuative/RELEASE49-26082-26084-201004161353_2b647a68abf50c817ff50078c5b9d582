package com.sulake.habbo.room.object.logic.room
{
   ...
   public class RoomLogic extends ObjectLogicBase
   {
      ...
      private var var_1606:int = 1500;
      
      private var var_1605:int = 255;
      
      private var var_1607:int = 255;
      
      private var var_1379:uint = 16777215;
      
      private var var_1106:uint = 16777215;
      
      protected var var_74:RoomPlaneParser = null;
      
      private var var_936:int = 0;
      
      private var var_1137:int = 255;
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(_loc3_ != null)
         {
            switch(_loc3_.type)
            {
               case RoomObjectRoomUpdateMessage.const_511:
                  _loc2_.setString(RoomObjectVariableEnum.const_637,_loc3_.value);
                  break;
               case RoomObjectRoomUpdateMessage.const_638:
                  _loc2_.setString(RoomObjectVariableEnum.const_576,_loc3_.value);
                  break;
               case RoomObjectRoomUpdateMessage.const_566:
                  _loc2_.setString(RoomObjectVariableEnum.const_711,_loc3_.value);
            }
            return;
         }
         ...
         if(_loc4_ != null)
         {
            ...
            switch(_loc4_.type)
            {
               case RoomObjectRoomMaskUpdateMessage.const_476:
                  _loc8_ = "null";
                  if(_loc4_.maskCategory == RoomObjectRoomMaskUpdateMessage.const_209)
                  {
                     _loc8_ = "null";
                  }
                  var_400.addMask(_loc4_.maskId,_loc4_.maskType,_loc4_.maskLocation,_loc8_);
                  _loc7_ = true;
                  break;
               case RoomObjectRoomMaskUpdateMessage.const_528:
                  _loc7_ = var_400.removeMask(_loc4_.maskId);
            }
            if(_loc7_)
            {
               _loc9_ = var_400.getXML();
               _loc10_ = _loc9_.toXMLString();
               _loc2_.setString(RoomObjectVariableEnum.const_856,_loc10_);
            }
            return;
         }
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.setString(RoomObjectVariableEnum.const_917,param1.toString(),true);
            _loc2_.setNumber(RoomObjectVariableEnum.const_624,16777215);
         }
      }
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         if(_loc5_ < 1 || _loc5_ > var_74.planeCount)
         {
         ...
         _loc5_--;
         var _loc7_:* = null;
         var _loc8_:IVector3d = var_74.getPlaneLocation(_loc5_);
         var _loc9_:IVector3d = var_74.getPlaneLeftSide(_loc5_);
         var _loc10_:IVector3d = var_74.getPlaneRightSide(_loc5_);
         var _loc11_:IVector3d = var_74.getPlaneNormalDirection(_loc5_);
         var _loc12_:IVector3d = var_74.getPlaneNormal(_loc5_);
         var _loc13_:int = var_74.getPlaneType(_loc5_);
         ...
         {
            _loc4_.setNumber(RoomObjectVariableEnum.const_1279,_loc20_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1346,_loc21_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1200,_loc22_);
            ...
            switch(param1.type)
            {
               ...
               case MouseEvent.CLICK:
                  ...
                  {
                     if(_loc13_ == RoomPlaneData.const_143)
                     {
                        _loc25_ = new RoomObjectTileMouseEvent(_loc26_,_loc24_,_loc23_,_loc20_,_loc21_,_loc22_);
                     }
                     else if(_loc13_ == RoomPlaneData.const_140 || _loc13_ == RoomPlaneData.const_262)
                     {
                        _loc27_ = 90;
                        if(_loc11_ != null)
                        {
      ...
      private function updateBackgroundColor(param1:int) : void
      {
         ...
         if(var_936)
         {
            ...
            {
               _loc7_ = var_1379 >> 16 & 255;
               _loc8_ = var_1379 >> 8 & 255;
               _loc9_ = var_1379 & 255;
               _loc10_ = var_1106 >> 16 & 255;
               _loc11_ = var_1106 >> 8 & 255;
               _loc12_ = var_1106 & 255;
               _loc13_ = (_loc2_ - var_936) / var_1606;
               _loc7_ += (_loc10_ - _loc7_) * _loc13_;
               _loc8_ += (_loc11_ - _loc8_) * _loc13_;
               _loc9_ += (_loc12_ - _loc9_) * _loc13_;
               _loc3_ = (_loc7_ << 16) + (_loc8_ << 8) + _loc9_;
               _loc4_ = var_1605 + (var_1607 - var_1605) * _loc13_;
               _color = _loc3_;
               var_1137 = _loc4_;
            }
            ...
            _loc6_.setNumber(RoomObjectVariableEnum.const_624,_loc3_);
         }
      }
   }
}
