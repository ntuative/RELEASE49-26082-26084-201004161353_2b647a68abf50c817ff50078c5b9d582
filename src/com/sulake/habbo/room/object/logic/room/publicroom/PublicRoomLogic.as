package com.sulake.habbo.room.object.logic.room.publicroom
{
   ...
   public class PublicRoomLogic extends RoomLogic
   {
      ...
      public function adDelayTimeout() : void
      {
         ...
         _loc1_.setNumber(RoomObjectVariableEnum.const_417,Number(false));
      }
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         _loc2_.setString(RoomObjectVariableEnum.const_329,"");
         _loc2_.setString(RoomObjectVariableEnum.const_557,"");
         _loc2_.setNumber(RoomObjectVariableEnum.const_417,Number(false));
         var_928 = true;
      }
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(_loc3_ != null)
         {
            switch(_loc3_.type)
            {
               case RoomObjectRoomAdUpdateMessage.const_890:
                  _loc2_.setString(RoomObjectVariableEnum.const_329,_loc3_.asset);
                  _loc2_.setString(RoomObjectVariableEnum.const_557,_loc3_.clickUrl);
                  _loc2_.setNumber(RoomObjectVariableEnum.const_417,Number(true));
                  var_1061 = getTimer() + _loc2_.getNumber(RoomVariableEnum.const_861);
            }
         }
      }
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         switch(_loc3_.type)
         {
            case MouseEvent.CLICK:
               if(_loc3_.spriteTag == RoomObjectVariableEnum.const_370)
               {
                  _loc7_ = _loc4_.getString(RoomObjectVariableEnum.const_557);
