package com.sulake.habbo.room.object.logic.room
{
   ...
   public class SelectionArrowLogic extends ObjectLogicBase
   {
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.setNumber(RoomObjectVariableEnum.const_198,1);
         }
      }
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(_loc2_ != null)
         {
            ...
            if(_loc2_.type == RoomObjectVisibilityUpdateMessage.const_356)
            {
               if(_loc3_ != null)
               {
            ...
            else if(_loc2_.type == RoomObjectVisibilityUpdateMessage.const_413)
            {
               if(_loc3_ != null)
               {
