package com.sulake.habbo.room.object.logic.furniture
{
   ...
   public class FurnitureLogic extends MovingObjectLogic
   {
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               {
                  _loc2_.setString(RoomObjectVariableEnum.const_355,String(_loc3_.extra));
               }
            }
            return;
         }
         ...
         if(_loc4_ != null)
         {
            if(_loc2_ != null)
            {
               _loc2_.setString(RoomObjectVariableEnum.const_818,_loc4_.itemData);
            }
            return;
         }
         var_756 = false;
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         object.getModelController().setNumber(RoomObjectVariableEnum.const_282,var_1087,true);
         object.getModelController().setNumber(RoomObjectVariableEnum.const_444,var_1088,true);
         object.getModelController().setNumber(RoomObjectVariableEnum.const_538,var_1086,true);
         object.getModelController().setNumber(RoomObjectVariableEnum.const_1271,var_2191,true);
         object.getModelController().setNumber(RoomObjectVariableEnum.const_1403,var_2190,true);
         object.getModelController().setNumber(RoomObjectVariableEnum.const_830,var_1344,true);
         object.getModelController().setNumberArray(RoomObjectVariableEnum.const_594,var_227,true);
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         var _loc9_:String = _loc3_.getString(RoomObjectVariableEnum.const_307);
         switch(param1.type)
         {
