         ...
         switch(param1.type)
         {
            case MouseEvent.DOUBLE_CLICK:
               if(eventDispatcher != null)
               {
                  ...
                  {
                     _loc5_ = new RoomObjectFurnitureActionEvent(RoomObjectFurnitureActionEvent.const_439,_loc3_,_loc4_);
                  }
                  else if(param1.spriteTag == "deactivate")
                  {
                     _loc5_ = new RoomObjectFurnitureActionEvent(RoomObjectFurnitureActionEvent.const_387,_loc3_,_loc4_);
                  }
                  if(_loc5_ != null)
                  {
