package com.sulake.habbo.room.object
{
   ...
   public class RoomPlaneParser
   {
      ...
      private var var_716:Number = 0;
      
      private var var_360:int = 0;
      
      private var var_359:int = 0;
      
      private var var_1278:Number = 0;
      ...
      private var var_881:Number = 0;
      
      private var var_362:int = 0;
      
      private var var_361:int = 0;
      
      private var var_110:Number = 0;
      ...
      public function getPlaneType(param1:int) : int
      {
         ...
         {
            return RoomPlaneData.const_972;
         }
      ...
      {
         var _loc11_:* = null;
         addPlane(RoomPlaneData.const_140,param1,param2,param3,[param4]);
         addPlane(RoomPlaneData.const_262,param1,param2,param3,[param4]);
         var _loc9_:Vector3d = Vector3d.crossProduct(param2,param3);
         var _loc10_:Vector3d = Vector3d.product(_loc9_,1 / _loc9_.length * -var_881);
         addPlane(RoomPlaneData.const_140,Vector3d.sum(param1,param3),param2,_loc10_,[_loc9_,param4]);
         if(param5)
         {
            addPlane(RoomPlaneData.const_140,Vector3d.sum(Vector3d.sum(param1,param2),param3),Vector3d.product(param3,-(param3.length + var_110) / param3.length),_loc10_,[_loc9_,param4]);
         }
         if(param6)
         {
            addPlane(RoomPlaneData.const_140,Vector3d.sum(param1,Vector3d.product(param3,-var_110 / param3.length)),Vector3d.product(param3,(param3.length + var_110) / param3.length),_loc10_,[_loc9_,param4]);
            if(param7)
            {
               _loc11_ = Vector3d.product(param2,var_881 / param2.length);
               addPlane(RoomPlaneData.const_140,Vector3d.sum(Vector3d.sum(param1,param3),Vector3d.product(_loc11_,-1)),_loc11_,_loc10_,[_loc9_,param2,param4]);
            }
         }
      }
      ...
      public function method_8(param1:XML) : Boolean
      {
         var _loc8_:* = null;
         var _loc9_:* = null;
         var _loc10_:int = 0;
      ...
      public function setTileHeight(param1:int, param2:int, param3:Number) : Boolean
      {
         ...
         if(param1 >= 0 && param1 < _width && param2 >= 0 && param2 < _height)
         {
            ...
            {
               if(param1 == var_359 || param1 == var_362)
               {
                  _loc5_ = false;
                  _loc6_ = var_360;
                  while(_loc6_ < var_361)
                  {
               ...
               if(param2 == var_360 || param2 == var_361)
               {
                  _loc7_ = false;
                  _loc8_ = var_359;
      ...
      {
         var _loc12_:RoomPlaneData = addPlane(RoomPlaneData.const_143,param1,param2,param3);
         ...
         if(_loc12_)
         {
            ...
            if(param6)
            {
               ...
               _loc14_ = addPlane(RoomPlaneData.const_143,_loc13_,new Vector3d(0,0,-var_110),param2);
               if(_loc14_ != null)
               {
                  if(param8 > 0)
                  {
                     _loc14_.addMask(0,0,var_110,param8);
                  }
                  if(param9 > 0)
                  {
                     _loc14_.addMask(0,param2.length - param9,var_110,param9);
                  }
               }
            }
            if(param7)
            {
               ...
               _loc14_ = addPlane(RoomPlaneData.const_143,_loc13_,new Vector3d(0,0,-var_110),Vector3d.product(param2,-1));
               if(_loc14_ != null)
               {
                  if(param9 > 0)
                  {
                     _loc14_.addMask(0,0,var_110,param9);
                  }
                  if(param8 > 0)
                  {
                     _loc14_.addMask(0,param2.length - param8,var_110,param8);
                  }
               }
            }
            if(param4)
            {
               ...
               _loc15_ = addPlane(RoomPlaneData.const_143,_loc13_,new Vector3d(0,0,-var_110),Vector3d.product(param3,-1));
               if(_loc15_ != null)
               {
                  if(param11 > 0)
                  {
                     _loc15_.addMask(0,0,var_110,param11);
                  }
                  if(param10 > 0)
                  {
                     _loc15_.addMask(0,param3.length - param10,var_110,param10);
                  }
               }
            }
            if(param5)
            {
               ...
               _loc15_ = addPlane(RoomPlaneData.const_143,_loc13_,new Vector3d(0,0,-var_110),param3);
               if(_loc15_ != null)
               {
                  if(param10 > 0)
                  {
                     _loc15_.addMask(0,0,var_110,param10);
                  }
                  if(param11 > 0)
                  {
                     _loc15_.addMask(0,param3.length - param11,var_110,param11);
                  }
               }
            }
         }
