package com.sulake.habbo.room.object.visualization.room.mask
{
   ...
   public class PlaneMask
   {
      ...
      private var var_682:PlaneMaskVisualization = null;
      ...
      protected function getMaskVisualization(param1:int) : PlaneMaskVisualization
      {
         ...
         {
            var_682 = var_398.getValue(String(_sizes[_loc2_])) as PlaneMaskVisualization;
         }
         else
         {
            var_682 = null;
      ...
      public function createMaskVisualization(param1:int) : PlaneMaskVisualization
      {
         ...
         var_398.add(String(param1),_loc2_);
         _sizes.push(param1);
         _sizes.sort();
         return _loc2_;
      }
      ...
      public function dispose() : void
      {
         ...
         if(var_398 != null)
         {
            ...
            {
               _loc1_ = var_398.getWithIndex(_loc2_) as PlaneMaskVisualization;
               if(_loc1_ != null)
               {
                  _loc1_.dispose();
               }
