package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
   ...
   public class Plane
   {
      ...
      private var var_655:PlaneVisualization = null;
      ...
      {
         if(var_291.getValue(String(param1)) != null)
         {
            return null;
         }
      ...
      public function clearCache() : void
      {
         ...
         {
            _loc2_ = var_291.getWithIndex(_loc1_) as PlaneVisualization;
            if(_loc2_ != null)
            {
               _loc2_.clearCache();
            }
      ...
      protected function getPlaneVisualization(param1:int) : PlaneVisualization
      {
         ...
         {
            var_655 = var_291.getValue(String(_sizes[_loc2_])) as PlaneVisualization;
         }
         else
         {
            var_655 = null;
      ...
      public function dispose() : void
      {
         ...
         if(var_291 != null)
         {
            ...
            {
               _loc1_ = var_291.getWithIndex(_loc2_) as PlaneVisualization;
               if(_loc1_ != null)
               {
                  _loc1_.dispose();
               }
