package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomPlane
   {
      ...
      private var var_235:PlaneBitmapData = null;
      
      private var var_757:IPlaneRasterizer = null;
      ...
      private var var_1580:Boolean = true;
      
      private var _width:Number = 0;
      
      private var var_176:BitmapData = null;
      ...
      private function draw(param1:BitmapData, param2:Matrix) : void
      {
         ...
         if(_bitmapData != null)
         {
            if(param2.a == 1 && param2.d == 1 && param2.c == 0 && param2.b != 0 && Math.abs(param2.b) <= 1 && (_type == const_224 || _type == const_184))
            {
               _loc3_ = 0;
               _loc4_ = 0;
               _loc5_ = 0;
      ...
      private function updateMask(param1:BitmapData, param2:IRoomGeometry) : void
      {
         ...
         var _loc13_:int = 0;
         var _loc14_:int = 0;
         if(!var_920 || false && false && !var_154 || var_574 == null)
         {
            return;
         }
         ...
         if(var_154)
         {
            ...
            while(_loc5_ < var_201.length)
            {
               ...
               if(_loc3_ != null)
               {
                  ...
                  _loc12_ = _loc3_.type;
                  var_574.updateMask(var_58,_loc12_,param2.scale,_loc9_,_loc10_,_loc11_);
                  var_758.push(new RoomPlaneBitmapMask(_loc12_,_loc3_.leftSideLoc,_loc3_.rightSideLoc));
               }
               _loc5_++;
            }
            _loc6_ = 0;
            while(_loc6_ < var_278.length)
            {
               ...
               if(_loc4_ != null)
               {
                  ...
                  var_1089.push(new RoomPlaneRectangleMask(_loc4_.leftSideLength,_loc4_.rightSideLoc,_loc4_.leftSideLength,_loc4_.rightSideLength));
               }
               _loc6_++;
            }
            var_154 = false;
      ...
      private function getTextureIdentifier(param1:Number) : String
      {
         if(var_757 != null)
         {
            return var_757.getTextureIdentifier(param1,normal);
         }
      ...
      private function renderTexture(param1:IRoomGeometry, param2:BitmapData) : void
      {
         ...
         if(_type == const_224 || _type == const_184)
         {
         ...
         if(true)
         {
            while(_loc1_ < var_201.length)
            {
               ...
               if(_loc4_ != null)
               {
                  ...
                  {
                     _loc7_ = var_758[_loc2_] as RoomPlaneBitmapMask;
                     if(_loc7_ != null)
                     {
      ...
      public function update(param1:IRoomGeometry, param2:int, param3:Boolean) : Boolean
      {
         ...
         if(param3)
         {
            ...
            _loc5_ = 0;
            while(_loc5_ < var_1289.length)
            {
               _loc4_ = Number(Vector3d.cosAngle(param1.directionAxis,var_1289[_loc5_]));
               if(_loc4_ > -0.001)
               {
                  if(_isVisible)
                  {
      ...
      private function needsNewTexture(param1:IRoomGeometry, param2:int) : Boolean
      {
         ...
         var _loc3_:PlaneBitmapData = var_235;
         if(_loc3_ == null)
         {
      ...
      private function getTexture(param1:IRoomGeometry, param2:int) : BitmapData
      {
         ...
         if(needsNewTexture(param1,param2))
         {
            ...
            if(var_757 != null)
            {
               _loc3_ = var_757.render(_loc8_,_id,_loc5_,_loc6_,param1.scale,_loc7_,var_1580,var_2195,var_2193,var_2192,var_2196,param2);
               if(_loc3_ != null)
               {
      ...
      private function combineTextureMask(param1:BitmapData, param2:BitmapData) : void
      {
         ...
         if(var_176 != null && (var_176.width != param1.width || var_176.height != param1.height))
         {
            var_176.dispose();
            var_176 = null;
         }
         if(var_176 == null)
         {
            var_176 = new BitmapData(param1.width,param1.height,true,4294967295);
         }
         var_176.copyChannel(param1,param1.rect,new Point(0,0),BitmapDataChannel.ALPHA,BitmapDataChannel.RED);
         var_176.draw(param2,null,null,BlendMode.DARKEN);
         param1.copyChannel(var_176,var_176.rect,new Point(0,0),BitmapDataChannel.RED,BitmapDataChannel.ALPHA);
      }
