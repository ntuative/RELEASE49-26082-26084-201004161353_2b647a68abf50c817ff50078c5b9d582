package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
   ...
   public class PlaneRasterizer implements IPlaneRasterizer
   {
      ...
      protected static const const_486:String = "CatalogPageOpenedEvent";
      ...
      private var var_906:IGraphicAssetCollection = null;
      
      private var var_99:Map = null;
         ...
         while(_loc4_ < _loc3_.length())
         {
            ...
            if(_loc7_ != null)
            {
               ...
               while(_loc19_ < _loc7_.length)
               {
                  ...
                  _loc21_ = var_906.getAsset(_loc20_);
                  if(_loc21_ != null)
                  {
                     _loc8_.push(_loc21_);
                  }
      ...
      private function parseTextures(param1:XML, param2:IGraphicAssetCollection) : void
      {
         ...
         while(_loc4_ < _loc3_.length())
         {
            ...
            {
               _loc6_ = _loc5_.@id;
               if(var_177.getValue(_loc6_) == null)
               {
      ...
      {
         return var_306.getValue(param1) as PlaneMaterial;
      }
      ...
      public function dispose() : void
      {
         ...
         if(var_99 != null)
         {
            ...
            {
               _loc2_ = var_99.getWithIndex(_loc1_) as Plane;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      private function resetMaterials() : void
      {
         var _loc2_:* = null;
         var _loc1_:int = 0;
         while(_loc1_ < var_306.length)
         {
            _loc2_ = var_306.getWithIndex(_loc1_) as PlaneMaterial;
            if(_loc2_ != null)
            {
               _loc2_.dispose();
            }
      ...
      {
         return var_177.getValue(param1) as PlaneTexture;
      }
      
      protected function getPlane(param1:String) : Plane
      {
         return var_99.getValue(param1);
      }
      ...
      private function resetTextures() : void
      {
         ...
         {
            _loc2_ = var_177.getWithIndex(_loc1_) as PlaneTexture;
            if(_loc2_ != null)
            {
               _loc2_.dispose();
            }
      ...
      public function clearCache() : void
      {
         ...
         while(_loc1_ < var_306.length)
         {
            _loc3_ = var_306.getWithIndex(_loc1_) as PlaneMaterial;
            if(_loc3_ != null)
            {
               _loc3_.clearCache();
            }
