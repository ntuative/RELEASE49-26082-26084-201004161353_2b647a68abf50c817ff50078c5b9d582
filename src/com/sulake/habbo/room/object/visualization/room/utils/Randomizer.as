package com.sulake.habbo.room.object.visualization.room.utils
{
   public class Randomizer
   {
      ...
      public static const const_1590:int = 16777216;
      
      public static const const_1587:int = 1;
       
      
      private var var_2364:int = 69069;
      
      private var var_1325:int = 1;
      
      private var var_2365:int = 5;
      
      private var var_1571:int = 16777216;
      ...
      private function iterateScaled(param1:int, param2:int) : int
      {
         ...
         return int(param1 + _loc3_ / var_1571 * param2);
      }
      ...
      {
         var _loc1_:int = var_2364 * var_1325 + var_2365;
         if(_loc1_ < 0)
         {
            _loc1_ = -_loc1_;
         }
