package com.sulake.habbo.room.object.visualization.room.publicroom.rasterizer
{
   ...
   public class LayoutRasterizer
   {
      ...
      private var var_996:Point = null;
      ...
      private var var_485:Boolean = true;
      
      private var _adBgIndex:int = -1;
      
      private var var_906:IGraphicAssetCollection;
      ...
      {
         var_485 = true;
         var _loc3_:int = var_346.indexOf(param1);
         if(_loc3_ < 0)
         {
            var_346.push(param1);
            var_486.push(param2);
      ...
      public function initializeAds(param1:int, param2:IRoomObjectSpriteVisualization) : void
      {
         ...
         var _loc11_:* = null;
         var_997 = param1;
         var _loc3_:LayoutRasterizerData = var_38.getValue(var_679);
         if(_loc3_ == null)
         {
            return;
         }
                  ...
                  if(_loc9_ != null)
                  {
                     if(_loc7_.@id.toString().length > 0)
                     {
                        ...
                        if(_loc10_ == "billboard_bg")
                        {
                           ...
                           {
                              var_1199 = RoomObjectVariableEnum.const_919;
                           }
                           if(_loc11_.indexOf("right") > -1)
                           {
                              var_1199 = RoomObjectVariableEnum.const_935;
                           }
                           if(param2 != null)
                           {
                              _loc5_ = param2.getSprite(var_997 + _adBgIndex);
                              if(_loc5_ != null)
                              {
                        ...
                        if(_loc10_ == "billboard_img")
                        {
                           ...
                           if(param2 != null)
                           {
                              _loc5_ = param2.getSprite(var_997 + _adImgIndex);
                              if(_loc5_ != null)
                              {
                                 _loc5_.visible = false;
                                 _loc5_.alpha = 0;
      ...
      public function showAd(param1:IRoomObjectSpriteVisualization, param2:String = "", param3:Boolean = false) : void
      {
         ...
         if(param1 != null)
         {
            _loc4_ = param1.getSprite(var_997 + _adBgIndex);
            _loc5_ = param1.getSprite(var_997 + _adImgIndex);
         }
         ...
         {
            exchangeElementGraphics("billboard_img",var_1199);
         }
         ...
         if(param3)
         {
            ...
            _loc5_.tag = RoomObjectVariableEnum.const_370;
         }
         if(param2 != "")
         {
            _loc4_.visible = true;
      ...
      public function initializeGeometry(param1:IRoomGeometry) : void
      {
         ...
         var _loc3_:Point = param1.getScreenPoint(var_1842);
         _loc3_.x -= _loc2_.x;
         _loc3_.y -= _loc2_.y;
      ...
      public function set layout(param1:String) : void
      {
         if(param1 != var_679)
         {
            ...
            _adBgIndex = -1;
            _adImgIndex = -1;
            var_995 = var_38.getValue(var_679);
         }
      }
      ...
      {
         var _loc1_:LayoutRasterizerData = var_38.getValue(var_679);
         if(_loc1_ == null)
         {
            return 0;
         }
      ...
      public function setElementToSprite(param1:int, param2:IRoomObjectSprite, param3:String = "", param4:Boolean = false) : void
      {
         ...
         var _loc9_:IGraphicAsset = var_906.getAsset(_loc8_.@asset);
         ...
         param2.offsetX = int(_loc8_.@x) + _loc9_.offsetX + var_996.x;
         param2.offsetY = int(_loc8_.@y) + _loc9_.offsetY + var_996.y;
         ...
         if(_loc6_.@id.toString().length > 0)
         {
            ...
            if(var_346.indexOf(_loc10_) >= 0 && var_485)
            {
               param1 = var_346.indexOf(_loc10_);
               if(true)
               {
                  _loc9_ = var_906.getAsset(var_486[param1]);
                  if(_loc9_ != null && _loc9_.asset != null)
                  {
                     param2.asset = _loc9_.asset.content as BitmapData;
                  }
               ...
               if(true)
               {
                  param2.alpha = var_484[param1];
               }
               var_346.splice(param1,1);
               var_486.splice(param1,1);
               var_484.splice(param1,1);
               if(false)
               {
                  var_485 = false;
               }
