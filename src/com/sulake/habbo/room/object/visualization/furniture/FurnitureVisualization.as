package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureVisualization extends RoomObjectSpriteVisualization
   {
      ...
      protected var var_1574:String = null;
      ...
      protected var var_2276:Number = NaN;
      ...
      protected function getSpriteAssetName(param1:int, param2:Number) : String
      {
         ...
         if(_loc3_ == null || _loc3_.length == 0)
         {
            ...
            var_614[param1] = _loc3_;
            var_615[param1] = _loc4_;
         }
         if(_loc4_)
         {
      ...
      protected function updateSprites(param1:int, param2:Number) : void
      {
         ...
         var _loc4_:Boolean = false;
         if(var_1574 != null && var_1574.indexOf("http") == 0)
         {
            _loc4_ = true;
         }
            ...
            if(_loc7_ != null)
            {
               ...
               if(_loc8_ != null && _loc8_.asset != null)
               {
                  ...
                  if(_loc5_ < spriteCount - 1)
                  {
                     ...
                     _loc7_.color = getSpriteColor(_loc5_,var_2288,param1);
      ...
      {
         var _loc3_:int = 0;
         if(var_2161 != param1 || var_2162 != param2)
         {
            _loc3_ = spriteCount - 1;
            while(_loc3_ >= 0)
            {
               var_614[_loc3_] = "";
               var_615[_loc3_] = false;
               _loc3_--;
            }
            var_2161 = param1;
            var_2162 = param2;
      ...
      {
         var _loc3_:int = 0;
         if(var_2160 != param1 || var_2159 != param2)
         {
            _loc3_ = spriteCount - 1;
            while(_loc3_ >= 0)
            {
      ...
      protected function updateModel(param1:Number) : Boolean
      {
         ...
         {
            var_2288 = _loc3_.getNumber(RoomObjectVariableEnum.const_207);
            ...
            var_1574 = _loc3_.getString(RoomObjectVariableEnum.const_307);
      ...
      protected function updateObject(param1:Number, param2:Number) : Boolean
      {
         ...
         if(var_287 != _loc3_.getUpdateID() || param1 != var_209 || param2 != var_2276)
         {
