package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class AnimatedFurnitureVisualization extends FurnitureVisualization
   {
      ...
      override protected function updateAnimation(param1:Number) : Boolean
      {
         ...
         if(var_476 == 0)
         {
            var_476 = _animationData.getStartFrame(var_1096,param1);
         }
         var_476 += 1;
         ...
         while(_loc4_ < _animationData.getLayerCount(param1))
         {
            ...
            if(_loc5_ == null || _loc5_.remainingFrameRepeats >= 0 && _loc7_ <= 0)
            {
               ...
               if(_loc6_ == AnimationFrame.const_977)
               {
                  _loc5_ = _animationData.getFrame(_loc4_,var_1096,var_476,param1);
               }
               else
               {
                  _loc5_ = _animationData.getFrameFromSequence(_loc4_,var_1096,_loc6_,_loc5_.activeSequenceOffset + 1,var_476,param1);
               }
