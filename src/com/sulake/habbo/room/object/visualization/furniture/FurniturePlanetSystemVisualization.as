package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePlanetSystemVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private function readDefinition() : Boolean
      {
         ...
         var _loc3_:String = _loc2_.getString(RoomObjectVariableEnum.const_907);
      ...
      {
         if(param1 < var_555.length)
         {
            return var_555[param1].y;
         }
      ...
      private function getPlanet(param1:String) : FurniturePlanetSystemVisualizationPlanetObject
      {
         var _loc2_:* = null;
         var _loc3_:int = 0;
         while(_loc3_ < var_212.length)
         {
            _loc2_ = var_212[_loc3_];
      ...
      override protected function updateAnimation(param1:Number) : Boolean
      {
         ...
         if(var_212 != null)
         {
            ...
            {
               _loc2_ = var_212[_loc3_];
               _loc2_.update(var_555,var_1692,param1);
               _loc3_++;
            }
