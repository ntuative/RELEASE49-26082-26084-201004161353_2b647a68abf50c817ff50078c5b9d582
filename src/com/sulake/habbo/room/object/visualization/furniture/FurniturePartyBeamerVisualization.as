package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePartyBeamerVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_760:int = 15;
      
      private static const const_1080:int = 2;
      
      private static const const_350:int = 2;
      
      private static const const_761:int = 31;
      ...
      private function getNewPoint(param1:int, param2:Number) : Point
      {
         ...
         var_981[param1] = _loc3_;
         if(int(_loc9_) == 0)
         {
            var_984[param1] = getRandomAmplitudeFactor();
         }
      ...
      private function initItems(param1:Number) : void
      {
         ...
         var_981 = new Array();
         var_981.push(Math.random() * _loc2_ * 1.5);
         var_981.push(Math.random() * _loc2_ * 1.5);
         var_982 = new Array();
         var_982.push(1);
         var_982.push(-1);
         var_983 = new Array();
         var_983.push(const_1080);
         var_983.push(const_1079);
         var_984 = new Array();
         var_984.push(getRandomAmplitudeFactor());
         var_984.push(getRandomAmplitudeFactor());
      }
