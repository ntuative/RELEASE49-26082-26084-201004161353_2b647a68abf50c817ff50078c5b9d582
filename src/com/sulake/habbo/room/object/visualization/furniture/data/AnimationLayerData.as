package com.sulake.habbo.room.object.visualization.furniture.data
{
   public class AnimationLayerData
   {
      ...
      public function dispose() : void
      {
         ...
         {
            _loc2_ = var_195[_loc1_] as AnimationFrameSequenceData;
            if(_loc2_ != null)
            {
               _loc2_.dispose();
            }
      ...
      public function getFrame(param1:int) : AnimationFrame
      {
         ...
         if(!var_1435)
         {
            _loc4_ = param1 / var_421;
            param1 %= var_421;
            if(var_1523 > 0 && _loc4_ >= var_1523)
            {
               param1 = var_421 - 1;
               _loc3_ = true;
            }
            ...
            _loc6_ = 0;
            _loc6_ = 0;
            while(_loc6_ < var_195.length)
            {
               _loc2_ = var_195[_loc6_] as AnimationFrameSequenceData;
               if(_loc2_ != null)
               {
         ...
         _loc2_ = var_195[_loc7_] as AnimationFrameSequenceData;
      ...
      {
         if(param1 < 0 || param1 >= var_195.length)
         {
            return null;
         }
         var _loc4_:AnimationFrameSequenceData = var_195[param1] as AnimationFrameSequenceData;
         if(_loc4_ != null)
         {
