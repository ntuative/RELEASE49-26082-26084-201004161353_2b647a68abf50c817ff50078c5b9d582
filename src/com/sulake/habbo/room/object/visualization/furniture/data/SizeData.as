package com.sulake.habbo.room.object.visualization.furniture.data
{
   ...
   public class SizeData
   {
      ...
      public static const const_311:int = 1000;
      ...
      private var var_1245:int = 360;
      
      private var var_2009:int = 0;
      
      private var var_720:DirectionData = null;
      ...
      public function getDirectionValue(param1:int) : int
      {
         var _loc6_:int = 0;
         var _loc7_:int = 0;
         var _loc2_:int = (param1 % 360 + 360 + var_1245 / 2) % 360 / var_1245;
         ...
         {
            _loc6_ = int(var_227.getKey(_loc5_)) * var_1245;
      ...
      private function defineDirection(param1:DirectionData, param2:XMLList) : Boolean
      {
         ...
         },_loc5_++)
         {
            ...
            {
               case "ADD":
                  param1.setInk(_loc7_,LayerData.const_859);
                  break;
               case "SUBTRACT":
