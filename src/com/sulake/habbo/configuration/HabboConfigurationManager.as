package com.sulake.habbo.configuration
{
   ...
   public class HabboConfigurationManager extends Component implements IHabboConfigurationManager
   {
      ...
      private static var var_1421:String = "%";
      ...
      private function onConfigurationError(param1:Event = null) : void
      {
         ...
         Core.error("Could not load external variables. HTTP status " + _loc3_ + ". Client startup failed!",true,Core.const_1311);
      }
      
      public function keyExists(param1:String) : Boolean
      {
         var _loc2_:String = var_1063[param1] as String;
         return _loc2_ != null;
      }
      ...
      private function parseConfiguration(param1:String) : void
      {
         ...
         var_1293 = getKey("url.prefix");
         if(false)
         {
            _loc9_ = var_1293.replace("http://","");
      ...
      public function setKey(param1:String, param2:String, param3:Boolean = false) : void
      {
         ...
         if(var_1538.indexOf(param1) < 0)
         {
            var_1063[param1] = param2;
         }
      }
      ...
      private function onInitConfiguration(param1:Event = null) : void
      {
         ...
         var_928 = true;
         events.dispatchEvent(new Event(HabboConfigurationEvent.const_166));
         if(var_2092)
         {
      ...
      {
         var _loc4_:String = var_1063[param1] as String;
         if(_loc4_ == null)
         {
            _loc4_ = param2;
         }
         if(_loc4_ != null)
         {
            ...
            {
               _loc4_ = _loc4_.replace("%predefined%",var_1293);
      ...
      private function fillParams(param1:String, param2:Dictionary) : String
      {
         ...
         while(_loc3_ < 10)
         {
            _loc4_ = param1.indexOf(var_1421);
            if(_loc4_ < 0)
            {
               break;
            }
            _loc5_ = param1.indexOf(var_1421,_loc4_ + 1);
            if(_loc5_ < 0)
            {
               break;
            }
