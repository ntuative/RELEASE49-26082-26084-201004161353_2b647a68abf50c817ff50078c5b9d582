package com.sulake.habbo.catalog.purchase
{
   ...
   public class PurchaseConfirmationDialog implements IGetImageListener
   {
      ...
      private const const_1431:uint = 4.294967295E9;
      
      private const const_1432:uint = 4.293848814E9;
      
      private var var_908:int;
      
      private const const_1653:uint = 4.291613146E9;
      ...
      private const const_1654:int = 10;
      ...
      private var var_75:IPurchasableOffer;
      ...
      private function suggestionsEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER:
               _loc5_ = var_232.findChildByName("suggestion_list") as IItemListWindow;
               if(_loc5_ == null)
               {
                  return;
               }
      ...
      private function updateColorGrid() : void
      {
         ...
         while(_loc4_ < _loc1_.numGridItems)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null)
               {
                  _loc3_.visible = _loc2_.id == var_909;
               }
            }
            _loc4_++;
         }
      ...
      {
         if(this.var_75 == null || this.var_75.offerId != param1.offerId)
         {
            return;
         }
      ...
      private function updateLocalizations() : void
      {
         var _loc5_:* = null;
         var _loc6_:* = null;
         var _loc1_:IProductData = _catalog.getProductData(var_75.localizationId);
         ...
         switch(var_75.priceType)
         {
            ...
            case Offer.const_364:
               ...
               _loc5_ = _localization.getLocalization(_loc6_);
               _localization.registerParameter(_loc6_,"credits",var_75.priceInCredits.toString());
               _localization.registerParameter(_loc6_,"pixels",var_75.priceInPixels.toString());
               _loc3_ = _loc5_.value;
               _localization.registerParameter(_loc6_,"credits",_loc7_);
      ...
      private function updatePreview() : void
      {
         ...
         var _loc2_:IRoomEngine = var_75.page.viewer.roomEngine;
         _loc3_ = _loc2_.getFurnitureImage(var_909,new Vector3d(180),64,this,_loc1_.toString());
         if(_loc3_ == null)
         {
            return;
         }
      ...
      {
         return param1 % 2 == 0 ? uint(const_1432) : uint(const_1431);
      }
      ...
      private function confirmationHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "gift_button":
               ...
               break;
            case "buy_button":
               _catalog.purchaseProduct(var_436,var_75,var_1079);
               dispose();
               break;
            case "cancel_button":
      ...
      private function selectHighlighted() : void
      {
         ...
         var _loc1_:IItemListWindow = var_232.findChildByName("suggestion_list") as IItemListWindow;
         if(_loc1_ == null)
         {
            return;
         }
         var _loc2_:IWindowContainer = _loc1_.getListItemAt(var_277) as IWindowContainer;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function giveGift() : void
      {
         ...
         var _loc7_:int = !!_loc6_ ? 0 : int(var_909);
         var _loc8_:int = !!_loc6_ ? 0 : int(var_617[_boxIndex]);
         var _loc9_:int = !!_loc6_ ? 0 : int(var_616[var_198]);
         _catalog.purchaseProductAsGift(var_436,var_75,var_1079,_loc2_,_loc4_,_loc7_,_loc8_,_loc9_);
      }
      ...
      private function nameInputHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.const_52:
               ...
               break;
            case WindowKeyboardEvent.const_634:
               _loc6_ = param1 as WindowKeyboardEvent;
               switch(_loc6_.keyCode)
               {
                  case Keyboard.UP:
                     highlightSuggestion(var_277 - 1);
                     break;
                  case Keyboard.DOWN:
                     highlightSuggestion(var_277 + 1);
                     break;
      ...
      private function showConfirmationDialog() : void
      {
         ...
         if(_loc1_ != null)
         {
            _loc3_ = _catalog.getProductData(var_75.localizationId);
         ...
         if(_loc2_ != null)
         {
            _loc4_ = var_75.page.viewer.roomEngine;
            _loc7_ = 0;
            _loc8_ = "";
            _loc9_ = "";
            if(var_75 is Offer)
            {
               _loc10_ = var_75.productContainer.firstProduct;
               _loc9_ = _loc10_.productType;
               _loc7_ = _loc10_.productClassId;
               _loc8_ = _loc10_.extraParam;
            }
            else if(var_75 is ClubBuyOfferData)
            {
               _loc9_ = "null";
            }
            switch(_loc9_)
            {
               ...
               case ProductTypeEnum.const_221:
                  ...
                  break;
               case ProductTypeEnum.const_322:
      ...
      private function showGiftDialog() : void
      {
         ...
         if(_loc1_.isEnabled)
         {
            ...
            var_1416 = _loc1_.stuffTypes;
            var_617 = _loc1_.boxTypes;
            var_616 = _loc1_.ribbonTypes;
            var_909 = var_1416[0];
            _boxIndex = var_617[0];
            var_198 = var_616[0];
            initColorGrid();
      ...
      private function highlightSuggestion(param1:int) : void
      {
         ...
         var _loc2_:IItemListWindow = var_232.findChildByName("suggestion_list") as IItemListWindow;
         if(_loc2_ == null)
         {
            return;
         }
         _loc3_ = _loc2_.getListItemAt(var_277) as IWindowContainer;
         if(_loc3_ != null)
         {
            _loc3_.color = getColor(var_277);
         }
         var_277 = param1;
         if(var_277 < 0)
         {
            var_277 = _loc2_.numListItems - 1;
         }
         if(var_277 >= _loc2_.numListItems)
         {
            var_277 = 0;
         }
         _loc3_ = _loc2_.getListItemAt(var_277) as IWindowContainer;
      ...
      private function updateSuggestions(param1:Array) : void
      {
         ...
         if(var_232 == null)
         {
            var_232 = _window.findChildByName("suggestion_container") as IWindowContainer;
         }
         if(var_525 == null)
         {
            var_525 = createWindow("suggestion_list_item") as IWindowContainer;
            var_525.procedure = suggestionsEventHandler;
         }
         if(var_232 == null || var_525 == null)
         {
            return;
         }
         var _loc2_:IItemListWindow = var_232.findChildByName("suggestion_list") as IItemListWindow;
         ...
         {
            _loc5_ = var_525.clone() as IWindowContainer;
            if(_loc5_ != null)
            {
