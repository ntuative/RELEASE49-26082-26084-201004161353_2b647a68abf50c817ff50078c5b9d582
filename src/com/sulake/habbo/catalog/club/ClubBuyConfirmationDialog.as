package com.sulake.habbo.catalog.club
{
   ...
   public class ClubBuyConfirmationDialog
   {
      ...
      private var var_75:ClubBuyOfferData;
      ...
      {
         if(!param1 || !param2 || !var_47 || !var_75)
         {
            return;
         }
         ...
         {
            case "select_button":
               var_47.confirmSelection(var_75,var_436);
               break;
      ...
      {
         var _loc1_:* = null;
         if(var_75 && false && var_75.productContainer.firstProduct)
         {
            _loc1_ = var_75.productContainer.firstProduct.productData;
            if(_loc1_)
            {
               return _loc1_.name;
            }
      ...
      public function showConfirmation() : void
      {
         ...
         var _loc13_:int = var_75.periods == 0 ? 1 : int(var_75.periods);
         _loc2_.registerParameter("catalog.club.buy.confirm.price","price",String(var_75.price));
         ...
         _loc2_.registerParameter("catalog.club.buy.confirm.amount","day",String(var_75.day));
         _loc2_.registerParameter("catalog.club.buy.confirm.amount","month",String(var_75.month));
         _loc2_.registerParameter("catalog.club.buy.confirm.amount","year",String(var_75.year));
         _loc2_.registerParameter("catalog.club.buy.confirm.before","days",String(_loc10_));
         _loc2_.registerParameter("catalog.club.buy.confirm.after","days",String(var_75.daysLeftAfterPurchase));
         if(false)
         {
