package com.sulake.habbo.catalog.club
{
   ...
   public class ClubBuyController
   {
      ...
      {
         closeConfirmation();
         var_204 = new ClubBuyConfirmationDialog(this,param1,param2);
      }
      ...
      public function getClubType() : int
      {
         ...
         {
            _loc1_ = !!_catalog.getPurse().method_2 ? 0 : int(HabboClubLevelEnum.const_60);
         }
         return _loc1_;
      }
      ...
      public function onOffers(param1:HabboClubOffersMessageEvent) : void
      {
         ...
         var_590.sort(orderByPrecedence);
         for each(_loc6_ in var_590)
         {
