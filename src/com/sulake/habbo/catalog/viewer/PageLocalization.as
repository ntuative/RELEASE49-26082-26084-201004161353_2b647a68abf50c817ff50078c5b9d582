package com.sulake.habbo.catalog.viewer
{
   ...
   public class PageLocalization implements IPageLocalization
   {
      ...
      private static const const_192:Dictionary = new Dictionary();
      
      private static const const_786:Object = {"frontpage3":[7,8]};
      
      private static const const_1127:Array = ["ctlg_header_text","ctlg_description","ctlg_special_txt","ctlg_text_1","ctlg_text_2"];
      
      private static const const_787:Object = {"frontpage3":[["ctlg_txt1","ctlg_txt2"],["ctlg_txt3"]]};
      ...
      private static const const_1126:Array = ["ctlg_header_img","ctlg_teaserimg_1","ctlg_special_img","ctlg_teaserimg_2","ctlg_teaserimg_3"];
      
      {
         const_192["frontpage3"] = ["ctlg_txt3","ctlg_txt7"];
         const_192["info_pixels"] = ["ctlg_text_5","ctlg_text_7"];
         const_192["info_credits"] = ["ctlg_text_5","ctlg_text_7"];
         const_192["collectibles"] = ["ctlg_collectibles_link"];
         const_192["club1"] = ["ctlg_text_5"];
      }
      ...
      {
         if(param1 < var_618.length)
         {
            return var_618[param1];
         }
         return "";
      }
      ...
      public function getColorUintFromText(param1:int) : uint
      {
         ...
         if(param1 < var_618.length)
         {
            _loc2_ = String(var_618[param1]).replace("#","0x");
