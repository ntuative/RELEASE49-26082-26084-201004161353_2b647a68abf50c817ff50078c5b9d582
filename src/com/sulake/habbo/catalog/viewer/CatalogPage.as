package com.sulake.habbo.catalog.viewer
{
   ...
   public class CatalogPage implements ICatalogPage
   {
      ...
      protected static const const_1405:String = "ctlg_";
      ...
      private var var_1247:EventDispatcher;
      
      private var _pageId:int;
      
      private var var_797:ICatalogViewer;
      ...
      {
         var _loc2_:String = const_1405 + param1;
         ...
         var_1392 = _loc3_.content as XML;
         _window = viewer.catalog.windowManager.buildFromXML(var_1392) as IWindowContainer;
         if(_window == null)
         {
      ...
      {
         return _localization.hasLinks(var_858);
      }
      ...
      private function createWidgets() : void
      {
         ...
         _loc1_ = _window.findChildByName(CatalogWidgetEnum.const_1347) as IWindowContainer;
         if(_loc1_ != null)
         {
         ...
         {
            _loc2_.page = this;
            _loc2_.events = var_1247;
            _loc2_.init();
         }
         var_1247.dispatchEvent(new CatalogWidgetsInitializedEvent());
      }
      ...
      public function method_6(param1:Event) : Boolean
      {
         return var_1247.dispatchEvent(param1);
      }
      ...
      {
         return _localization.getLinks(var_858);
      }
