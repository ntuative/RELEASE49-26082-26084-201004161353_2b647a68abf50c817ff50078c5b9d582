package com.sulake.habbo.catalog.viewer
{
   ...
   public class Product extends ProductGridItem implements IProduct, IGetImageListener
   {
      ...
      private var var_1248:IProductData;
      ...
      {
         super();
         var_1250 = param1.productType;
         var_1249 = param1.furniClassId;
         var_1032 = param1.extraParam;
         var_1031 = param1.productCount;
         var_1251 = param1.expiration;
         var_1248 = param2;
      ...
      public function initIcon(param1:IProductContainer, param2:IGetImageListener = null) : BitmapData
      {
         ...
         switch(productType)
         {
            ...
            case ProductTypeEnum.const_84:
               _loc6_ = _loc4_.getWallItemIcon(productClassId,param2,var_1032);
               break;
