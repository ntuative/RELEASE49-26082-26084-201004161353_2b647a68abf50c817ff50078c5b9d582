package com.sulake.habbo.catalog.viewer
{
   ...
   public class CatalogViewer implements ICatalogViewer
   {
      ...
      private var var_1585:HabboCatalog;
      ...
      public function showCatalogPage(param1:int, param2:String, param3:IPageLocalization, param4:Array) : void
      {
         ...
         if(var_436 != null)
         {
            if(var_436.pageId == param1)
            {
               return;
            }
            _container.removeChild(var_436.window);
            var_436.dispose();
         }
         var _loc5_:ICatalogPage = new CatalogPage(this,param1,param2,param3,param4,var_1585);
         var_436 = _loc5_;
      ...
      {
         return var_436.method_6(param1);
      }
