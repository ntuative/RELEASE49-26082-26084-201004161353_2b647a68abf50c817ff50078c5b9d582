package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class PetsCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private var var_526:Boolean = false;
      ...
      private function getPurchaseParameters() : String
      {
         ...
         if(var_437 >= var_314.length)
         {
            return "";
         }
         var petColor:IPetColor = var_314[var_437] as IPetColor;
         var color:uint = petColor.rgb;
         var breed:IBreed = var_619[var_1572] as IBreed;
      ...
      private function onColourIndex(param1:CatalogWidgetColourIndexEvent) : void
      {
         ...
         if(var_437 < 0 || var_437 > var_314.length)
         {
            var_437 = 0;
         }
         updateImage();
      ...
      private function onApproveNameResult(param1:CatalogWidgetApproveNameResultEvent) : void
      {
         ...
         (page.viewer.catalog as HabboCatalog).showPurchaseConfirmation(var_590.getWithIndex(0),page,p);
      }
      ...
      override public function init() : void
      {
         ...
         _loc2_.addEventListener(WindowEvent.const_128,onTextWindowEvent);
         var_590 = new Map();
         ...
         var_914 = getPetTypeIndexFromProduct(_loc5_.localizationId);
         var_314 = [];
         var_619 = [];
         if(page && false && page.viewer.catalog)
         {
            ...
            {
               _loc11_ = _loc10_.avatarRenderManager.petDataManager.getPetData(var_914);
               if(_loc11_)
               {
                  var_619 = _loc11_.breeds;
                  var_314 = _loc11_.colors;
                  if(var_314 == null)
                  {
                     var_314 = [];
                  }
         ...
         {
            _loc12_ = var_619[_loc6_] as IBreed;
            _loc3_.push(_loc4_.getKey(getRaceLocalizationKey(var_914,_loc12_.id),getRaceLocalizationKey(var_914,_loc12_.id)));
            _loc6_++;
         }
         var_590.add(var_914,_loc5_);
         ...
         events.addEventListener(WidgetEvent.const_858,onApproveNameResult);
         _loc5_ = var_590.getWithIndex(0);
         if(_loc5_ != null)
         {
            events.dispatchEvent(new SelectProductEvent(_loc5_));
         }
         var _loc8_:* = [];
         for each(_loc9_ in var_314)
         {
      ...
      {
         var _loc7_:* = null;
         var _loc1_:Offer = var_590.getWithIndex(0);
         if(_loc1_ == null)
         {
            return;
         }
         ...
         if(var_437 >= 0 && var_437 < var_314.length)
         {
            _loc7_ = var_314[var_437] as IPetColor;
            if(_loc7_ != null)
            {
               _loc2_ = uint(_loc7_.rgb);
            }
         }
         var _loc3_:IBreed = var_619[var_1572] as IBreed;
         var _loc4_:IAvatarImage = (page.viewer.catalog as HabboCatalog).avatarRenderManager.createPetImage(var_914,_loc3_.id,_loc2_,AvatarScaleType.const_55);
         if(_loc4_ == null)
         {
            return;
         }
         _loc4_.initActionAppends();
         _loc4_.appendAction(AvatarAction.const_319,AvatarAction.const_686);
         _loc4_.endActionAppends();
         _loc4_.setDirection(AvatarSetType.const_39,2);
         setPreviewImage(_loc4_.getCroppedImage(AvatarSetType.const_39),true);
         _loc4_.dispose();
