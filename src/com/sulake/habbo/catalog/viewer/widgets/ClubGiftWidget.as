package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ClubGiftWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private function updateList() : void
      {
         ...
         for each(_loc6_ in _loc2_)
         {
            ...
            if(_loc5_)
            {
               ...
               var_590.add(_loc1_.offerId,_loc1_);
            }
         }
      }
      ...
      private function showPreview(param1:Offer, param2:Rectangle) : void
      {
         ...
         if(!var_190)
         {
            var_190 = createWindow("club_gift_preview") as IWindowContainer;
         }
         if(!var_190)
         {
            return;
         }
         var _loc5_:IBitmapWrapperWindow = var_190.findChildByName("image") as IBitmapWrapperWindow;
         if(!_loc5_)
         {
            return;
         }
         ...
         var_190.setGlobalPosition(_loc6_.subtract(new Point(0,0)));
         var_190.visible = true;
         var_190.activate();
      }
      ...
      {
         if(!param1 || !param2 || !var_590 || !var_47)
         {
            return;
         }
         ...
         var _loc3_:Offer = var_590.getValue(param2.id) as Offer;
         if(!_loc3_)
         {
            return;
         }
