package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class BotCatalogWidget extends CatalogWidget implements ICatalogWidget, IItemGrid
   {
      ...
      private var var_833:Offer;
      
      public function BotCatalogWidget(param1:IWindowContainer)
      {
         super(param1);
         var_950 = _window.findChildByName("botGrid") as IItemGridWindow;
      }
      ...
      {
         var _loc6_:* = null;
         var _loc2_:IWindowContainer = page.viewer.catalog.windowManager.buildFromXML(var_1155) as IWindowContainer;
         var_950.addGridItem(_loc2_);
         param1.productContainer.view = _loc2_;
         var _loc3_:String = var_1459.getValue(param1.productContainer.firstProduct.extraParam.toLowerCase());
         ...
         if(_loc5_)
         {
            ...
            _loc6_ = _loc5_.getImage(AvatarSetType.const_39,true);
      ...
      {
         var _loc1_:String = var_1459.getValue(var_833.productContainer.firstProduct.extraParam.toLowerCase());
         ...
         if(_loc2_)
         {
            ...
            setPreviewImage(_loc2_.getImage(AvatarSetType.const_39,true));
            _loc2_.dispose();
         }
      }
      ...
      {
         (page.viewer.catalog as HabboCatalog).showPurchaseConfirmation(var_833,page);
      }
      ...
      private function setProductData() : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc1_.registerParameter("catalog.purchase.price.credits+pixels","credits",String(var_833.priceInCredits));
            _loc1_.registerParameter("catalog.purchase.price.credits+pixels","pixels",String(var_833.priceInPixels));
            _loc2_.text = "${catalog.purchase.price.credits+pixels}";
         }
         var _loc3_:IProductData = page.viewer.catalog.getProductData(var_833.localizationId);
