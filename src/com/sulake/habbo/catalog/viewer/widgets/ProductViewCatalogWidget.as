package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_598:IItemGridWindow;
      
      private var var_82:IBitmapWrapperWindow;
      
      private var var_1343:ITextWindow;
      
      private var var_1255:IScrollbarWindow;
      
      protected var var_1155:XML;
      
      private var var_1256:BitmapData;
      
      private var var_1342:ITextWindow;
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         if(var_598 != null)
         {
            var_598.visible = false;
            var_598.destroyGridItems();
         }
         if(var_1255 != null)
         {
         ...
         if(_loc3_ != null)
         {
            var_1343.text = "${" + _loc3_.name + "}";
            var_1342.text = "${" + _loc3_.description + "}";
         }
         else
         {
            var_1343.text = "${" + _loc2_.localizationId + "}";
            var_1342.text = "${" + _loc2_.localizationId + "}";
         }
         ...
         else
         {
            ...
            switch(_loc2_.pricingModel)
            {
               case Offer.const_473:
                  _loc4_ = var_1256.clone();
                  if(var_598 != null)
                  {
                     var_598.visible = true;
                     (_loc2_.productContainer as BundleProductContainer).populateItemGrid(var_598,var_1255,var_1155);
                  }
                  break;
                     ...
                     case ProductTypeEnum.const_221:
                        ...
                        if(_loc12_.avatarRenderManager != null)
                        {
                           ...
                           if(_loc13_ != null)
                           {
                              ...
                              _loc13_.appendAction(AvatarAction.const_319,AvatarAction.const_602);
                              _loc13_.appendAction(AvatarAction.const_525,_loc6_.productClassId);
                              _loc13_.endActionAppends();
                              _loc13_.updateAnimationByFrames(1);
                              _loc13_.updateAnimationByFrames(1);
                              _loc11_ = _loc13_.getImage(AvatarSetType.const_39,true);
      ...
      {
         var_1343 = _window.findChildByName("ctlg_product_name") as ITextWindow;
         var_1342 = _window.findChildByName("ctlg_description") as ITextWindow;
         var_82 = _window.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         var_1501 = new Point(var_82.x,var_82.y);
         var_598 = _window.findChildByName("bundleGrid") as IItemGridWindow;
         var_1255 = _window.findChildByName("bundleGridScrollbar") as IScrollbarWindow;
         if(var_598 == null)
         {
            Logger.log("[ProductViewCatalogWidget] Bundle Grid not initialized!");
         }
         var _loc1_:XmlAsset = page.viewer.catalog.assets.getAssetByName("gridItem") as XmlAsset;
         var_1155 = _loc1_.content as XML;
         var _loc2_:BitmapDataAsset = page.viewer.catalog.assets.getAssetByName("ctlg_dyndeal_background") as BitmapDataAsset;
         var_1256 = _loc2_.content as BitmapData;
