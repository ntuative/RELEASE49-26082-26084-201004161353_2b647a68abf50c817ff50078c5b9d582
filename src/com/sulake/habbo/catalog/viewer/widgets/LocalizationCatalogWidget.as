      ...
      private function onClickLink(param1:WindowMouseEvent) : void
      {
         ...
         switch(page.layoutCode)
         {
               ...
               switch(_loc4_)
               {
                  ...
                  case "ctlg_txt7":
                     if(IWindow(param1.target).caption != "")
                     {
                        ...
                        {
                           if(false && "RoomReadyMessageParser" == _loc3_.getKey("client.credits.embed.enabled"))
                           {
            ...
            case "info_pixels":
               ...
               {
                  case "ctlg_text_5":
                     page.viewer.catalog.openInventoryCategory(InventoryCategory.const_327);
                     break;
                  case "ctlg_text_7":
            ...
            case "club1":
               ...
               {
                  case "ctlg_text_5":
                     page.viewer.catalog.openCatalogPage(CatalogPageName.const_226,true);
               }
               break;
            default:
      ...
      private function initLinks() : void
      {
         ...
         if(false)
         {
            for each(_loc1_ in page.links)
            {
               ...
               if(_loc2_ != null)
               {
                  _loc2_.setParamFlag(WindowParam.const_49);
