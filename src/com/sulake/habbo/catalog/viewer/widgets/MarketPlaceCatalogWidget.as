package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class MarketPlaceCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener, IMarketPlaceVisualization
   {
      ...
      private var var_932:MarketPlaceOfferData;
      
      private const const_1436:int = 1;
      
      private const const_1666:int = 40;
      
      private var var_539:IWindowContainer;
      
      private const const_1435:int = 2;
      ...
      private const const_1665:int = 10;
      ...
      private function updateList() : void
      {
         ...
         if(!var_539)
         {
            ...
            var_539 = _loc4_.buildFromXML(_loc3_) as IWindowContainer;
         }
         if(!var_539)
         {
            return;
         ...
         updateStatusDisplay(const_1435,_loc2_.length);
         if(!var_448)
         {
            var_448 = new Timer(25);
            var_448.addEventListener(TimerEvent.TIMER,onPopulationTimer);
         }
         var_933 = 0;
         populateList();
         var_448.start();
      ...
      public function imageReady(param1:int, param2:BitmapData) : void
      {
         ...
         var _loc6_:* = null;
         var _loc7_:* = null;
         if(!marketPlace || !param2 || !_itemList || !var_590)
         {
            return;
         }
         var _loc3_:* = [];
      ...
      private function addListItem(param1:MarketPlaceOfferData) : void
      {
         ...
         var _loc10_:* = null;
         var _loc11_:* = null;
         if(!param1 || !_itemList || !var_539 || true)
         {
            return;
         }
         var _loc2_:IWindowContainer = var_539.clone() as IWindowContainer;
      ...
      {
         var _loc5_:* = null;
         updateStatusDisplay(const_1436);
         var _loc1_:int = -1;
         var _loc2_:int = -1;
         var _loc3_:String = "";
         var _loc4_:int = 1;
         ...
         if(_loc6_ && _loc6_.selection >= 0 && _loc6_.selection < var_449.length)
         {
            _loc4_ = 0;
         }
      ...
      override public function dispose() : void
      {
         ...
         if(var_448)
         {
            var_448.removeEventListener(TimerEvent.TIMER,onPopulationTimer);
            var_448 = null;
         }
      }
      ...
      private function populateList() : Boolean
      {
         ...
         while(_loc1_ < 5)
         {
            if(var_933 >= var_590.length)
            {
               return true;
            }
            addListItem(var_590.getWithIndex(var_933));
            ++var_933;
            _loc1_++;
         }
         return false;
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "back_button":
                  ...
                  break;
               case "buy_button":
                  marketPlace.buyOffer(var_932.offerId);
            }
            return;
         }
      ...
      private function onWidgetEvent(param1:WindowEvent, param2:IWindow = null) : void
      {
         ...
         else if(param1.type == WindowEvent.const_128)
         {
      ...
      private function selectSearchCategory(param1:String) : void
      {
         ...
         if(_loc7_ != null)
         {
            _loc7_.populate(getSortKeys(var_449));
            _loc7_.selection = 0;
         }
      }
