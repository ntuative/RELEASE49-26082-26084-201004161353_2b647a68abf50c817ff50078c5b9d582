package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RecyclerPrizesCatalogWidget extends CatalogWidget implements ICatalogWidget, IItemGrid
   {
      ...
      private var var_1155:XML;
      
      private var _itemList:IItemListWindow;
      
      private var var_797:PrizeViewer;
      ...
      protected function populateItemGrid(param1:TimerEvent = null) : void
      {
         ...
         {
            createLevelItem(var_654[_loc2_]);
            _loc2_++;
         }
      }
      ...
      override public function init() : void
      {
         var _loc1_:* = null;
         super.init();
         var_797 = new PrizeViewer();
         var_654 = recycler.getPrizeTable();
         if(var_654 == null)
         {
            return;
         }
         ...
         var_1154 = _loc1_.content as XML;
         populateItemGrid();
         if(false && var_654[0].prizes.length > 0)
         {
            select(var_654[0].prizes[0] as IGridItem);
         }
      }
      ...
      {
         var _loc6_:* = null;
         var _loc2_:IWindowContainer = page.viewer.catalog.windowManager.buildFromXML(var_1154) as IWindowContainer;
      ...
      {
         var _loc3_:IWindowContainer = page.viewer.catalog.windowManager.buildFromXML(var_1155) as IWindowContainer;
      ...
      public function select(param1:IGridItem) : void
      {
         ...
         var_797.viewProduct(page.viewer.roomEngine,_loc3_,_loc2_.productItemType,_loc2_.productItemTypeId,_loc2_.title,_loc4_);
      }
