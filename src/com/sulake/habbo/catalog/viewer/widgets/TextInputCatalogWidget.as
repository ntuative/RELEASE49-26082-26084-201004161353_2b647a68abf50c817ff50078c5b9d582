package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class TextInputCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      {
         super.init();
         var_1049 = _window.findChildByName("input_text") as ITextFieldWindow;
         if(var_1049 != null)
         {
            var_1049.addEventListener(WindowKeyboardEvent.const_634,onKey);
         }
      }
      ...
      private function onKey(param1:WindowKeyboardEvent) : void
      {
         ...
         events.dispatchEvent(new TextInputEvent(var_1049.text));
      }
   }
}
