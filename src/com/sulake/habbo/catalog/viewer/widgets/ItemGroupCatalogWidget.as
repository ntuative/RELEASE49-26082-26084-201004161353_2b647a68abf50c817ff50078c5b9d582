package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ItemGroupCatalogWidget extends ItemGridCatalogWidget implements ICatalogWidget, IItemGrid
   {
      ...
      private function onColourIndex(param1:CatalogWidgetColourIndexEvent) : void
      {
         ...
         var _loc3_:Array = var_599[var_1037] as Array;
      ...
      {
         var _loc2_:Offer = var_599[var_1037][var_2025];
      ...
      private function createOfferGroups() : void
      {
         ...
         {
            if(_loc1_.pricingModel == Offer.const_470 || _loc1_.pricingModel == Offer.const_399)
            {
               _loc3_ = _loc1_.productContainer.firstProduct;
               if(_loc3_ != null)
               {
                  _loc4_ = _loc3_.productClassId;
                  if(_loc3_.productType == ProductTypeEnum.const_84 || _loc3_.productType == ProductTypeEnum.const_82)
                  {
                     if(_loc3_.furnitureData != null)
                     {
                        ...
                        if(var_1036.indexOf(_loc5_) == -1)
                        {
                           ...
                           var_599.push(new Array());
                        }
                        _loc6_ = var_1036.indexOf(_loc5_);
                        (var_599[_loc6_] as Array).push(_loc1_);
                     }
                  }
               }
            }
      ...
      override protected function populateItemGrid(param1:TimerEvent = null) : void
      {
         ...
         for each(_loc2_ in var_599)
         {
            if(var_2025 < _loc2_.length)
            {
               _loc3_ = _loc2_[var_2025] as Offer;
      ...
      override public function select(param1:IGridItem) : void
      {
         ...
         super.select(param1);
         var_1037 = var_950.getGridItemIndex(param1.view);
