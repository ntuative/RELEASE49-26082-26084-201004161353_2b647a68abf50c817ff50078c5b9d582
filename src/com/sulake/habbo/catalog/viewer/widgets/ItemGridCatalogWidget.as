   ...
   public class ItemGridCatalogWidget extends CatalogWidget implements ICatalogWidget, IItemGrid
   {
      ...
      public function ItemGridCatalogWidget(param1:IWindowContainer)
      {
         ...
         if(_scrollBar != null)
         {
            ...
            _scrollBar.addEventListener(WindowEvent.const_232,deActivateScrollbar);
         }
      }
      ...
      protected function populateItemGrid(param1:TimerEvent = null) : void
      {
         ...
         while(_loc3_ < 3)
         {
            if(var_879 >= 0 && var_879 < page.offers.length)
            {
               _loc4_ = page.offers[var_879];
      ...
      protected function createGridItem(param1:Offer) : void
      {
         ...
         if(param1.pricingModel == Offer.const_473)
         {
            ++var_1521;
            (param1.productContainer as BundleProductContainer).setBundleCounter(var_1521);
         }
      }
