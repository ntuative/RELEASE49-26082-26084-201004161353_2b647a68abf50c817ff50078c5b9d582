package com.sulake.habbo.catalog.marketplace
{
   ...
   public class MarketplaceConfirmationDialog implements IGetImageListener
   {
      ...
      private var var_684:MarketPlaceLogic;
      
      private var _window:IFrameWindow;
      
      private var _roomEngine:IRoomEngine;
      
      private var var_75:MarketPlaceOfferData;
      ...
      {
         if(var_75 && var_75.imageCallback == param1)
         {
            var_75.image = param2;
            setImage();
         }
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            case "buy_button":
               _catalog.buyMarketPlaceOffer(var_75.offerId);
               hide();
               break;
      ...
      public function showConfirmation(param1:int, param2:MarketPlaceOfferData) : void
      {
         ...
         if(_loc3_)
         {
            if(param1 == var_684.const_1545)
            {
               _loc3_.text = "${catalog.marketplace.confirm_header}";
            }
            if(param1 == var_684.const_1548)
            {
         ...
         if(_loc3_)
         {
            ...
            _loc4_ = _loc4_.replace("%price%",var_75.price);
            _loc3_.text = _loc4_;
         }
         ...
         if(_loc3_)
         {
            ...
            {
               _loc4_ = _loc5_.raw;
               _loc4_ = _loc4_.replace("%days%",var_684.averagePricePeriod.toString());
               _loc6_ = false ? " - " : var_75.averagePrice.toString();
         ...
         if(_loc3_)
         {
            ...
            {
               _loc4_ = _loc5_.raw;
               _loc4_ = _loc4_.replace("%count%",var_75.offerCount);
               _loc3_.text = _loc4_;
            }
            else
            {
      ...
      private function setImage() : void
      {
         ...
         if(true)
         {
            if(false)
            {
               _loc1_ = _roomEngine.getFurnitureIcon(var_75.furniId,this);
            }
            else if(false)
            {
               _loc1_ = _roomEngine.getWallItemIcon(var_75.furniId,this);
            }
            if(_loc1_ && _loc1_.data)
            {
               var_75.image = _loc1_.data as BitmapData;
               var_75.imageCallback = _loc1_.id;
            }
         }
         if(false)
         {
            ...
            if(_loc2_)
            {
               ...
               _loc2_.bitmap.draw(var_75.image,new Matrix(1,0,0,1,(_loc2_.width - var_75.image.width) / 2,(_loc2_.height - var_75.image.height) / 2));
            }
         }
      }
