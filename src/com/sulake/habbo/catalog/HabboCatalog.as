package com.sulake.habbo.catalog
{
   ...
   public class HabboCatalog extends Component implements IHabboCatalog
   {
      ...
      private var var_116:Purse;
      
      private var var_445:ClubBuyController;
      ...
      private var var_2222:Boolean = true;
      
      private var _roomEngine:IRoomEngine;
      
      private var var_444:ICatalogNavigator;
      ...
      private var var_2224:GiftWrappingConfiguration;
      ...
      private var var_1097:ClubGiftController;
      ...
      {
         return var_343.getProductData(param1);
      }
      ...
      private function onCreditBalance(param1:IMessageEvent) : void
      {
         ...
         var_116.credits = _loc3_.balance;
         updatePurse();
         if(!var_2223 && var_535 != null)
         {
            var_535.playSound(HabboSoundTypesEnum.const_868);
         }
         var_2223 = false;
      }
      ...
      public function getFurnitureData(param1:int, param2:String) : IFurnitureData
      {
         ...
         {
            _loc3_ = var_343.getFloorItemData(param1);
         }
         if(param2 == ProductTypeEnum.const_84)
         {
            _loc3_ = var_343.getWallItemData(param1);
         }
         return _loc3_;
      }
      ...
      private function onRecyclerStatus(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_ == null || var_85 == null)
         {
            return;
         }
         var_85.setSystemStatus(_loc2_.recyclerStatus,_loc2_.recyclerTimeoutSeconds);
      }
      ...
      private function createClubBuyController() : void
      {
         if(var_445 == null)
         {
            var_445 = new ClubBuyController(this);
         }
      }
      ...
      private function onRoomSessionEvent(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            case RoomSessionEvent.const_100:
               var_1355 = param1.session.isPrivateRoom;
               if(var_85 != null)
               {
                  var_85.setRoomSessionActive(true);
               }
               break;
            case RoomSessionEvent.const_103:
               ...
               if(var_85 != null)
               {
                  var_85.setRoomSessionActive(false);
               }
         }
      }
      ...
      private function onRecyclerFinished(param1:IMessageEvent) : void
      {
         ...
         var_85.setFinished(_loc2_.recyclerFinishedStatus,_loc2_.prizeId);
      }
      ...
      private function noCreditsConfirmDialogEventProcessor(param1:IConfirmDialog, param2:Event) : void
      {
         ...
         {
            if(false && "RoomReadyMessageParser" == var_147.getKey("client.credits.embed.enabled"))
            {
      ...
      private function onGiftWrappingConfiguration(param1:GiftWrappingConfigurationEvent) : void
      {
         ...
         var_2224 = new GiftWrappingConfiguration(param1);
      }
      ...
      private function toggleCatalog(param1:Boolean = false) : void
      {
         ...
         {
            var_199.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_50,HabboToolbarIconEnum.CATALOGUE,_mainContainer));
         }
         if(false)
         {
            _events.dispatchEvent(new Event(HabboCatalogTrackingEvent.HABBO_CATALOG_TRACKING_EVENT_OPEN));
            if(var_85 != null && getCurrentLayoutCode() == "recycler")
            {
               var_85.activate();
            }
         }
      ...
      private function onClubGiftInfo(param1:ClubGiftInfoEvent) : void
      {
         ...
         var_1097.setInfo(_loc2_.daysUntilNextGift,_loc2_.giftsAvailable,_loc2_.offers,_loc2_.giftData);
      }
      ...
      {
         var_85 = new RecyclerLogic(this,_windowManager);
         getRecyclerPrizes();
      }
      ...
      private function createCatalogNavigator() : void
      {
         ...
         var_444 = new CatalogNavigator(this,_loc1_) as ICatalogNavigator;
      ...
      private function onSubscriptionInfo(param1:IMessageEvent) : void
      {
         ...
         var_116.clubDays = Math.max(0,_loc2_.daysToPeriodEnd);
         var_116.clubPeriods = Math.max(0,_loc2_.periodsSubscribedAhead);
         var_116.method_2 = _loc2_.method_2;
         updatePurse();
      ...
      private function createClubGiftController() : void
      {
         if(var_1097 == null)
         {
            var_1097 = new ClubGiftController(this);
         }
      }
      ...
      public function showPurchaseConfirmation(param1:IPurchasableOffer, param2:ICatalogPage, param3:String = "") : void
      {
         ...
         else if(param1 is Offer)
         {
            if(var_204 == null)
            {
               var_204 = new PurchaseConfirmationDialog(_localization);
            }
            _loc7_ = [];
            if(_friendList != null)
            {
            ...
            var_204.showOffer(this,param1,param2,param3,_loc7_);
         ...
         {
            var_445.showConfirmation(param1 as ClubBuyOfferData,param2);
         }
      }
      ...
      {
         var_199.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_110,HabboToolbarIconEnum.CATALOGUE));
      }
      ...
      private function onCatalogIndex(param1:IMessageEvent) : void
      {
         ...
         var_444.buildCatalogIndex(_loc2_);
         if(var_1098 != "")
         {
            var_444.openPage(var_1098);
            var_1098 = "";
         }
         else
         {
            var_444.openFrontPage();
         }
      }
      ...
      {
         if(param1 == null || var_320 == null)
         {
            return;
         }
         var _loc2_:ApproveNameMessageParser = param1.getParser();
         var_320.method_6(new CatalogWidgetApproveNameResultEvent(_loc2_.result));
      }
      ...
      private function onRecyclerPrizes(param1:IMessageEvent) : void
      {
         ...
         var_85.storePrizeTable(_loc2_.prizeLevels);
      }
      ...
      private function updatePurse() : void
      {
         ...
         _localization.registerParameter("catalog.purse.creditbalance","balance",String(var_116.credits));
         _localization.registerParameter("catalog.purse.pixelbalance","balance",String(var_116.pixels));
         var _loc1_:int = 0;
         if(true)
         {
         ...
         else
         {
            ...
            _localization.registerParameter(_loc2_,"days",String(var_116.clubDays));
            _localization.registerParameter(_loc2_,"months",String(var_116.clubPeriods));
         }
      ...
      private function getCurrentLayoutCode() : String
      {
         ...
         return var_320.getCurrentLayoutCode();
      }
      ...
      private function onPixelsBalance(param1:IMessageEvent) : void
      {
         ...
         var_116.pixels = _loc2_.amount;
         updatePurse();
         if(!var_2222 && var_535 != null)
         {
            var_535.playSound(HabboSoundTypesEnum.const_931);
         }
         var_2222 = false;
      }
      ...
      private function onCatalogPage(param1:IMessageEvent) : void
      {
         ...
         var_320.showCatalogPage(_loc4_,_loc5_,_loc8_,_loc3_.offers);
      }
      ...
      private function onRentableBotDefinitions(param1:IMessageEvent) : void
      {
         ...
         var_320.method_6(new RentableBotDefinitionWidgetEvent(_loc2_.rentableBots));
      }
      ...
      private function createCatalogViewer() : void
      {
         ...
         var_320 = new CatalogViewer(this,_loc1_,_roomEngine);
         var_320.habboCatalog = this;
      }
