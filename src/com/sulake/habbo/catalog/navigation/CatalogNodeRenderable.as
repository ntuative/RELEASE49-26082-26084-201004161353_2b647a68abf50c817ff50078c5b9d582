package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNodeRenderable extends CatalogNode
   {
      ...
      private static const const_1097:Number = 4285716709;
      
      private static var _listSubItemWindowLayout:XML;
      
      private static var var_1504:XML;
      
      private static var var_1502:XML;
      ...
      private var var_1503:Number = 4.294967295E9;
      ...
      override public function activate() : void
      {
         ...
         if(_loc1_ != null)
         {
            if(var_1503 == 4294967295)
            {
               var_1503 = _loc1_.color;
            }
            _loc1_.color = const_1097;
         }
      }
      ...
      override public function open() : void
      {
         ...
         if(isBranch)
         {
            ...
            if(_loc1_ != null)
            {
               _loc1_.style = HabboIconType.const_1360;
            }
         }
      }
      ...
      private function createWindow() : void
      {
         if(depth == 1)
         {
            _window = navigator.catalog.windowManager.buildFromXML(var_1504) as IWindowContainer;
         }
         else
         {
      ...
      {
         var_49 = navigator.catalog.windowManager.buildFromXML(var_1502) as IItemListWindow;
         if(var_49 == null)
         {
      ...
      override public function close() : void
      {
         ...
         if(isBranch)
         {
            ...
            if(_loc1_ != null)
            {
               _loc1_.style = HabboIconType.const_1230;
            }
         }
      }
