package com.sulake.habbo.catalog.recycler
{
   ...
   public class RecyclerLogic implements IRecycler
   {
      ...
      private static const const_793:int = 0;
      
      public static const const_168:int = 5;
      
      private static const const_354:int = 1;
      
      private static const const_794:int = 2;
      ...
      public function setSystemStatus(param1:int, param2:int) : void
      {
         ...
         switch(var_1587)
         {
            case RecyclerStatusMessageEvent.const_1280:
               var_281 = const_354;
               if(_view == null)
               {
                  return;
               ...
               break;
            case RecyclerStatusMessageEvent.const_969:
               if(_view == null)
               {
                  return;
               }
               ...
               break;
            case RecyclerStatusMessageEvent.const_1285:
               if(_view == null)
               {
                  return;
               }
      ...
      {
         return var_1587 != RecyclerStatusMessageEvent.const_969;
      }
      
      private function get statusActive() : Boolean
      {
         return var_281 != const_793;
      }
      ...
      {
         return active && var_281 == const_354;
      }
      ...
      public function setFinished(param1:int, param2:int) : void
      {
         ...
         switch(status)
         {
            case RecyclerFinishedMessageEvent.const_1001:
               if(_view != null)
               {
                  _view.displayFinishedView();
               }
               break;
            case RecyclerFinishedMessageEvent.const_1282:
