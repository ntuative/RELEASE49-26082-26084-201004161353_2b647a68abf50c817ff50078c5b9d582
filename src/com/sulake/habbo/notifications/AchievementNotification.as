package com.sulake.habbo.notifications
{
   ...
   public class AchievementNotification
   {
      ...
      public function AchievementNotification(param1:String, param2:int, param3:IAssetLibrary, param4:IHabboWindowManager, param5:IHabboLocalizationManager, param6:IHabboConfigurationManager, param7:ISessionDataManager)
      {
         ...
         var_1636 = param2;
         var_343 = param7;
         param7.events.addEventListener(BadgeImageReadyEvent.const_129,onBadgeImageReady);
         ...
         var_2012 = param5.getKey("notifications.text.achievement_facebook");
      ...
      public function dispose() : void
      {
         if(var_343 != null)
         {
            var_343.events.removeEventListener(BadgeImageReadyEvent.const_129,onBadgeImageReady);
            var_343 = null;
         }
         if(_window != null)
         {
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "post_to_facebook":
               if(false)
               {
                  ExternalInterface.call("FlashExternalInterface.postAchievement",var_722,var_2012);
               }
               dispose();
               break;
      ...
      {
         _localizations.registerParameter(param1,"badge_name",_localizations.getKey("badge_name_" + var_722,var_722));
         _localizations.registerParameter(param1,"badge_desc",_localizations.getKey("badge_desc_" + var_722,var_722));
         _localizations.registerParameter(param1,"level",var_1636.toString());
         _localizations.registerParameter(param1,"name",var_343.userName);
         _localizations.registerParameter(param1,"realname",var_343.realName);
      }
   }
}
