package com.sulake.habbo.notifications
{
   ...
   public class HabboNotifications extends Component implements IHabboNotifications, IUpdateReceiver, IGetImageListener
   {
      ...
      private static const const_1054:String = "badges";
      
      private static const const_1055:String = "pet_inventory";
      
      private static const const_1060:String = "pixelbalance";
      
      private static const const_1058:String = "credits";
      
      private static const const_1053:String = "inventory";
      
      private static const const_1057:String = "friendlist";
      
      private static const const_1056:String = "selectfurni";
      
      private static const const_1059:String = "selectbadge";
       
      
      private var _assetLibrary:IAssetLibrary;
      
      private var var_564:ParkBusDialogManager;
      
      private var var_565:IHabboToolbar;
      
      private var _windowManager:IHabboWindowManager;
      
      private var _roomEngine:IRoomEngine;
      
      private var var_386:HabboNotificationViewManager;
      
      private var var_661:ClubEndingNotification;
      ...
      private var var_185:HabboAlertDialogManager;
      
      private var var_662:ClubGiftNotification;
      ...
      public function HabboNotifications(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         if(_loc5_ != null)
         {
            XMLVariableParser.parseVariableList(XML(_loc5_.content).children(),var_804);
         }
         var _loc6_:Map = var_804["styles"];
         if(_loc6_ != null)
         {
            _loc7_ = 0;
      ...
      private function onClubGiftNotification(param1:ClubGiftNotificationEvent) : void
      {
         ...
         var_662 = new ClubGiftNotification(_loc2_.numGifts,_assets,_windowManager,_catalog);
      }
      ...
      private function onUserBannedMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_ == null || var_185 == null)
         {
            return;
         }
         var_185.handleUserBannedMessage(_loc2_.message);
      }
      ...
      private function onRecyclerFinished(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_ == null || _loc2_.recyclerFinishedStatus != RecyclerFinishedMessageEvent.const_1001)
         {
            return;
         }
         ...
         if(_loc3_)
         {
            addItem(_loc3_.value,NotificationType.const_1366);
         }
      ...
      private function onLoginFailedHotelClosed(param1:IMessageEvent) : void
      {
         ...
         var_185.handleLoginFailedHotelClosedMessage(_loc2_.openHour,_loc2_.openMinute);
      }
      ...
      private function onModMessageEvent(param1:IMessageEvent) : void
      {
         ...
         var_185.handleModMessage(_loc2_.message,_loc2_.url);
      }
      ...
      override public function dispose() : void
      {
         ...
         if(var_565)
         {
            var_565.release(new IIDHabboToolbar());
            var_565 = null;
         }
         if(_windowManager)
         {
      ...
      private function getProductImage(param1:String, param2:int, param3:String) : BitmapData
      {
         ...
         switch(param1)
         {
            ...
            case CatalogPageMessageProductData.const_84:
               ...
               break;
            case CatalogPageMessageProductData.const_221:
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         if(!var_1738)
         {
            ...
            this.addItem(_loc2_,NotificationType.const_1015);
            var_1738 = true;
      ...
      public function onExecuteLink(param1:String) : void
      {
         switch(param1)
         {
            ...
            case const_1054:
               if(var_10 != null)
               {
                  var_10.toggleInventoryPage(InventoryCategory.const_270);
               }
               break;
            case const_1059:
               break;
            ...
            case const_1055:
               if(var_10)
               {
                  var_10.toggleInventoryPage(InventoryCategory.const_137);
               }
               break;
            case const_1056:
               break;
      ...
      {
         if(param1 != null && this.var_386 != null)
         {
            var_386.replaceIcon(param1);
         }
      }
      ...
      private function onClubGiftSelected(param1:ClubGiftSelectedEvent) : void
      {
         ...
         addItem(_loc5_,NotificationType.const_1015,_loc6_);
      }
      ...
      private function onPetReceived(param1:PetReceivedMessageEvent) : void
      {
         ...
         var _loc4_:IAvatarImage = var_563.createPetImageFromFigure(_loc2_.pet.figure,AvatarScaleType.const_55);
         if(_loc4_ == null)
         {
            return;
         }
         _loc4_.setDirection(AvatarSetType.const_39,3);
         var _loc5_:BitmapData = _loc4_.getCroppedImage(AvatarSetType.const_48);
         _loc4_.dispose();
         if(_loc3_)
         {
            addItem(_loc3_.value,NotificationType.const_1003,_loc5_);
         }
      }
      
      public function onAlert(param1:IAlertDialog, param2:WindowEvent) : void
      {
         if(param2.type == WindowEvent.const_153 || param2.type == WindowEvent.const_584)
         {
            param1.dispose();
         }
      }
      ...
      {
         if(var_386.isSpaceAvailable() && false)
         {
            var_386.showItem(getNextItemFromQueue());
         }
      }
      ...
      private function onParkBusMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(var_564 == null)
         {
            var_564 = new ParkBusDialogManager(_windowManager,assets,_localization);
         }
         if(_loc2_ != null || var_564 != null)
         {
            var_564.handleParkBusCannotEnter(_loc2_.reason);
         }
      }
      
      private function getNextItemFromQueue() : HabboNotificationItem
      {
         var _loc1_:Array = var_973.splice(0,1);
      ...
      private function onPetLevelNotification(param1:PetLevelNotificationEvent) : void
      {
         ...
         var _loc4_:IAvatarImage = var_563.createPetImageFromFigure(_loc2_.figure,AvatarScaleType.const_55);
         if(_loc4_ == null)
         {
            return;
         }
      ...
      function onAchievementNotication(param1:IMessageEvent) : void
      {
         ...
         new AchievementNotification(_loc2_.badgeID,_loc2_.level,_assets,_windowManager,_localization,_config,var_343);
      }
      ...
      private function onPurchaseOK(param1:IMessageEvent) : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(_loc8_)
            {
               ...
               {
                  _loc9_ = var_343.getFloorItemData(_loc8_.furniClassId);
               }
               else if(_loc8_.productType == CatalogPageMessageProductData.const_84)
               {
                  _loc9_ = var_343.getWallItemData(_loc8_.furniClassId);
               }
               _loc5_ = getProductImage(_loc8_.productType,_loc8_.furniClassId,_loc8_.extraParam);
            }
            _loc6_ = var_343.getProductData(_loc4_.localizationId);
         }
         if(!_loc6_)
         {
            return;
         ...
         if(_loc7_)
         {
            addItem(_loc7_.value,NotificationType.const_1244,_loc5_);
         }
      ...
      public function addOnlineNotification(param1:String, param2:String, param3:String = "") : void
      {
         ...
         var _loc9_:* = null;
         var _loc4_:* = null;
         var _loc7_:IAvatarImage = var_563.createAvatarImage(param2,AvatarScaleType.const_55);
         if(_loc7_ != null)
         {
      ...
      private function onSubscriptionInfo(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.responseType == ScrSendUserInfoMessageParser.const_1264)
         {
         ...
         else
         {
            ...
            if(_loc8_ > 0 && _loc2_.daysToPeriodEnd > 0 && _loc2_.daysToPeriodEnd <= _loc8_ && _loc2_.periodsSubscribedAhead == 0)
            {
               ...
               var_661 = new ClubEndingNotification(_loc2_.daysToPeriodEnd,_loc2_.method_2,_assets,_windowManager,_catalog,_localization);
            }
         }
      }
      ...
      private function onLocalizationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_185 = new HabboAlertDialogManager(_windowManager,_localization);
      ...
      {
         var_565 = IHabboToolbar(param2);
         var_565.events.addEventListener(HabboToolbarEvent.const_88,onHabboToolbarEvent);
      }
      ...
      private function onHotelClosing(param1:IMessageEvent) : void
      {
         ...
         var_185.handleHotelClosingMessage(_loc2_.minutesUntilClosing);
      }
      ...
      function onRespectNotification(param1:IMessageEvent) : void
      {
         ...
         if(this.var_343.userId == _loc2_.userId)
         {
            ...
            if(_loc3_)
            {
               addItem(_loc3_.value,NotificationType.const_853);
            }
            if(_loc4_)
            {
               addItem(_loc4_.value,NotificationType.const_853);
            }
         }
      }
      ...
      private function onHotelClosed(param1:IMessageEvent) : void
      {
         ...
         var_185.handleHotelClosedMessage(_loc2_.openHour,_loc2_.openMinute,_loc2_.userThrownOutAtClose);
      }
      ...
      private function tempCategoryMapping(param1:String, param2:int) : int
      {
         ...
         if(param1 == "I")
         {
            ...
            if(param2 == 4057)
            {
               return FurniCategory.const_283;
            }
            return 1;
         }
         return 1;
      ...
      public function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         if(param1.type == HabboToolbarEvent.const_88)
         {
            ...
            var_386 = new HabboNotificationViewManager(_assetLibrary,_windowManager,var_804["styles"],var_804["view"],var_565);
            ...
            registerUpdateReceiver(var_386,1);
            registerUpdateReceiver(this,2);
            var_343.events.addEventListener(BadgeImageReadyEvent.const_129,onBadgeImage);
            var_565.events.addEventListener(HabboToolbarEvent.TOOLBAR_ORIENTATION,onToolbarRepositionEvent);
         }
      }
   }
}
