package com.sulake.habbo.messenger
{
   ...
   public class ConversationView
   {
      ...
      private static const const_1134:int = 20;
      
      private static const const_792:int = 100;
       
      
      private var var_2217:IScrollbarWindow;
      
      private var var_138:HabboMessenger;
      
      private var var_1586:IContainerButtonWindow;
      ...
      public function ConversationView(param1:HabboMessenger, param2:IWindowContainer)
      {
         super();
         var_138 = param1;
         var_1586 = initButton("follow_friend",onFollowButtonClick,param2);
         var_49 = IItemListWindow(param2.findChildByName("msg_list"));
         var_2217 = IScrollbarWindow(param2.findChildByName("scroller"));
         var_138.refreshButton(param2,"close",true,onCloseButtonClick,0);
      ...
      {
         if(param1 == Message.const_690)
         {
            return 4285887861;
         }
         if(param1 == Message.const_506)
         {
            return 4285887861;
         }
         return 4278190080;
      ...
      private function refreshEntry(param1:Boolean, param2:int, param3:Message) : Boolean
      {
         ...
         if(_loc4_ == null)
         {
            ...
            _loc4_ = ITextWindow(var_138.getXmlWindow("msg_entry"));
         ...
         _loc4_.visible = true;
         var _loc5_:String = param3.type == Message.const_734 || param3.type == Message.const_715 ? param3.time + ": " : "";
      ...
      private function refreshList() : void
      {
         ...
         var _loc1_:int = 0;
         var _loc2_:int = Math.max(0,var_534.messages.length - const_792);
         _loc1_ = 0;
         while(_loc1_ + _loc2_ < var_534.messages.length)
         {
            refreshEntry(true,_loc1_,var_534.messages[_loc1_ + _loc2_]);
            _loc1_++;
         }
         while(true)
         {
      ...
      {
         var _loc1_:Conversation = var_138.conversations.findSelectedConversation();
         if(_loc1_ == null)
         {
            return;
         }
         if(var_534 == null || _loc1_.id != var_534.id)
         {
            var_534 = _loc1_;
            refreshList();
            afterResize();
      ...
      public function addMessage(param1:Message) : void
      {
         ...
         if(_loc2_ >= const_792 + const_1134)
         {
            refreshList();
            afterResize();
         }
      ...
      private function onCloseButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_138.conversations.closeConversation();
         var_138.messengerView.refresh(true);
      }
      ...
      private function onFollowButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_138.send(new FollowFriendMessageComposer(var_534.id));
      }
      ...
      private function initButton(param1:String, param2:Function, param3:IWindowContainer) : IContainerButtonWindow
      {
         ...
         _loc5_.bitmap = var_138.getButtonImage(param1);
      ...
      private function onMinimailButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(var_138.isEmbeddedMinimailEnabled())
         {
            if(false)
            {
         ...
         {
            var_138.openHabboWebPage("link.format.mail.compose",_loc3_,param1);
         }
      }
      ...
      private function refreshTextDims(param1:ITextWindow) : void
      {
         ...
         param1.height = param1.textHeight + const_1135;
         param1.invalidate();
      }
   }
}
