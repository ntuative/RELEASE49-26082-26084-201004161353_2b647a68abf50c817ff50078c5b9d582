package com.sulake.habbo.avatar.cache
{
   ...
   public class AvatarImageCache
   {
      ...
      private static const const_1413:int = 60000;
      ...
      private var var_785:IAvatarImage;
      ...
      public function getBodyPartCache(param1:String) : AvatarImageBodyPartCache
      {
         ...
         var _loc2_:AvatarImageBodyPartCache = var_118.getValue(param1) as AvatarImageBodyPartCache;
         if(_loc2_ == null)
         {
            _loc2_ = new AvatarImageBodyPartCache();
            var_118.add(param1,_loc2_);
         }
         return _loc2_;
      }
      ...
      public function getImageContainer(param1:String, param2:int) : AvatarImageBodyPartContainer
      {
         ...
         else if(_loc5_.definition.isAnimation)
         {
            ...
            if(_loc17_ != null)
            {
               ...
               if(_loc18_ != null)
               {
                  _loc8_ = _loc4_ + _loc18_.method_5;
                  if(_loc18_.method_5 < 0)
                  {
                     if(_loc8_ < 0)
                     {
                        _loc8_ = 8 + _loc8_;
                  ...
                  if(_loc18_.type == AnimationLayerData.const_603)
                  {
                     if(_loc18_.action != null)
                     {
                  ...
                  else if(_loc18_.type == AnimationLayerData.const_431)
                  {
                     _loc4_ = _loc8_;
                  }
                  _loc7_ = true;
         ...
         if(_loc16_ == null)
         {
            ...
            _loc10_ = var_51.getParts(param1,(var_785 as AvatarImage).getFigure(),_loc6_,var_1125,_loc4_,_loc13_,_loc14_);
      ...
      private function renderBodyPart(param1:int, param2:Array, param3:int, param4:IActiveActionData) : AvatarImageBodyPartContainer
      {
         ...
         var _loc5_:AvatarCanvas = var_51.getCanvas(var_186,var_1125);
         if(_loc5_ == null)
         {
            return null;
         }
         ...
         while(_loc23_ >= 0)
         {
            ...
            if(AvatarDirectionAngle.const_1350[param1])
            {
            ...
            _loc9_ = var_186 + "_" + _loc15_.assetPartDefinition + "_" + _loc10_ + "_" + _loc11_ + "_" + _loc18_ + "_" + _loc12_;
            _loc14_ = _assets.getAssetByName(_loc9_) as BitmapDataAsset;
            if(_loc14_ == null)
            {
               _loc9_ = var_186 + "_std_" + _loc10_ + "_" + _loc11_ + "_" + _loc18_ + "_0";
               _loc14_ = _assets.getAssetByName(_loc9_) as BitmapDataAsset;
            }
            ...
            else
            {
               ...
               if((_loc29_ == AvatarAction.const_1024 || _loc29_ == AvatarAction.const_678) && (_loc6_ == AvatarBodyPartType.const_317 || _loc6_ == AvatarBodyPartType.const_1260 || _loc6_ == AvatarBodyPartType.const_1340) && _loc7_.color != null)
               {
         ...
         if(_loc17_)
         {
            if(var_186 == AvatarScaleType.const_55)
            {
               _loc25_.x += 67;
            }
            else
      ...
      public function disposeInactiveActions(param1:int = 60000) : void
      {
         ...
         if(var_118 != null)
         {
            _loc2_ = var_118.getKeys();
            for each(_loc3_ in _loc2_)
            {
               _loc4_ = var_118.getValue(_loc3_) as AvatarImageBodyPartCache;
               if(_loc4_ != null)
               {
