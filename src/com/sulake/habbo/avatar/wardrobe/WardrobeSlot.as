package com.sulake.habbo.avatar.wardrobe
{
   ...
   public class WardrobeSlot implements IOutfit
   {
      ...
      public function updateView() : void
      {
         ...
         if(var_294 && var_1367)
         {
            _loc5_ = var_47.avatarRenderManager.createAvatarImage(figure,AvatarScaleType.SMALL,var_628);
            if(_loc5_)
            {
               _loc5_.setDirection(AvatarSetType.const_39,parseInt(FigureData.const_633));
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            case "set_button":
               var_294 = var_47.figureData.getFigureString();
               var_628 = var_47.gender;
               var_47.handler.saveWardrobeOutfit(var_1598,this);
               updateView();
               break;
            case "get_button":
               if(var_294)
               {
                  var_47.loadAvatarInEditor(var_294,var_628,var_47.clubMemberLevel);
               }
         }
      }
   }
