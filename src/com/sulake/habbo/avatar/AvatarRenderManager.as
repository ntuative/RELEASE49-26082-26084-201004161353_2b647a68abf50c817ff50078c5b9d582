package com.sulake.habbo.avatar
{
   ...
   public class AvatarRenderManager extends Component implements IAvatarRenderManager
   {
      ...
      private var var_1077:PaletteManager;
      
      private var var_744:PetDataManager;
      ...
      public function injectFigureData(param1:String, param2:XML) : void
      {
         ...
         switch(param1)
         {
            case AvatarType.const_83:
               _loc3_ = var_231.getValue(AvatarType.const_83) as AvatarStructure;
               break;
            case AvatarType.PET:
               _loc3_ = var_231.getValue(AvatarType.PET) as AvatarStructure;
               break;
            default:
      ...
      {
         var _loc2_:* = null;
         _loc2_ = var_231.getValue(AvatarType.const_83) as AvatarStructure;
         if(_loc2_ != null)
         {
            _loc2_.initConfiguration(_habboConfiguration);
         }
         _loc2_ = var_231.getValue(AvatarType.PET) as AvatarStructure;
         if(_loc2_ != null)
         {
            _loc2_.initConfiguration(_habboConfiguration);
         }
      ...
      private function init() : void
      {
         ...
         var_744 = new PetDataManager(_loc1_,_loc3_);
         var_1077 = new PaletteManager(_loc1_,_loc3_);
         var _loc4_:XML = _assets.getAssetByName("HabboAvatarPetFigure").content as XML;
         var_744.populateFigureData(_loc4_);
         ...
         var_231.add(AvatarType.const_83,_loc5_);
         _loc5_ = new AvatarStructure(this,assets,_loc1_,AvatarType.PET);
         _loc5_.addEventListener(AvatarStructure.AVATAR_STRUCTURE_INIT,onStructureInit);
         var_231.add(AvatarType.PET,_loc5_);
      }
      
      public function get petDataManager() : IPetDataManager
      {
         return var_744 as IPetDataManager;
      }
      
      public function set mode(param1:String) : void
      {
         var_699 = param1;
         if(var_699 == RenderMode.const_1163)
         {
            init();
         }
         if(var_699 == RenderMode.const_1170)
         {
            init();
      ...
      {
         var _loc5_:String = var_744.createAvatarFigureString(param1,param2,param3);
         var _loc6_:AvatarStructure = var_231.getValue(AvatarType.PET) as AvatarStructure;
         if(_loc6_ == null)
         {
            return null;
         }
      ...
      {
         var _loc2_:AvatarStructure = var_231.getValue(param1) as AvatarStructure;
         if(_loc2_ != null)
         {
      ...
      {
         var _loc4_:AvatarStructure = var_231.getValue(AvatarType.const_83) as AvatarStructure;
         if(_loc4_ == null)
         {
            return null;
         }
