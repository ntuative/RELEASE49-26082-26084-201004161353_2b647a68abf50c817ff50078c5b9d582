package com.sulake.habbo.avatar
{
   ...
   public class HabboAvatarEditor extends Component implements IHabboAvatarEditor
   {
      ...
      private var var_907:AvatarEditorHandler;
      ...
      private const const_1125:int = 2;
      ...
      public function getFigureSetType(param1:String) : ISetType
      {
         ...
         return var_745.getSetType(param1);
      }
      ...
      private function init() : void
      {
         ...
         if(!var_160)
         {
            ...
            var_524["null"] = new FigureData(this);
            var_524["null"] = new FigureData(this);
            _loc1_ = var_524["null"];
            _loc2_ = var_524["null"];
            ...
            var_87 = new Map();
            var_435 = new Map();
            var_87.add(AvatarEditorFigureCategory.const_973,new BodyModel(this));
            var_87.add(AvatarEditorFigureCategory.const_48,new HeadModel(this));
            var_87.add(AvatarEditorFigureCategory.const_317,new TorsoModel(this));
            var_87.add(AvatarEditorFigureCategory.const_1208,new LegsModel(this));
            var_87.add(AvatarEditorFigureCategory.const_1286,new HotLooksModel(this));
            var_435.add(AvatarEditorSideCategory.WARDROBE,new WardrobeModel(this));
            var_435.add(AvatarEditorSideCategory.const_414,new ClubPromoModel(this));
            var_160 = true;
         }
      }
         ...
         if(_loc8_ != null)
         {
            ...
            if(_loc9_)
            {
               ...
               if(_loc19_)
               {
                  ...
                  _loc7_ = new AvatarEditorGridPartItem(AvatarEditorView.var_1381.clone() as IWindowContainer,param1,null,null,false);
            ...
            {
               _loc21_ = false;
               if(_loc6_.gender == FigureData.const_1178)
               {
                  _loc21_ = true;
               }
               ...
               {
                  _loc7_ = new AvatarEditorGridPartItem(AvatarEditorView.var_1381.clone() as IWindowContainer,param1,_loc6_,_loc12_,_loc15_);
                  _loc3_.push(_loc7_);
               }
            }
         }
      ...
      public function get wardrobe() : WardrobeModel
      {
         ...
         return var_435.getValue(AvatarEditorSideCategory.WARDROBE);
      }
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_907 = new AvatarEditorHandler(this,_communication);
      }
      ...
      public function getPalette(param1:int) : IPalette
      {
         ...
         return var_745.getPalette(param1);
      }
      ...
      {
         var _loc2_:ISideContentModel = var_435.getValue(param1) as ISideContentModel;
         if(_loc2_ != null)
         {
            return _loc2_.getWindowContainer();
         }
      ...
      public function openEditor(param1:IWindowContainer = null) : Boolean
      {
         ...
         else
         {
            if(_windowContext == null)
            {
               _windowContext = _windowManager.createWindow("avatarEditorContainer","",HabboWindowType.const_61,HabboWindowStyle.const_42,0 | 0,new Rectangle(0,0,2,2),null,0) as IWindowContainer;
         ...
         _view.show();
         toggleAvatarEditorPage(AvatarEditorFigureCategory.const_973);
         return true;
      }
      
      private function onAvatarRendererReady(param1:Event = null) : void
      {
         var_745 = var_563.getFigureData(AvatarType.const_83);
      }
      ...
      private function onAvatarRenderManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         (var_563 as Component).events.addEventListener(AvatarRenderEvent.AVATAR_RENDER_READY,onAvatarRendererReady);
      }
      ...
      public function loadAvatarInEditor(param1:String, param2:String, param3:int = 0) : void
      {
         ...
         var_1078 = param3;
         var _loc4_:FigureData = var_524[param2];
         if(_loc4_ == null)
         {
            return;
         }
