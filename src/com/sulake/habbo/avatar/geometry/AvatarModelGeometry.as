package com.sulake.habbo.avatar.geometry
{
   ...
   public class AvatarModelGeometry
   {
      ...
      private var var_468:Matrix4x4;
      
      private var var_793:Vector3D;
      
      private var var_130:Dictionary;
      
      private var var_652:Dictionary;
      
      private var var_1417:AvatarSet;
      ...
      public function AvatarModelGeometry(param1:XML)
      {
         ...
         var _loc13_:* = null;
         var _loc14_:* = null;
         var_793 = new Vector3D(0,0,10,0);
         super();
         var_468 = new Matrix4x4();
         var_652 = new Dictionary();
         var_1417 = new AvatarSet(param1.avatarset[0]);
         ...
         for each(_loc4_ in param1.type)
         {
            ...
            var_652[String(_loc4_.@id)] = _loc12_;
         }
      }
      ...
      public function getParts(param1:String, param2:String, param3:uint, param4:Array) : Array
      {
         ...
         if(hasBodyPart(param1,param2))
         {
            ...
            var_468 = var_468.identity().rotateY(param3);
            return _loc5_.getParts(var_468,var_793,param4);
         }
         return [];
      }
      ...
      {
         var _loc2_:AvatarSet = var_1417.findAvatarSet(param1);
         if(_loc2_ != null)
         {
      ...
      private function hasBodyPart(param1:String, param2:String) : Boolean
      {
         ...
         {
            _loc3_ = var_652[param1] as Dictionary;
      ...
      {
         var _loc4_:* = null;
         var _loc3_:Dictionary = var_130[param1];
         if(_loc3_ != null)
         {
      ...
      public function getBodyPartsAtAngle(param1:String, param2:uint, param3:IActionDefinition) : Array
      {
         ...
         var_468 = var_468.identity().rotateY(param2);
         for each(_loc8_ in _loc6_)
         {
            _loc8_.applyTransform(var_468);
            _loc11_ = _loc8_.getDistance(var_793);
      ...
      private function getBodyPartsOfType(param1:String) : Dictionary
      {
         if(typeExists(param1))
         {
            return var_652[param1] as Dictionary;
         }
      ...
      {
         var _loc2_:* = [];
         var _loc3_:AvatarSet = var_1417.findAvatarSet(param1);
         if(_loc3_ != null)
         {
