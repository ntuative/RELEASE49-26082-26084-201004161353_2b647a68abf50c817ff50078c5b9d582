   ...
   public class LegsView extends CategoryBaseView implements IAvatarEditorCategoryView
   {
      ...
      override public function init() : void
      {
         ...
         if(!var_34)
         {
            ...
            var_34["null"] = new AvatarEditorGridView(_model,FigureData.const_179,_windowManager,_assetLibrary);
            var_34["null"] = new AvatarEditorGridView(_model,FigureData.const_170,_windowManager,_assetLibrary);
         ...
         if(_model && var_141 == "")
         {
            _model.switchCategory(FigureData.const_179);
         }
      }
      ...
      private function windowEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            {
               case "tab_pants":
                  switchCategory(FigureData.const_179);
                  break;
               case "tab_shoes":
