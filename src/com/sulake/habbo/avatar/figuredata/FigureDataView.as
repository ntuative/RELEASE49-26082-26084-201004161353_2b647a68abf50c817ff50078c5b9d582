package com.sulake.habbo.avatar.figuredata
{
   ...
   public class FigureDataView
   {
      ...
      private var var_352:IBitmapWrapperWindow;
      ...
      public function FigureDataView(param1:IHabboWindowManager, param2:IAssetLibrary)
      {
         ...
         if(_loc4_)
         {
            var_1045 = _loc4_.content as BitmapData;
         }
         if(_window != null)
         {
            var_352 = _window.findChildByName("bitmap") as IBitmapWrapperWindow;
         }
      }
      ...
      public function udpate(param1:BitmapData) : void
      {
         if(var_352 && var_1045)
         {
            var_352.bitmap = new BitmapData(var_352.width,var_352.height,true,16777215);
            var_352.bitmap.copyPixels(var_1045,var_1045.rect,new Point(0,0 - 0 - 8));
            var_352.bitmap.copyPixels(param1,param1.rect,new Point(4,0),null,null,true);
         }
      }
   }
}
