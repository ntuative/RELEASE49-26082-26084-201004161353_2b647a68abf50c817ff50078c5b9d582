package com.sulake.habbo.avatar.animation
{
   ...
   public class AvatarDataContainer implements IAvatarDataContainer
   {
      ...
      private var var_1414:Number = 1;
      
      private var _b:uint;
      
      private var var_1413:Number = 1;
      
      private var var_1561:int;
      
      private var _colorTransform:ColorTransform;
      
      private var var_2137:uint;
      ...
      public function AvatarDataContainer(param1:XML)
      {
         ...
         _colorTransform = new ColorTransform(var_1415,var_1413,var_1414,_alphaMultiplier);
         var_1072 = generatePaletteMapForGrayscale(var_2137,var_2138);
      }
      
      public function get reds() : Array
      {
         return var_1072.getValue("reds") as Array;
      }
      ...
      {
         return var_1072.getValue("blues") as Array;
      }
      
      public function get greens() : Array
      {
         return var_1072.getValue("greens") as Array;
      }
      ...
      {
         return var_1072.getValue("alphas") as Array;
      }
