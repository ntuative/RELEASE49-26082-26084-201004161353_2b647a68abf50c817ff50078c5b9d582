package com.sulake.habbo.avatar.pets
{
   ...
   public class PetDataManager implements IPetDataManager
   {
         ...
         for each(_loc3_ in param2)
         {
            ...
            if(_loc4_ != null)
            {
               ...
               if(_loc4_.hasAsset("petData"))
               {
                  ...
                  var_704.add(int(_loc6_.@species),new PetData(_loc6_));
               }
            }
         }
      }
      ...
      {
         return var_704.getValue(param1) as IPetData;
      }
      ...
      public function populateFigureData(param1:XML) : void
      {
         ...
         speciesKeys = var_704.getKeys();
         for each(key in speciesKeys)
         {
            petData = var_704.getValue(key);
            if(petData != null)
            {
               ...
               for each(breed in petData.breeds)
               {
                  ...
                  for each(targetSetName in targetSets)
                  {
                     ...
                     {
                        figurePart = figureTargetSet.var_1907.part.(@id == petData.species).(hasOwnProperty("palettemapid") && @palettemapid == breed.patternId)[0];
                        if(figurePart == null)
                        {
                        }
      ...
      {
         var _loc4_:PetData = var_704.getValue(param1);
         if(_loc4_ == null)
         {
