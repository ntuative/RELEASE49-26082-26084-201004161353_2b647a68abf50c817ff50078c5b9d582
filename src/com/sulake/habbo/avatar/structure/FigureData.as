package com.sulake.habbo.avatar.structure
{
   ...
   public class FigureData implements IStructureData, IFigureData
   {
      ...
      {
         super();
         var_216 = new Dictionary();
         var_766 = new Dictionary();
      }
      ...
      public function parse(param1:XML) : Boolean
      {
         ...
         {
            var_216[String(_loc2_.@id)] = new Palette(_loc2_);
         }
         for each(_loc3_ in param1.sets.settype)
         {
            var_766[String(_loc3_.@type)] = new SetType(_loc3_);
         }
         return true;
      }
      ...
      {
         var _loc3_:SetType = var_766[param1] as SetType;
         if(_loc3_)
         {
      ...
      public function appendXML(param1:XML) : Boolean
      {
         ...
         for each(_loc2_ in param1.colors.palette)
         {
            _loc4_ = var_216[String(_loc2_.@id)];
            if(_loc4_ == null)
            {
               var_216[String(_loc2_.@id)] = new Palette(_loc2_);
            }
         ...
         for each(_loc3_ in param1.sets.settype)
         {
            _loc5_ = var_766[String(_loc3_.@type)];
            if(_loc5_ == null)
            {
               var_766[String(_loc3_.@type)] = new SetType(_loc3_);
            }
