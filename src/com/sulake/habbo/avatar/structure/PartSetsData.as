package com.sulake.habbo.avatar.structure
{
   ...
   public class PartSetsData implements IStructureData
   {
      ...
      {
         var _loc2_:ActivePartSet = var_923[param1.activePartSet];
         if(_loc2_ != null)
         {
            return _loc2_.parts;
         }
      ...
      public function addPartDefinition(param1:XML) : PartDefinition
      {
         ...
         if(true)
         {
            var_166[_loc2_] = new PartDefinition(param1);
         }
         return var_166[_loc2_];
      }
      ...
      public function parse(param1:XML) : Boolean
      {
         ...
         {
            var_166[String(_loc2_["set-type"])] = new PartDefinition(_loc2_);
         }
         for each(_loc3_ in param1.activePartSet)
         {
            var_923[String(_loc3_.@id)] = new ActivePartSet(_loc3_);
         }
         return true;
      }
      ...
      {
         return var_923[param1.activePartSet] as ActivePartSet;
      }
      
      public function getPartDefinition(param1:String) : PartDefinition
      {
         return var_166[param1] as PartDefinition;
      }
   }
}
