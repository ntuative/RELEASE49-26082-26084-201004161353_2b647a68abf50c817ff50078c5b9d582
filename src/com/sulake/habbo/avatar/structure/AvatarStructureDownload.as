package com.sulake.habbo.avatar.structure
{
   ...
   public class AvatarStructureDownload extends EventDispatcher
   {
      ...
      public static const const_852:String = "AVATAR_STRUCTURE_DONE";
       
      
      private var _assets:IAssetLibrary;
      
      private var var_1683:IStructureData;
      
      private var var_1403:XML;
      ...
      private function onDataComplete(param1:Event) : void
      {
         ...
         try
         {
            var_1403 = new XML(loaderStruct.assetLoader.content as String);
         }
         catch(e:Error)
         {
         ...
         var_1683.appendXML(var_1403);
         dispatchEvent(new Event(AvatarStructureDownload.const_852));
      }
   }
}
