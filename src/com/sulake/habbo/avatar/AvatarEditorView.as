package com.sulake.habbo.avatar
{
   ...
   public class AvatarEditorView
   {
      ...
      private var var_1453:Boolean = true;
      
      private var var_349:Timer;
      
      private var var_1455:ITabSelectorWindow;
      ...
      public function AvatarEditorView(param1:HabboAvatarEditor, param2:IHabboWindowManager, param3:IHabboCatalog)
      {
         ...
         if(var_1381 == null)
         {
            ...
            var_1381 = var_47.windowManager.buildFromXML(_loc4_.content as XML) as IWindowContainer;
         }
         if(var_1609 == null)
         {
      ...
      private function createWindow() : void
      {
         ...
         var_1455 = _window.findChildByName("mainTabs") as ITabSelectorWindow;
         attachImages();
         update();
      }
      ...
      public function update() : void
      {
         ...
         if(var_47.sessionData.hasUserRight("fuse_use_wardrobe") && (var_1454 == AvatarEditorSideCategory.WARDROBE || var_1893))
         {
            _loc4_ = "null";
         }
      ...
      private function displayStripClubDialog() : void
      {
         ...
         if(!var_490)
         {
            ...
            var_490 = _windowManager.buildFromXML(_loc2_,2) as IFrameWindow;
            var_490.procedure = stripClubDialogEventProc;
            var_490.center();
         }
         else
         {
            var_490.visible = true;
            var_490.center();
         }
      }
      ...
      private function setSideContent(param1:String) : void
      {
         ...
         switch(param1)
         {
            case AvatarEditorSideCategory.const_531:
               break;
            case AvatarEditorSideCategory.const_414:
               _loc3_ = var_47.getSideContentWindowContainer(AvatarEditorSideCategory.const_414);
               break;
      ...
      private function setViewToCategory(param1:String) : void
      {
         ...
         var_271 = param1;
         var_1455.setSelected(var_1455.getSelectableByName(param1));
         _window.invalidate();
      }
      
      private function toggleWardrobe() : void
      {
         if(var_1454 == AvatarEditorSideCategory.WARDROBE)
         {
            var_1893 = false;
            setSideContent(AvatarEditorSideCategory.const_531);
         }
         else
         {
