package com.sulake.habbo.avatar.common
{
   ...
   public class AvatarEditorGridColorItem
   {
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc1_ != null)
         {
            _loc1_.bitmap = new BitmapData(var_749.width,var_749.height,true,0);
            _loc1_.bitmap.copyPixels(var_749,var_749.rect,new Point(0,0));
         }
         var _loc2_:IBitmapWrapperWindow = _window.findChildByTag("COLOR_IMAGE") as IBitmapWrapperWindow;
         if(_loc2_ != null)
         {
            _loc2_.bitmap = new BitmapData(var_915.width,var_915.height,true,0);
            _loc5_ = var_915.clone();
            ...
            if(var_747)
            {
               switch(var_747.clubLevel)
               {
                  ...
                  case HabboClubLevelEnum.const_60:
                     _loc4_.style = HabboIconType.const_628;
                     _loc4_.visible = true;
                     break;
