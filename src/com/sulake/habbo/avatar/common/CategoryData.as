package com.sulake.habbo.avatar.common
{
   ...
   public class CategoryData
   {
      ...
      public function selectPartIndex(param1:int) : AvatarEditorGridPartItem
      {
         ...
         if(var_665 >= 0 && var_166.length > var_665)
         {
            _loc2_ = var_166[var_665];
            if(_loc2_)
            {
               _loc2_.isSelected = false;
            }
         }
         if(var_166.length > param1)
         {
            _loc3_ = var_166[param1] as AvatarEditorGridPartItem;
            if(_loc3_)
            {
      ...
      public function getSelectedColorIds() : Array
      {
         ...
         var _loc1_:Array = var_216[0] as Array;
         ...
         {
            _loc7_ = var_216[_loc5_];
            if(!(!_loc7_ || _loc7_.length <= _loc5_))
            {
               if(_loc7_.length > var_188[_loc5_])
               {
      ...
      public function selectColorIndex(param1:int, param2:int) : AvatarEditorGridColorItem
      {
         ...
         deselectColorIndex(var_188[param2],param2);
         var_188[param2] = param1;
      ...
      public function getSelectedColor(param1:int) : AvatarEditorGridColorItem
      {
         ...
         if(!_loc2_ || _loc2_.length <= var_188[param1])
         {
            return null;
         }
      ...
      public function getPalette(param1:int) : Array
      {
         ...
         if(var_216.length <= param1)
         {
            return null;
         }
         return var_216[param1] as Array;
      }
      
      public function getCurrentPart() : AvatarEditorGridPartItem
      {
         return var_166[var_665] as AvatarEditorGridPartItem;
      }
      ...
      public function dispose() : void
      {
         ...
         if(var_216)
         {
            for each(_loc2_ in var_216 as Array)
            {
               if(_loc2_)
               {
      ...
      public function selectColorIds(param1:Array) : void
      {
         ...
         var_188 = new Array(param1.length);
         var _loc3_:int = 0;
