package com.sulake.habbo.avatar.common
{
   ...
   public class AvatarEditorGridPartItem
   {
      ...
      private const const_1646:int = 16777215;
      
      private var _isSelected:Boolean = false;
      
      private const const_1645:int = 13421772;
      
      private var var_422:Rectangle;
      ...
      private var var_605:IFigurePartSet;
      ...
      public function AvatarEditorGridPartItem(param1:IWindowContainer, param2:IAvatarEditorCategoryModel, param3:IFigurePartSet, param4:Array, param5:Boolean = true)
      {
         ...
         if(param3 != null)
         {
            ...
            {
               var_1525 = Math.max(var_1525,_loc6_.colorLayerIndex);
            }
         }
      ...
      private function updateThumbVisualization() : void
      {
         ...
         if(isSelected)
         {
            _window.color = const_1645;
         }
         else
         {
            _window.color = const_1646;
         }
         _window.invalidate();
      }
      ...
      private function analyzePartLayers() : Boolean
      {
         ...
         {
            _loc2_ = "undefined_undefined_" + _loc1_.type + "_" + _loc1_.id + "_" + FigureData.const_948 + "_" + FigureData.const_238;
      ...
      private function renderThumb() : BitmapData
      {
         ...
         _loc1_ = new BitmapData(var_422.width,var_422.height,true,16777215);
         var _loc6_:Array = partSet.parts.concat().sort(sortByDrawOrder);
         for each(_loc2_ in _loc6_)
         {
            _loc3_ = "undefined_undefined_" + _loc2_.type + "_" + _loc2_.id + "_" + FigureData.const_948 + "_" + FigureData.const_238;
            ...
            if(_loc4_ != null)
            {
               ...
               if(var_1524 && _loc2_.colorLayerIndex > 0)
               {
