package com.sulake.habbo.avatar
{
   ...
   public class AvatarStructure extends EventDispatcher
   {
      ...
      private var var_406:PartSetsData;
      
      private var var_1894:PartOffsetData;
      
      private var var_824:AvatarActionManager;
      
      private var var_168:IAssetLibrary;
      
      private var var_1004:IAssetLibrary;
      
      private var var_1895:AvatarRenderManager;
      
      private var var_300:FigureData;
      ...
      private var var_1456:AvatarStructureDownloadSet;
      
      private var var_1216:Array;
      
      private var var_686:AnimationManager;
      ...
      public function AvatarStructure(param1:AvatarRenderManager, param2:IAssetLibrary, param3:IAssetLibrary, param4:String)
      {
         ...
         var_168 = param2;
         var_1004 = param3;
         var_300 = new FigureData();
         var_406 = new PartSetsData();
         _animationData = new AnimationData();
         var_1456 = new AvatarStructureDownloadSet();
         var_686 = new AnimationManager();
         var_687 = param4;
         var_1894 = PartOffsetData.getInstance(param3);
         init();
      }
      ...
      {
         return var_824.getActionDefinitionWithState(param1);
      }
      ...
      private function init() : void
      {
         ...
         switch(var_687)
         {
            case AvatarType.const_83:
               _loc1_ = var_168.getAssetByName("HabboAvatarPartSets").content as XML;
               if(!var_406.parse(_loc1_))
               {
                  return;
               }
               _loc2_ = var_168.getAssetByName("HabboAvatarAnimation").content as XML;
               if(!_animationData.parse(_loc2_))
               {
                  return;
               }
               _loc3_ = var_168.getAssetByName("HabboAvatarFigure").content as XML;
               if(!var_300.parse(_loc3_))
               {
                  return;
               }
               break;
            case AvatarType.PET:
               _loc1_ = var_168.getAssetByName("HabboAvatarPetPartSets").content as XML;
               if(!var_406.parse(_loc1_))
               {
                  return;
               }
               _loc2_ = var_168.getAssetByName("HabboAvatarPetAnimation").content as XML;
               if(!_animationData.parse(_loc2_))
               {
                  return;
               }
               _loc3_ = var_168.getAssetByName("HabboAvatarPetFigure").content as XML;
               if(!var_300.parse(_loc3_))
               {
                  return;
               }
      ...
      {
         return var_824.getCanvasOffsets(param1,param2,param3);
      }
      
      public function injectFigureData(param1:XML) : void
      {
         var_300.appendXML(param1);
      }
      
      public function getActionDefinition(param1:String) : ActionDefinition
      {
         return var_824.getActionDefinition(param1);
      }
      ...
      public function getActiveBodyPartIds(param1:IActiveActionData) : Array
      {
         ...
         if(param1.definition.isAnimation)
         {
            ...
            _loc7_ = var_686.getAnimation(_loc6_);
            if(_loc7_ != null)
            {
               ...
               if(_loc7_.hasAddData())
               {
                  for each(_loc9_ in _loc7_.addData)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        _loc12_ = var_406.addPartDefinition(_loc11_);
         ...
         {
            _loc2_ = var_406.getActiveParts(param1.definition);
      ...
      {
         var _loc4_:Number = AvatarDirectionAngle.const_1211[param3];
      ...
      public function getParts(param1:String, param2:AvatarFigureContainer, param3:IActiveActionData, param4:String, param5:int, param6:Array, param7:Dictionary = null) : Array
      {
         ...
         var _loc8_:ActionDefinition = var_824.getDefaultActionType();
         var _loc9_:Array = var_406.getActiveParts(param3.definition);
         var _loc11_:Array = new Array();
         if(param3.definition.isAnimation)
         {
            _loc19_ = param3.definition.state + "." + param3.actionParameter;
            _loc10_ = var_686.getAnimation(_loc19_);
            if(_loc10_ != null)
            {
         ...
         for each(_loc16_ in _loc15_)
         {
            ...
            _loc25_ = var_300.getSetType(_loc16_);
            if(_loc25_ != null)
            {
               _loc26_ = var_300.getPalette(_loc25_.paletteID);
               if(_loc26_)
               {
                  ...
                  if(_loc27_ != null)
                  {
                     ...
                     for each(_loc28_ in _loc27_.parts)
                     {
                        if(_loc14_.indexOf(_loc28_.type) > -1)
                        {
                           ...
                           _loc13_ = var_406.getPartDefinition(_loc28_.type);
         ...
         for each(_loc12_ in _loc14_)
         {
            ...
            if(!_loc37_)
            {
               ...
               if(_loc9_.indexOf(_loc12_) > -1)
               {
                  ...
                  {
                     _loc13_ = var_406.getPartDefinition(_loc12_);
                     _loc42_ = false;
                     _loc43_ = 1;
      ...
      private function initGeometry() : void
      {
         ...
         {
            case AvatarType.const_83:
               if(var_168.hasAsset("HabboAvatarGeometry"))
               {
                  _loc1_ = var_168.getAssetByName("HabboAvatarGeometry").content as XML;
               ...
               break;
            case AvatarType.PET:
               if(var_168.hasAsset("HabboAvatarPetGeometry"))
               {
                  _loc1_ = var_168.getAssetByName("HabboAvatarPetGeometry").content as XML;
                  _geometry = new AvatarModelGeometry(_loc1_);
               }
               else
               {
      ...
      {
         Logger.log("[AvatarStructure] Structure " + var_687 + " ready to go!");
         if(var_687 == AvatarType.const_83)
         {
            var_406.getPartDefinition("ri").appendToFigure = true;
            var_406.getPartDefinition("li").appendToFigure = true;
         }
         registerAnimations();
      ...
      public function initConfiguration(param1:IHabboConfigurationManager) : void
      {
         ...
         {
            case AvatarType.const_83:
               if(var_168.hasAsset(_loc5_))
               {
                  var_168.removeAsset(var_168.getAssetByName(_loc5_));
               }
               var_1456.add(new AvatarStructureDownload(var_168,_loc5_,var_300));
               break;
            case AvatarType.PET:
         }
         var_1456.addEventListener(AvatarStructureDownloadSet.DOWNLOAD_SET_DONE,onStructureReady);
      }
      
      public function getAnimation(param1:String) : Animation
      {
         return var_686.getAnimation(param1);
      }
      ...
      {
         var_824 = new AvatarActionManager(var_168,var_687);
      }
      ...
      public function getMandatorySetTypeIds() : Array
      {
         ...
         var_1216 = var_300.getMandatorySetTypeIds();
         return var_1216;
      }
      
      public function getDefaultPartSet(param1:String, param2:String) : IFigurePartSet
      {
         return var_300.getDefaultPartSet(param1,param2);
      }
      ...
      private function registerAnimations() : void
      {
         var _loc2_:* = null;
         var _loc1_:int = 1;
         while(var_1004.hasAsset("dance" + _loc1_))
         {
            _loc2_ = var_1004.getAssetByName("dance" + _loc1_).content as XML;
            var_686.registerAnimation(this,_loc2_);
            _loc1_++;
         }
         _loc1_ = 1;
         while(var_1004.hasAsset("fx" + _loc1_))
         {
            _loc2_ = var_1004.getAssetByName("fx" + _loc1_).content as XML;
            var_686.registerAnimation(this,_loc2_);
            _loc1_++;
         }
      }
      ...
      public function getPartColor(param1:AvatarFigureContainer, param2:String, param3:int = 0) : IPartColor
      {
         ...
         var _loc5_:ISetType = var_300.getSetType(param2);
         if(_loc5_ == null)
         {
            return null;
         }
         var _loc6_:IPalette = var_300.getPalette(_loc5_.paletteID);
         if(!_loc6_)
         {
            return null;
         }
      ...
      {
         return var_824.sortActions(param1);
      }
   }
}
