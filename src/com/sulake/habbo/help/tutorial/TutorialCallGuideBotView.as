package com.sulake.habbo.help.tutorial
{
   ...
   public class TutorialCallGuideBotView implements ITutorialUIView
   {
      ...
      private var var_560:IWindowContainer;
      ...
      public function TutorialCallGuideBotView(param1:IItemListWindow, param2:TutorialUI)
      {
         ...
         _main.help.toolbar.events.addEventListener(HabboToolbarShowMenuEvent.const_50,onShowMenuEvent);
      }
      ...
      private function showToolbarIconHighlightArrow() : void
      {
         ...
         var_560 = _main.buildXmlWindow("tutorial_arrow") as IWindowContainer;
         var _loc1_:IBitmapWrapperWindow = var_560.findChildByName("arrow") as IBitmapWrapperWindow;
         if(_loc1_ != null)
         {
         ...
         _main.help.toolbar.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_50,HabboToolbarIconEnum.HELP_ARROW,var_560));
      }
      ...
      {
         var _loc2_:HabboToolbarSetIconEvent = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_164,HabboToolbarIconEnum.HELP);
         if(param1)
         {
      ...
      {
         setToolbarIconHighlight(false);
         _main.help.toolbar.events.removeEventListener(HabboToolbarShowMenuEvent.const_50,onShowMenuEvent);
      }
   }
}
