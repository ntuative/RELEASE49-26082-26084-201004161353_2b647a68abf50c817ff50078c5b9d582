package com.sulake.habbo.help.tutorial
{
   ...
   public class TutorialUI implements INameChangeUI
   {
      ...
      public static const const_287:String = "TUI_CLOTHES_VIEW";
      ...
      public function update(param1:Boolean, param2:Boolean, param3:Boolean) : void
      {
         ...
         var_1103 = param2;
         var_1102 = param3;
         if(var_36 == null || var_36.id == const_90)
         {
            prepareForTutorial();
            showView(const_90);
         }
      ...
      public function onUserNameChanged(param1:String) : void
      {
         ...
         if(var_36 != null && (var_36.id == const_234 || var_36.id == const_90))
         {
            showView(const_90);
         }
      }
      ...
      public function onTaskDoneEvent(param1:HabboHelpTutorialEvent) : void
      {
         switch(param1.type)
         {
            case HabboHelpTutorialEvent.const_410:
               var_1102 = true;
               if(var_36 != null && var_36.id == const_361)
               {
                  showView(const_90);
               }
               break;
            case HabboHelpTutorialEvent.const_388:
               if(var_36 != null && var_36.id == const_287)
               {
                  var_1377 = true;
                  disposeWindow();
               }
      ...
      {
         var_1104 = true;
         if(var_36 != null && (var_36.id == const_287 || var_36.id == const_90))
         {
            showView(const_90);
         }
      }
      ...
      {
         return var_1104 && var_1103 && var_1102;
      }
   }
}
