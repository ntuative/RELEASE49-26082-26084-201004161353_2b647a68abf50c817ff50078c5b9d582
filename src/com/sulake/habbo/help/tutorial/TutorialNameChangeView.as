package com.sulake.habbo.help.tutorial
{
   ...
   public class TutorialNameChangeView implements ITutorialUIView
   {
      ...
      private var var_273:IBorderWindow;
      ...
      public function setNameAvailableView() : void
      {
         ...
         _main.localization.registerParameter("help.tutorial.name.available","name",var_347);
      ...
      private function showConfirmationView(param1:Boolean) : void
      {
         ...
         if(param1)
         {
            _main.localization.registerParameter("help.tutorial.name.confirmation","name",var_347);
         }
         if(var_273 == null)
         {
            var_273 = _main.buildXmlWindow("tutorial_change_name_confirmation") as IBorderWindow;
            if(var_273 == null)
            {
               return;
            }
            ...
            _loc2_.addChild(var_273);
            var_273.procedure = confirmationViewEventHandler;
         }
         _window.visible = !param1;
         var_273.visible = param1;
      }
      ...
      public function setNameNotAvailableView(param1:int, param2:String, param3:Array) : void
      {
         ...
         _loc5_.visible = true;
         var_823 = new NameSuggestionListRenderer(_main);
