package com.sulake.habbo.help.help
{
   ...
   public class HelpUI
   {
      ...
      private static const const_1430:int = 0;
      
      private static const const_1429:int = 0;
      ...
      private var var_424:IWindowContainer;
      ...
      public function HelpUI(param1:HabboHelp, param2:IAssetLibrary, param3:IHabboWindowManager, param4:IHabboLocalizationManager, param5:IHabboToolbar)
      {
         ...
         _windowManager.registerLocalizationParameter("info.client.version","version","26082-26084-201004161309");
         var_199 = param5;
         var_100 = new Map();
         var_100.add(HabboHelpViewEnum.const_1336,IHelpViewController(new PlaceholderView(this,_windowManager,_assetLibrary)));
         var_100.add(HabboHelpViewEnum.const_139,IHelpViewController(new HelpMainView(this,_windowManager,_assetLibrary)));
         var_100.add(HabboHelpViewEnum.const_365,IHelpViewController(new FaqBrowseTopView(this,_windowManager,_assetLibrary)));
         var_100.add(HabboHelpViewEnum.const_273,IHelpViewController(new FaqBrowseCategoryView(this,_windowManager,_assetLibrary)));
         var_100.add(HabboHelpViewEnum.const_216,IHelpViewController(new FaqBrowseEntry(this,_windowManager,_assetLibrary)));
         var_100.add(HabboHelpViewEnum.const_542,IHelpViewController(new FaqBrowseSearchResults(this,_windowManager,_assetLibrary)));
         var_100.add(HabboHelpViewEnum.const_312,IHelpViewController(new CallForHelpTopicSelection(this,_windowManager,_assetLibrary)));
         var_100.add(HabboHelpViewEnum.const_667,IHelpViewController(new CallForHelpTextInput(this,_windowManager,_assetLibrary)));
         var_100.add(HabboHelpViewEnum.const_220,IHelpViewController(new CallForHelpSentView(this,_windowManager,_assetLibrary,"help_cfh_thanks")));
         ...
         var_100.add(HabboHelpViewEnum.const_926,IHelpViewController(new CallForHelpPendingItemView(this,_windowManager,_assetLibrary)));
         var_100.add(HabboHelpViewEnum.const_643,IHelpViewController(new CallForHelpReportUserSelection(this,_windowManager,_assetLibrary)));
      }
      ...
      private function addBackButtonWindow() : void
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         if(var_271 == HabboHelpViewEnum.const_139 || false)
         {
            return;
         }
         if(var_424 == null)
         {
            ...
            var_424 = _loc2_.buildFromXML(XML(_loc3_.content)) as IWindowContainer;
         }
         var _loc1_:IItemListWindow = _window.findChildByName("content_list") as IItemListWindow;
         if(_loc1_ == null || var_424 == null)
         {
            return;
         }
         if(_loc1_.getListItemIndex(var_424 as IWindow) > -1)
         {
            return;
         }
         _loc1_.addListItem(var_424 as IWindow);
      ...
      {
         return var_100.getValue(var_271);
      }
      ...
      {
         var_2072 = param1;
         var _loc2_:IHelpViewController = var_100.getValue(HabboHelpViewEnum.const_139) as IHelpViewController;
      ...
      public function showCallForHelpResult(param1:String) : void
      {
         switch(param1)
         {
            case CallForHelpResultEnum.const_220:
               ...
               break;
            case CallForHelpResultEnum.const_994:
               showUI(HabboHelpViewEnum.const_926);
               break;
      ...
      {
         var _loc3_:* = null;
         if(var_271 == HabboHelpViewEnum.const_139)
         {
            return;
         }
         if(true)
         ...
         var _loc2_:IBitmapWrapperWindow = var_424.findChildByName("back_image") as IBitmapWrapperWindow;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      public function showUI(param1:String = null, param2:Boolean = true) : void
      {
         ...
         if(_loc4_ == null)
         {
            Logger.log("* No view controller found for " + var_271);
            return;
         }
         ...
         if(_loc3_)
         {
            if(var_199 != null)
            {
               var_199.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_50,HabboToolbarIconEnum.HELP,_window));
            }
         }
      ...
      public function handleCallGuideBot() : void
      {
         ...
         hideUI();
         var_22.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_410));
      }
