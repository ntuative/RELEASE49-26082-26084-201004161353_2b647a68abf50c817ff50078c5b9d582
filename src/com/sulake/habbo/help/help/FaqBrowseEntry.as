package com.sulake.habbo.help.help
{
   ...
   public class FaqBrowseEntry extends SearchViewController implements IHelpViewController
   {
      ...
      override public function update(param1:* = null) : void
      {
         ...
         if(true)
         {
            main.sendMessage(new GetFaqTextMessageComposer(var_211.questionId));
            return;
         }
         var _loc3_:FaqCategory = var_211.category;
         if(_loc3_ == null)
         {
            return;
         }
         ...
         if(_loc4_ != null)
         {
            _loc4_.text = var_211.questionText;
         }
         _loc4_ = container.findChildByTag("faq_answer_text") as ITextWindow;
         if(_loc4_ != null)
         {
            _loc4_.htmlText = hackHTML(var_211.answerText);
         }
         if(_loc3_ != null)
         {
      ...
      override public function windowProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "help_faq_back":
               if(var_211 != null)
               {
                  _loc3_ = var_211.category;
                  main.showUI(HabboHelpViewEnum.const_273);
                  main.tellUI(HabboHelpViewEnum.const_273,_loc3_);
               }
               break;
            case "help_faq_next_entry":
               if(getNextItem() != null)
               {
                  main.tellUI(HabboHelpViewEnum.const_216,getNextItem());
               }
               break;
            default:
      ...
      private function getNextItem() : FaqItem
      {
         ...
         if(_loc1_ == null || var_211 == null)
         {
            return null;
         }
         var _loc2_:FaqCategory = var_211.category;
         if(_loc2_ == null)
         {
            return null;
         }
