package com.sulake.habbo.help
{
   ...
   public class IncomingMessages
   {
      ...
      private function onFaqText(param1:IMessageEvent) : void
      {
         ...
         if(_loc4_ != null)
         {
            var_22.tellUI(HabboHelpViewEnum.const_216,_loc4_);
         }
      }
      ...
      private function onFaqCategory(param1:IMessageEvent) : void
      {
         ...
         var_22.tellUI(HabboHelpViewEnum.const_273,_loc6_);
      }
      ...
      private function onFaqClientFaqs(param1:IMessageEvent) : void
      {
         ...
         var_22.tellUI(HabboHelpViewEnum.const_139);
      }
      ...
      {
         var_22.showUI(HabboHelpViewEnum.const_312);
      }
      ...
      private function onFaqCategories(param1:IMessageEvent) : void
      {
         ...
         var_22.showUI(HabboHelpViewEnum.const_365);
      }
      ...
      private function onFaqSearchResults(param1:IMessageEvent) : void
      {
         ...
         var_22.showUI(HabboHelpViewEnum.const_542);
         var_22.tellUI(HabboHelpViewEnum.const_542,_loc5_);
      }
      ...
      private function onUsers(param1:IMessageEvent) : void
      {
         ...
         while(_loc4_ < _loc3_.getUserCount())
         {
            ...
            if(_loc5_.webID != _userId && _loc5_.userType == RoomObjectTypeEnum.const_320)
            {
         ...
         var_22.tellUI(HabboHelpViewEnum.const_643);
      }
