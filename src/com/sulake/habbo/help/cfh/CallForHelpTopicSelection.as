package com.sulake.habbo.help.cfh
{
   ...
   public class CallForHelpTopicSelection extends HelpViewController implements IHelpViewController
   {
      ...
      private function handleListItemClick(param1:IWindow) : void
      {
         ...
         if(var_746 == null || _loc3_ < 0 || _loc3_ >= var_746.length)
         {
            return;
         }
         if(_loc3_ > -1)
         {
            main.component.callForHelpData.topicIndex = var_746[_loc3_];
            main.showUI(HabboHelpViewEnum.const_667);
            main.tellUI(HabboHelpViewEnum.const_667,null);
         }
      }
   }
}
