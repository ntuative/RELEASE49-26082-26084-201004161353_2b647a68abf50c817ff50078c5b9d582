package com.sulake.habbo.communication.demo
{
   ...
   public class HabboLoginDemoView extends EventDispatcher
   {
      ...
      public static const const_672:String = "InitConnection";
      ...
      private var var_369:HabboCommunicationDemo;
      
      public var password:String = "";
      
      private var var_113:SSOTicket;
      ...
      {
         var_369.windowManager.removeWindow("habbo_login_window");
      }
      ...
      private function onParsedTicketSuccess(param1:Event) : void
      {
         ...
         var_369.shockwaveClientUrl = var_113.shockwaveClientUrl;
         var_369.ssoTicket = var_113.ticket;
         var_113.removeEventListener(SSOTicket.const_315,onParsedTicketSuccess);
         var_113.removeEventListener(SSOTicket.const_277,onParsedTicketFailure);
         var_113 = null;
         dispatchEvent(new Event(const_672));
      }
      ...
      private function windowEventProcessor(param1:Event = null, param2:IWindow = null) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            _loc6_ = SharedObject.getLocal(const_1423,"/");
      ...
      {
         var _loc1_:XmlAsset = (var_369 as Component).assets.getAssetByName("login_window") as XmlAsset;
         if(_loc1_ == null)
         {
            Logger.log("Could  not find embedded Window XML for Login Window, login_window");
            return;
         }
         _window = var_369.windowManager.createWindow("habbo_login_window","Login",HabboWindowType.const_396,HabboWindowStyle.const_41,0 | 0,new Rectangle(10,10,320,240),null) as IFrameWindow;
         var _loc2_:XML = _loc1_.content as XML;
         var _loc3_:IWindowContainer = var_369.windowManager.buildFromXML(_loc2_) as IWindowContainer;
         ...
         var _loc7_:SharedObject = SharedObject.getLocal(const_1423,"/");
         if(_loc5_ != null)
         {
      ...
      private function initSSOTicket() : void
      {
         ...
         if(false)
         {
            _loc1_ = var_369.habboConfiguration.getKey("url.prefix",_loc1_);
            _loc1_ = _loc1_.replace("http://","");
            _loc1_ = _loc1_.replace("https://","");
         }
         var _loc2_:IHabboWebLogin = var_369.habboCommunication.habboWebLogin(name,password);
         var_113 = new SSOTicket(var_369.assets,_loc2_,_loc1_);
         var_113.addEventListener(SSOTicket.const_315,onParsedTicketSuccess);
         var_113.addEventListener(SSOTicket.const_277,onParsedTicketFailure);
      }
