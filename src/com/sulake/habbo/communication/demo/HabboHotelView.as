package com.sulake.habbo.communication.demo
{
   ...
   public class HabboHotelView implements IDisposable
   {
      ...
      private var var_578:Function;
      
      private var _window:IWindowContainer;
      
      private var var_689:IAssetLibrary;
      
      private var var_835:uint = 0;
      ...
      private function hotelViewLoadedCallbackHandler(param1:AssetLoaderEvent) : void
      {
         ...
         var _loc3_:IAsset = var_689.getAssetByName(_loc2_.assetName);
         ...
         else if(param1.type == AssetLoaderEvent.const_36)
         {
            if(_events != null)
            {
               _events.dispatchEvent(new Event(HabboHotelViewEvent.const_459));
            }
      ...
      {
         var _loc3_:AssetLoaderStruct = var_689.loadAssetFromFile("hotel_view_banner_" + var_835,new URLRequest(param1),"image/png");
         if(param2 == null)
         {
         ...
         else
         {
            if(_events != null)
            {
               _events.dispatchEvent(new Event(HabboHotelViewEvent.const_705));
            }
            var_577 = param2;
      ...
      {
         var _loc3_:AssetLoaderStruct = var_689.loadAssetFromFile("hotelview_png",new URLRequest(param1),"image/png");
         if(param2 == null)
         {
