package com.sulake.habbo.communication.demo
{
   ...
   public class HabboCommunicationDemo extends Component
   {
      ...
      private var var_1927:PseudoRandom;
      
      private var _windowManager:IHabboWindowManager;
      
      private var _habboConfiguration:IHabboConfigurationManager;
      
      private var var_1467:ILogger;
      
      private var var_1221:String;
      
      private var var_1926:String;
      
      private const const_1423:String = "fuselogin";
      
      private var var_289:ICoreCommunicationManager;
      
      private var var_407:IKeyExchange;
      ...
      private function onDisconnectReason(param1:IMessageEvent) : void
      {
         ...
         if(var_1011)
         {
            dispatchLoginStepEvent(HabboCommunicationEvent.const_167);
         }
         switch(_loc2_)
         {
            case DisconnectReasonEvent.const_1203:
            case DisconnectReasonEvent.const_1261:
               _loc3_ = _habboConfiguration.getKey("logout.banned.url");
               break;
            case DisconnectReasonEvent.const_1372:
               _loc3_ = _habboConfiguration.getKey("logout.concurrent.url");
               break;
            case DisconnectReasonEvent.const_1154:
      ...
      private function onConnectionDisconnected(param1:Event) : void
      {
         ...
         if(param1.type == Event.CLOSE && !var_1928)
         {
      ...
      private function onSessionParamsEvent(param1:IMessageEvent) : void
      {
         ...
         if(var_694 != null)
         {
            _loc4_ = new SSOTicketMessageComposer(var_694);
            _loc2_.send(_loc4_);
      ...
      {
         var_1011 = true;
         dispatchLoginStepEvent(HabboCommunicationEvent.const_193);
         param1.send(new VersionCheckMessageComposer(401,var_1221,var_1926));
         var _loc2_:String = "";
         var _loc3_:SharedObject = SharedObject.getLocal(const_1423,"/");
      ...
      private function onSecretKeyEvent(param1:IMessageEvent) : void
      {
         ...
         var_407.generateSharedKey(_loc4_,10);
         var _loc5_:String = var_407.getSharedKey(16).toUpperCase();
         var _loc6_:RC4_R27 = new RC4_R27(null,null);
         var _loc7_:IEncryption = new RC4_R27(_loc6_,var_1927);
      ...
      private function onUniqueMachineId(param1:UniqueMachineIDEvent) : void
      {
         ...
         var _loc2_:SharedObject = SharedObject.getLocal(const_1423,"/");
      ...
      {
         var_694 = _habboConfiguration.getKey("sso.ticket",null);
         var_1221 = _habboConfiguration.getKey("flash.client.url","");
         var_1926 = _habboConfiguration.getKey("external.variables.txt","");
         if(var_169 == null)
         {
         ...
         if(var_694 != null)
         {
            var_65.mode = HabboConnectionType.const_392;
            var_65.initConnection(HabboConnectionType.const_252);
         }
      }
      
      private function receiveLoggerInterface(param1:IID, param2:IUnknown) : void
      {
         var_1467 = param2 as ILogger;
      }
      ...
      private function onHabboCommunication(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(param2 != null)
         {
            var_65 = param2 as IHabboCommunicationManager;
            _loc3_ = var_65.getHabboMainConnection(null);
            if(_loc3_ != null)
            {
            ...
            var_65.addHabboConnectionMessageEvent(new HelloMessageEvent(onHelloEvent));
            var_65.addHabboConnectionMessageEvent(new InitCryptoMessageEvent(onInitCrypto));
            var_65.addHabboConnectionMessageEvent(new SecretKeyEvent(onSecretKeyEvent));
            var_65.addHabboConnectionMessageEvent(new SessionParamsMessageEvent(onSessionParamsEvent));
            var_65.addHabboConnectionMessageEvent(new AuthenticationOKMessageEvent(onAuthenticationOK));
            var_65.addHabboConnectionMessageEvent(new PingMessageEvent(onPing));
            var_65.addHabboConnectionMessageEvent(new ErrorReportEvent(onErrorReport));
            var_65.addHabboConnectionMessageEvent(new UserObjectEvent(onUserObject));
            var_65.addHabboConnectionMessageEvent(new GenericErrorEvent(onGenericError));
            var_65.addHabboConnectionMessageEvent(new DisconnectReasonEvent(onDisconnectReason));
            var_65.addHabboConnectionMessageEvent(new RoomEntryInfoMessageEvent(onRoomEntryInfoEvent));
            var_65.addHabboConnectionMessageEvent(new UniqueMachineIDEvent(onUniqueMachineId));
         }
      }
      ...
      {
         var _loc3_:* = null;
         var _loc2_:IConnection = var_65.getHabboMainConnection(null);
         if(_loc2_ != null)
         {
            dispatchLoginStepEvent(HabboCommunicationEvent.const_605);
            _loc3_ = new InitCryptoMessageComposer(var_65.mode);
            _loc2_.send(_loc3_);
         }
      }
      ...
      private function onInitCrypto(param1:IMessageEvent) : void
      {
         ...
         var_1927 = new PseudoRandom(parseInt(_loc4_.substring(_loc4_.length - 4),16),65536);
         switch(var_65.mode)
         {
            case HabboConnectionType.const_392:
               _loc6_ = "";
               ...
               var_1010 = _loc4_;
               var_169.loadBannerImage(_loc7_ + "?token=" + var_1010,onHotelViewBannerLoaded);
               break;
            case HabboConnectionType.const_829:
               sendConnectionParameters(_loc2_);
               break;
            case HabboConnectionType.const_1292:
               var_581 = generateRandomHexString(30);
               var_407 = new DiffieHellman(new BigInteger(_habboConfiguration.getKey("connection.development.prime"),16),new BigInteger(_habboConfiguration.getKey("connection.development.generator"),16));
               var_407.init(var_581);
               _loc8_ = var_407.getPublicKey(10);
      ...
      private function onHotelViewBannerLoaded(param1:BitmapData) : void
      {
         ...
         var _loc4_:String = xor(_loc3_,var_1010);
         ...
         var _loc9_:IConnection = var_65.getHabboMainConnection(null);
         ...
         var_407 = new DiffieHellman(_loc10_,_loc11_);
         var _loc13_:int = 10;
         var _loc14_:* = null;
         while(_loc13_ > 0)
         {
            _loc14_ = generateRandomHexString(30);
            var_407.init(_loc14_);
            _loc15_ = var_407.getPublicKey(10);
      ...
      private function onInitConnection(param1:Event = null) : void
      {
         ...
         else
         {
            ...
            {
               var_65.mode = HabboConnectionType.const_829;
            }
         }
         var_65.initConnection(HabboConnectionType.const_252);
      }
      ...
      private function onHabboConfigurationInit(param1:IID = null, param2:IUnknown = null) : void
      {
         if(param2 != null)
         {
            ...
            Component(_habboConfiguration).events.addEventListener(HabboConfigurationEvent.const_166,onConfigurationLoaded);
         }
      }
      ...
      private function onRoomSessionManagerReady(param1:IID, param2:IUnknown) : void
      {
         ...
         var_18.events.addEventListener(RoomSessionEvent.const_103,onRoomSessionEnded);
      }
