package com.sulake.habbo.widget.chooser
{
   ...
   public class ChooserView
   {
      ...
      private const const_1431:uint = 0;
      ...
      private const const_1649:uint = 4.282169599E9;
      ...
      public function removeItem(param1:int, param2:int) : void
      {
         ...
         populate(_items,var_1547);
      }
      
      private function highlightItem(param1:int) : void
      {
         var _loc2_:* = null;
         if(_itemList == null || param1 < 0 || param1 > _itemList.numListItems || param1 == var_731)
         {
            return;
         }
         if(var_731 != -1)
         {
            _loc2_ = _itemList.getListItemAt(var_731) as IWindowContainer;
            if(_loc2_ != null)
            {
               _loc2_.color = !!(var_731 % 2) ? uint(const_1431) : uint(const_1432);
            }
         }
         _loc2_ = _itemList.getListItemAt(param1) as IWindowContainer;
         if(_loc2_ != null)
         {
            _loc2_.color = const_1649;
            var_731 = param1;
         }
      }
      ...
      public function populate(param1:Array, param2:Boolean) : void
      {
         ...
         while(_loc6_ < param1.length)
         {
            ...
            if(_loc4_ != null)
            {
               ...
               _loc5_.color = !!(_loc6_ % 2) ? uint(const_1431) : uint(const_1432);
