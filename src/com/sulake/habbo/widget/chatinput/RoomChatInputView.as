package com.sulake.habbo.widget.chatinput
{
   ...
   public class RoomChatInputView
   {
      ...
      private static const const_500:int = 16;
      
      private static const const_1052:int = 20;
      
      private static const const_353:int = 10;
      
      private static const const_1051:int = 40;
      ...
      private var var_389:Number = 600;
      ...
      public function RoomChatInputView(param1:RoomChatInputWidget, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager)
      {
         ...
         var_971 = _localization.getKey("widgets.chatinput.mode.whisper",":tell");
         var_1734 = _localization.getKey("widgets.chatinput.mode.shout",":shout");
         var_1733 = _localization.getKey("widgets.chatinput.mode.speak",":speak");
         var_658 = new Timer(1000,1);
         var_658.addEventListener(TimerEvent.TIMER_COMPLETE,onTypingTimerComplete);
         var_800 = new Timer(5000,1);
         var_800.addEventListener(TimerEvent.TIMER_COMPLETE,onIdleTimerComplete);
         createWindow();
         refreshView();
      }
      ...
      private function createWindow() : void
      {
         ...
         _window = _windowManager.createWindow("chatinput_widget_window","",HabboWindowType.const_61,HabboWindowStyle.const_41,0 | 0,new Rectangle(300,400,400,30),null) as IWindowContainer;
         ...
         _loc4_.addEventListener(WindowEvent.const_128,onInputChanged);
         _window.addEventListener(WindowEvent.const_368,onWindowMoved);
         var_1157 = true;
         var_120 = "";
      }
      ...
      private function refreshView() : void
      {
         ...
         var _loc12_:* = 0;
         var _loc13_:* = 0;
         var_1732 = _loc2_.width + const_500 + _loc6_.width + const_1052;
         if(_loc7_ != null)
         {
         ...
         if(_loc8_ != null)
         {
            _loc13_ = Number(Math.max(const_1051,_loc8_.width) + const_500);
            _loc8_.x = _loc12_;
      ...
      private function windowKeyEventProcessor(param1:Event = null, param2:IWindow = null) : void
      {
         ...
         if(_loc4_ == Keyboard.BACKSPACE)
         {
            ...
            if(_loc8_ != null)
            {
               ...
               if(_loc10_[0] == var_971 && _loc10_.length == 3 && _loc10_[2] == "")
               {
                  _loc8_.text = "";
                  var_120 = "";
               }
      ...
      public function setMaxWidth(param1:Number) : void
      {
         ...
         {
            _loc3_ = Math.min(int(_loc2_.textWidth),var_389);
         }
         else
         {
            _loc3_ = Math.min(_loc3_,var_389);
         }
      ...
      private function addEventListenerToChild(param1:IWindow) : void
      {
         if(param1 != null)
         {
            ...
            param1.addEventListener(WindowMouseEvent.const_52,windowMouseEventProcessor);
         }
      }
      ...
      private function sendTypingMessage() : void
      {
         ...
         var _loc1_:RoomWidgetChatTypingMessage = new RoomWidgetChatTypingMessage(var_473);
