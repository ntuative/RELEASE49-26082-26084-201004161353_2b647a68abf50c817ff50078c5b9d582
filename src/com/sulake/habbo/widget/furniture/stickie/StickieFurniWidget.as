package com.sulake.habbo.widget.furniture.stickie
{
   ...
   public class StickieFurniWidget extends RoomWidgetBase
   {
      ...
      private static const const_1088:int = 500;
      
      private static const const_1039:Number = 100;
      
      private static const const_1090:int = 14;
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetStickieDataUpdateEvent.const_697,onObjectUpdate);
      ...
      private function sendSetColor(param1:uint) : void
      {
         ...
         {
            _loc3_ = new RoomWidgetStickieSendUpdateMessage(RoomWidgetStickieSendUpdateMessage.const_477,var_146,var_189,var_753);
      ...
      private function sendDelete() : void
      {
         ...
         {
            _loc1_ = new RoomWidgetStickieSendUpdateMessage(RoomWidgetStickieSendUpdateMessage.const_583,var_146);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetStickieDataUpdateEvent.const_697,onObjectUpdate);
      }
      ...
      private function onObjectUpdate(param1:RoomWidgetStickieDataUpdateEvent) : void
      {
         ...
         var_1573 = param1.method_1;
         var_189 = param1.text;
         var_753 = param1.colorHex;
      ...
      private function sendUpdate() : void
      {
         ...
         if(messageListener != null)
         {
            _loc1_ = new RoomWidgetStickieSendUpdateMessage(RoomWidgetStickieSendUpdateMessage.const_477,var_146,var_189,var_753);
            messageListener.processWidgetMessage(_loc1_);
         }
      }
      ...
      private function showInterface() : void
      {
         ...
         if(_window == null)
         {
            _window = windowManager.createWindow("stickieui_container","",HabboWindowType.const_61,HabboWindowStyle.const_42,0 | 0,new Rectangle(const_1039,const_1038,2,2),null,0) as IWindowContainer;
         ...
         {
            _loc3_.text = var_189;
            _loc3_.addEventListener(WindowEvent.const_128,onTextWindowEvent);
         }
         _loc6_ = _window.findChildByTag("bg") as IBitmapWrapperWindow;
         if(_loc6_ != null)
         {
            if(var_1573 == "post_it_vd")
            {
            ...
            else
            {
               ...
               _loc6_.color = uint("0xFF" + var_753);
            }
         ...
         setColorButtons(var_47 && var_1573 == "post_it");
      }
      ...
      private function onTextWindowEvent(param1:WindowEvent) : void
      {
         ...
         _loc2_.maxChars = const_1088;
         if(_loc2_.numLines < const_1090)
         {
            return;
         }
