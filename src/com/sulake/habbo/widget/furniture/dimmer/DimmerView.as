package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerView
   {
      ...
      private var var_1126:XML;
      
      private var var_437:int;
      
      private var var_462:DimmerViewColorGrid;
      
      private var _window:IWindowContainer;
      
      private var var_1633:int;
      
      private var var_330:DimmerViewAlphaSlider;
      ...
      private function selectTab(param1:int) : void
      {
         ...
         var _loc2_:IWindow = var_229.getTabItemAt(param1);
         if(_loc2_ != null)
         {
            var_229.selector.setSelected(_loc2_ as ISelectableWindow);
         }
      }
      ...
      private function createWindow() : void
      {
         ...
         _window = _widget.windowManager.createWindow("dimmerui_container","",HabboWindowType.const_61,HabboWindowStyle.const_42,0 | 0,new Rectangle(const_1039,const_1038,2,2),null,0) as IWindowContainer;
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc5_ != null)
            {
               var_462 = new DimmerViewColorGrid(this,_loc5_ as IItemGridWindow,_widget.windowManager,_widget.assets);
            }
         }
         _loc1_ = _window.findChildByName("brightness_container");
         if(_loc1_ != null)
         {
            var_330 = new DimmerViewAlphaSlider(this,_loc1_ as IWindowContainer,_widget.assets);
         }
         var_229 = ITabContextWindow(_window.findChildByName("tab_context"));
         selectTab(_widget.selectedPresetIndex);
         var _loc2_:int = 0;
         while(_loc2_ < var_229.numTabItems)
         {
            _loc6_ = var_229.getTabItemAt(_loc2_);
      ...
      public function set selectedColorIndex(param1:int) : void
      {
         ...
         if(var_462 != null)
         {
            var_462.setSelectedColorIndex(param1);
         }
         _widget.previewCurrentSetting();
      }
      ...
      private function getSelectedTabIndex() : int
      {
         ...
         var _loc1_:ISelectableWindow = var_229.selector.getSelected();
         return var_229.selector.getSelectableIndex(_loc1_);
      }
      ...
      public function set selectedType(param1:int) : void
      {
         ...
         if(var_330 != null)
         {
            var_330.min = _widget.minLights[param1 - 1];
         }
      }
      ...
      private function selectPreset(param1:int) : void
      {
         ...
         selectTab(param1);
         var_957 = _loc2_.light;
         if(var_330 != null)
         {
            var_330.setValue(var_957);
         }
         var_437 = colors.indexOf(_loc2_.color);
         if(var_462 != null)
         {
            var_462.setSelectedColorIndex(var_437);
         }
