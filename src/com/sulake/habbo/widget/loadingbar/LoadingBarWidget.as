package com.sulake.habbo.widget.loadingbar
{
   ...
   public class LoadingBarWidget extends RoomWidgetBase
   {
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetLoadingBarUpdateEvent.const_271,onHideLoadingBar);
      ...
      private function onShowInterstitial(param1:RoomWidgetInterstitialUpdateEvent) : void
      {
         ...
         {
            var_438 = new Sprite();
            var_438.addChild(new Bitmap(_image));
            var_438.addEventListener(MouseEvent.CLICK,clickHandler);
         }
         else
         {
            _loc5_ = var_438.getChildAt(0) as Bitmap;
            if(_loc5_ != null)
            {
               _loc5_.bitmapData = _image;
            }
         }
         _loc2_.setDisplayObject(var_438);
         _window.visible = true;
         _window.center();
      }
      ...
      private function clickHandler(param1:Event) : void
      {
         if(var_1574 != "")
         {
            HabboWebTools.openWebPage(var_1574);
         }
      }
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetLoadingBarUpdateEvent.const_271,onHideLoadingBar);
      }
      ...
      override public function dispose() : void
      {
         if(var_438 != null)
         {
            var_438.removeEventListener(MouseEvent.CLICK,clickHandler);
            var_438 = null;
         }
         if(_image != null)
         {
