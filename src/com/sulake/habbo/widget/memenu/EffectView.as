package com.sulake.habbo.widget.memenu
{
   ...
   public class EffectView
   {
      ...
      {
         super();
         var_172 = new Timer(1000);
         var_172.addEventListener(TimerEvent.TIMER,onUpdate);
      }
      ...
      private function createWindow(param1:String) : void
      {
         ...
         var_783 = _window.findChildByName("time_left") as ITextWindow;
         setTimeLeft();
         var_784 = _window.findChildByName("loader_bar");
         if(var_784 != null)
         {
            var_389 = var_784.width;
            var_172.start();
            onUpdate();
         }
         if(false)
      ...
      public function dispose() : void
      {
         ...
         {
            var_172.stop();
            var_172.removeEventListener(TimerEvent.TIMER,onUpdate);
            var_172 = null;
         }
         _container = null;
         if(_window != null)
      ...
      private function setTimeLeft() : void
      {
         ...
         if(var_783 != null)
         {
            var_783.caption = "${widgets.memenu.effects.active.timeleft}";
            _loc1_ = "null";
            if(false)
            {
               _loc2_ = 0;
            ...
            {
               var_783.caption = "${widgets.memenu.effects.activate}";
            }
         }
      }
