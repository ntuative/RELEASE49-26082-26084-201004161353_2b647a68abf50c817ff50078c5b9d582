package com.sulake.habbo.widget.memenu
{
   ...
   public class MeMenuSettingsViewSlider
   {
      ...
      private var var_862:MeMenuSettingsView;
      
      private var var_2387:int;
      
      private var var_593:BitmapData;
      
      private var var_1028:Number = 1;
      ...
      {
         if(param1.type != WindowEvent.const_368)
         {
            return;
         }
         var_862.saveVolume(getValue(param2.x),false);
      }
      ...
      {
         return param1 / var_1496 * (var_1028 - var_717) + var_717;
      }
   }
}
