package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandUserView
   {
      ...
      private var var_874:TagListRenderer;
      ...
      private var var_105:IBorderWindow;
      ...
      public function InfoStandUserView(param1:InfostandWidget, param2:String)
      {
         ...
         var_874 = new TagListRenderer(param1,onTagSelected);
      }
      ...
      private function showGroupBadgeInfo(param1:WindowMouseEvent) : void
      {
         ...
         _loc3_ = var_105.getChildByName("name") as ITextWindow;
         if(_loc3_ != null)
         {
            _loc3_.text = "Group Info";
         }
         _loc4_ = var_105.getChildByName("description") as ITextWindow;
         if(_loc4_ != null)
         {
         ...
         var_105.x = _loc5_.left - 0;
         var_105.y = _loc5_.top + (_loc5_.height - 0) / 2;
      }
      ...
      public function setTags(param1:Array, param2:Array = null) : void
      {
         ...
         if(param1.length != 0)
         {
            _loc3_.height = var_874.renderTags(param1,_loc3_,param2);
            _loc4_.height = 1;
         }
         else
         {
      ...
      private function createBadgeDetails() : void
      {
         ...
         var_105 = _widget.windowManager.buildFromXML(_loc1_.content as XML) as IBorderWindow;
         if(var_105 == null)
         {
            throw new Error("Failed to construct window from XML!");
         }
      ...
      protected function setTradeButtonTooltip(param1:int) : void
      {
         ...
         switch(param1)
         {
            case RoomWidgetUserInfoUpdateEvent.TRADE_REASON_NO_OWN_RIGHT:
               ...
               break;
            case RoomWidgetUserInfoUpdateEvent.const_802:
               _loc2_ = "${infostand.button.trade.tooltip.shutdown}";
               break;
            case RoomWidgetUserInfoUpdateEvent.const_1014:
      ...
      private function showBadgeInfo(param1:WindowMouseEvent) : void
      {
         ...
         createBadgeDetails();
         _loc6_ = var_105.getChildByName("name") as ITextWindow;
         if(_loc6_ != null)
         {
            _loc6_.text = "${badge_name_" + _loc5_ + "}";
         }
         _loc6_ = var_105.getChildByName("description") as ITextWindow;
         if(_loc6_ != null)
         {
         ...
         var_105.x = _loc7_.left - 0;
         var_105.y = _loc7_.top + (_loc7_.height - 0) / 2;
      }
      ...
      protected function updateButtons(param1:RoomWidgetUserInfoUpdateEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetUserInfoUpdateEvent.const_196:
               ...
               break;
            case RoomWidgetUserInfoUpdateEvent.const_195:
