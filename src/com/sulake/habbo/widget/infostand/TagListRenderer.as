package com.sulake.habbo.widget.infostand
{
   ...
   public class TagListRenderer
   {
      ...
      private const const_1640:int = 5;
      ...
      {
         var _loc2_:* = null;
         if(var_1153 != null && var_1153.indexOf(param1) != -1)
         {
         ...
         _loc3_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,var_108);
      ...
      private function fit(param1:Rectangle) : Boolean
      {
         ...
         if(var_795 + param1.height > _rect.height)
         {
            return false;
         }
         ...
         {
            _offsetX = 0;
            var_795 += param1.height + const_1640;
            return fit(param1);
         }
         param1.offset(_offsetX,var_795);
         _offsetX += param1.width + const_1641;
         return true;
      }
