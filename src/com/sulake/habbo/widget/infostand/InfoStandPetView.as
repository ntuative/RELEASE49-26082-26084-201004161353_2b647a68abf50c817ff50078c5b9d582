package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandPetView
   {
      ...
      private const const_1661:uint = 6710886;
      
      private var _window:IItemListWindow;
      
      private const const_1657:String = "level";
      
      private var var_96:IItemListWindow;
      
      private const const_1662:String = "energy";
      
      private var var_1228:Map;
      
      private const const_1660:String = "nutrition";
      
      private var var_60:IItemListWindow;
      
      private const const_1656:uint = 3355443;
      
      private var var_219:IBorderWindow;
      
      private const const_1659:int = 158;
      
      private const const_1655:int = 16;
      
      private var _widget:InfostandWidget;
      
      private var var_175:PetCommandTool;
      
      private const const_1663:uint = 11184810;
      
      private const const_1658:String = "experience";
      ...
      {
         if(var_96 == null || var_219 == null || var_60 == null)
         {
            return;
         }
         ...
         var_219.height = NaN;
         _window.width = Math.max(var_219.width,var_60.width);
      ...
      private function openTrainView() : void
      {
         if(var_175 == null)
         {
            var_175 = new PetCommandTool(_widget);
         }
         var _loc1_:InfoStandPetData = var_1228.getValue(var_553) as InfoStandPetData;
         if(_loc1_ != null)
         {
            var_175.showWindow(true);
            var_175.showCommandToolForPet(_loc1_.id,_loc1_.name,_loc1_.image);
         }
      }
      ...
      public function update(param1:InfoStandPetData) : void
      {
         ...
         ageText = param1.age;
         updateStateElement(const_1657,param1.level,param1.levelMax);
         updateStateElement(const_1658,param1.experience,param1.experienceMax);
         updateStateElement(const_1662,param1.energy,param1.energyMax);
         ...
         updateWindow();
         var_553 = param1.id;
         var_1228.remove(param1.id);
         var_1228.add(param1.id,param1);
         if(var_175 && var_175.isVisible() && param1.isOwnPet)
         {
            var_175.showCommandToolForPet(param1.id,param1.name,param1.image);
         }
      }
      ...
      public function updateEnabledTrainingCommands(param1:int, param2:Array) : void
      {
         ...
         var_175.setEnabledCommands(param1,param2);
      }
      ...
      protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_.name)
         {
            case "btn_pick":
               _loc3_ = "null";
               if(var_175 && var_175.getPetId() == var_553)
               {
                  var_175.showWindow(false);
               }
               break;
            case "btn_train":
               openTrainView();
            ...
            case "btn_petrespect":
               ...
               break;
            case "btn_kick":
               _loc2_ = new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_462,_widget.petData.ownerId);
      ...
      private function createPercentageBar(param1:int, param2:int) : BitmapData
      {
         ...
         var _loc5_:BitmapData = new BitmapData(const_1659,const_1655,false);
         _loc5_.fillRect(new Rectangle(0,0,_loc5_.width,_loc5_.height),const_1663);
         var _loc6_:Rectangle = new Rectangle(1,1,_loc5_.width - 2,_loc5_.height - 2);
         _loc5_.fillRect(_loc6_,const_1656);
         var _loc7_:Rectangle = new Rectangle(1,1,_loc5_.width - 2,_loc5_.height - 2);
         _loc7_.width = _loc3_ * _loc7_.width;
         _loc5_.fillRect(_loc7_,const_1661);
         return _loc5_;
      }
