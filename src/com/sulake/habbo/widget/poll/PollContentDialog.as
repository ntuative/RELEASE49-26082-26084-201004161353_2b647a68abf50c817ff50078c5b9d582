package com.sulake.habbo.widget.poll
{
   ...
   public class PollContentDialog implements IPollDialog
   {
      ...
      private function answerPollQuestion() : void
      {
         ...
         var question:Dictionary = var_755[var_1084] as Dictionary;
      ...
      private function showCancelConfirm() : void
      {
         ...
         if(!var_317)
         {
            ...
            var_317 = _widget.windowManager.buildFromXML(_loc1_.content as XML,2);
            var_317.center();
            var_317.procedure = cancelConfirmEventProc;
         }
      }
      ...
      private function nextQuestion() : void
      {
         ...
         var _loc7_:int = 0;
         ++var_1084;
         if(var_1084 < var_755.length)
         {
            _loc1_ = var_755[var_1084] as Dictionary;
            if(!_loc1_)
            {
            ...
            if(_window)
            {
               ...
               if(_loc2_)
               {
                  ...
                  _loc6_ = _loc6_.replace("%count%",var_755.length);
                  _loc2_.text = _loc6_;
               }
