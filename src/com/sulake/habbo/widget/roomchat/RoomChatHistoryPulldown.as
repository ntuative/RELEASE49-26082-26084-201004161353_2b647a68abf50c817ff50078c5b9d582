package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatHistoryPulldown
   {
      ...
      public static const const_229:int = 0;
      
      public static const const_780:int = 3;
      
      private static const const_753:int = 150;
      ...
      private var var_1423:BitmapData;
      ...
      public function RoomChatHistoryPulldown(param1:RoomChatWidget, param2:IHabboWindowManager, param3:IWindowContainer, param4:IAssetLibrary)
      {
         ...
         var_35 = param3;
         var_1786 = (_assetLibrary.getAssetByName("chat_grapbar_bg") as BitmapDataAsset).content as BitmapData;
         var_1424 = (_assetLibrary.getAssetByName("chat_grapbar_grip") as BitmapDataAsset).content as BitmapData;
         var_1787 = (_assetLibrary.getAssetByName("chat_grapbar_handle") as BitmapDataAsset).content as BitmapData;
         var_1423 = (_assetLibrary.getAssetByName("chat_grapbar_x") as BitmapDataAsset).content as BitmapData;
         var_1425 = (_assetLibrary.getAssetByName("chat_grapbar_x_hi") as BitmapDataAsset).content as BitmapData;
         var_1789 = (_assetLibrary.getAssetByName("chat_grapbar_x_pr") as BitmapDataAsset).content as BitmapData;
         var_1788 = (_assetLibrary.getAssetByName("chat_history_bg") as BitmapDataAsset).content as BitmapData;
         var_68 = _windowManager.createWindow("chat_history_bg","",HabboWindowType.BITMAP_WRAPPER,HabboWindowStyle.const_42,HabboWindowParam.const_74,new Rectangle(0,0,param3.width,param3.height - const_78),null,0,0) as IBitmapWrapperWindow;
         var_35.addChild(var_68);
         _window = _windowManager.createWindow("chat_pulldown","",HabboWindowType.const_61,HabboWindowStyle.const_42,HabboWindowParam.const_43,new Rectangle(0,0 - const_78,param3.width,const_78),null,0) as IWindowContainer;
         var_35.addChild(_window);
         var_94 = _windowManager.createWindow("REGIONchat_pulldown","",WindowType.const_465,HabboWindowStyle.const_41,0 | 0 | 0 | 0,new Rectangle(0,0,param3.width,param3.height - const_78),null,0) as IRegionWindow;
         if(var_94 != null)
         {
      ...
      public function update(param1:uint) : void
      {
         switch(state)
         {
            case const_408:
               ...
               break;
            case const_780:
               var_68.blend = 0 - param1 / const_753;
               _window.blend = 0 - param1 / const_753;
               if(true)
               {
                  state = const_229;
               }
      ...
      public function containerResized(param1:Rectangle) : void
      {
         ...
         if(var_94 != null)
         {
            var_94.x = 0;
            var_94.y = 0 - const_78;
            var_94.width = 0 - var_1785;
         }
         if(var_68 != null)
         {
            var_68.rectangle = var_35.rectangle;
            var_68.height = 0 - const_78;
         }
         buildWindowGraphics();
      }
      ...
      private function buildWindowGraphics() : void
      {
         ...
         if(var_1784 == _window.width)
         {
            return;
         }
         var_1784 = _window.width;
         ...
         if(_loc1_ != null && _loc3_ != null && _loc4_ != null)
         {
            if(_loc1_.width > 0 && _loc1_.height > 0)
            {
               ...
               tileBitmapHorz(var_1786.clone(),_loc7_);
               _loc1_.bitmap = _loc7_;
            }
            if(_loc3_.width > 0 && _loc3_.height > 0)
            {
               _loc8_ = new BitmapData(_loc3_.width,_loc3_.height);
               tileBitmapHorz(var_1424.clone(),_loc8_);
               _loc3_.bitmap = _loc8_;
            }
            if(_loc4_.width > 0 && _loc4_.height > 0)
            {
               _loc9_ = new BitmapData(_loc4_.width,_loc4_.height);
               tileBitmapHorz(var_1424.clone(),_loc9_);
