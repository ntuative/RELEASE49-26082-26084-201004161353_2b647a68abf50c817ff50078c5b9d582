package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatItem
   {
      ...
      private static const const_500:int = 6;
      
      private static const const_353:int = 10;
      
      private static const const_1136:Number = 18;
      
      private static const const_1441:Number = 10;
      
      private static const const_1440:Number = 8;
      ...
      {
         _widget.onItemMouseOut(var_1093,var_1095,_roomId,_roomCategory,param1);
      }
      
      private function onBubbleMouseClick(param1:WindowMouseEvent) : void
      {
         _widget.onItemMouseClick(var_1093,var_762,var_1095,_roomId,_roomCategory,param1);
      }
      ...
      {
         var_1351 = param1.chatType;
         var_1093 = param1.userId;
         var_762 = param1.userName;
         var_1095 = param1.userCategory;
         _message = param1.text;
         var_1353 = param1.userX;
      ...
      private function addEventListenerToChild(param1:IWindow) : void
      {
         if(param1 != null)
         {
            ...
            param1.addEventListener(WindowMouseEvent.const_52,onBubbleMouseDown);
      ...
      public function renderView() : void
      {
         ...
         var_94 = _window as IRegionWindow;
         var_94.background = true;
         var_94.mouseTreshold = 0;
         enableTooltip();
         addEventListenerToChild(var_94);
         ...
         if(_loc19_ != null)
         {
            if(_loc2_)
            {
               _width += _loc19_.textWidth + const_353;
            }
            else
            {
               _loc19_.text = var_762 + ":";
               _loc19_.y += var_443;
               _loc19_.width = _loc19_.textWidth + const_353;
               _width += _loc19_.textWidth + const_353;
            }
         }
         if(_loc20_ != null)
         {
            if(var_1351 == RoomWidgetChatUpdateEvent.const_266)
            {
               _loc20_.text = _localizations.registerParameter("widgets.chatbubble.respect","username",var_762);
            }
            else if(var_1351 == RoomWidgetChatUpdateEvent.const_269)
            {
               _loc20_.text = _localizations.registerParameter("widget.chatbubble.petrespect","petname",var_762);
            }
            else
            {
            ...
            _loc20_.x = _width;
            _loc20_.y += var_443;
            _loc20_.width = _loc20_.textWidth + const_500;
            _width += _loc20_.textWidth + const_500;
         }
         if(_loc22_ != null)
         {
            _loc22_.width = _loc19_.textWidth + const_353 + _loc20_.textWidth + const_500;
            _loc37_ = new Matrix();
      ...
      {
         _widget.onItemMouseDown(var_1093,var_1095,_roomId,_roomCategory,param1);
      }
      ...
      {
         _widget.onItemMouseOver(var_1093,var_1095,_roomId,_roomCategory,param1);
      }
